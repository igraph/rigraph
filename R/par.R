...
igraph.pars.set.verbose <- function(verbose) {
  if (is.logical(verbose)) {
    .Call(Rx_igraph_set_verbose, verbose) # igraph_set_status_handler()/igraph_set_progress_handler(); no _impl
    ...
    .Call(Rx_igraph_set_verbose, TRUE) # igraph_set_status_handler()/igraph_set_progress_handler(); no _impl
  } else {
