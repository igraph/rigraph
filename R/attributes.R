...
#' behaviors are predefined: \describe{ \item{list("ignore")}{The attribute is
#' ignored and dropped.} \item{list("sum")}{The sum of the attributes is
...
#' a \code{sum} method.)} \item{list("prod")}{The product of the attributes is
#' calculated. This does not work for character attributes and works for
#' complex attributes only if they have a \code{prod} function defined.}
#' \item{list("min")}{The minimum of the attributes is calculated and returned.
#' For character and complex attributes the standard R \code{min} function is
#' used.} \item{list("max")}{The maximum of the attributes is calculated and
#' returned. For character and complex attributes the standard R \code{max}
#' function is used.} \item{list("random")}{Chooses one of the supplied
#' attribute values, uniformly randomly. For character and complex attributes
#' this is implemented by calling \code{sample}.} \item{list("first")}{Always
#' chooses the first attribute value. It is implemented by calling the
#' \code{head} function.} \item{list("last")}{Always chooses the last attribute
#' value. It is implemented by calling the \code{tail} function.}
#' \item{list("mean")}{The mean of the attributes is calculated and returned.
#' For character and complex attributes this simply calls the \code{mean}
#' function.} \item{list("median")}{The median of the attributes is selected.
#' Calls the R \code{median} function for all attribute types.}
#' \item{list("concat")}{Concatenate the attributes, using the \code{c}
