...
graph_attr <- function(graph, name) {
  ...
  if (missing(name)) {
    ...
    .Call(C_R_igraph_mybracket2, graph, igraph_t_idx_attr, 2L)[[as.character(name)]]
  }
}
...
set_graph_attr <- function(graph, name, value) {
  ...
  .Call(C_R_igraph_mybracket3_set, graph, igraph_t_idx_attr, 2L, name, value)
}
...
graph.attributes <- function(graph) {
  ...
  .Call(C_R_igraph_mybracket2_copy, graph, igraph_t_idx_attr, 2L)
}
...
"graph.attributes<-" <- function(graph, value) {
  ...
  .Call(C_R_igraph_mybracket2_set, graph, igraph_t_idx_attr, 2L, value)
}
...
vertex_attr <- function(graph, name, index=V(graph)) {
  ...
  if (missing(name)) {
    ...
    myattr <-
      .Call(C_R_igraph_mybracket2, graph, igraph_t_idx_attr, 3L)[[as.character(name)]]
    if (! missing(index)) {
...
vertex.attributes <- function(graph, index = V(graph)) {
  ...
  res <- .Call(C_R_igraph_mybracket2_copy, graph, igraph_t_idx_attr, 3L)
...
"vertex.attributes<-" <- function(graph, index = V(graph), value) {
  ...
  .Call(C_R_igraph_mybracket2_set, graph, igraph_t_idx_attr, 3L, value)
}
...
edge_attr <- function(graph, name, index=E(graph)) {
  ...
  if (missing(name)) {
    ...
    myattr <- .Call(C_R_igraph_mybracket2, graph, igraph_t_idx_attr, 4L)[[name]]
    myattr[index]
  }
}
...
edge.attributes <- function(graph, index = E(graph)) {
  ...
  res <- .Call(C_R_igraph_mybracket2_copy, graph, igraph_t_idx_attr, 4L)
...
"edge.attributes<-" <- function(graph, index = E(graph), value) {
  ...
  .Call(C_R_igraph_mybracket2_set, graph, igraph_t_idx_attr, 4L, value)
}
...
graph_attr_names <- function(graph) {
  ...
  res <- .Call(C_R_igraph_mybracket2_names, graph, igraph_t_idx_attr, 2L)
...
vertex_attr_names <- function(graph) {
  ...
  res <- .Call(C_R_igraph_mybracket2_names, graph, igraph_t_idx_attr, 3L)
...
edge_attr_names <- function(graph) {
  ...
  res <- .Call(C_R_igraph_mybracket2_names, graph, igraph_t_idx_attr, 4L)
  if (is.null(res)) { res <- character() }
  res
}
...
delete_graph_attr <- function(graph, name) {
  ...
  gattr <- .Call(C_R_igraph_mybracket2, graph, igraph_t_idx_attr, 2L)
  gattr[[name]] <- NULL

  .Call(C_R_igraph_mybracket2_set, graph, igraph_t_idx_attr, 2L, gattr)
}
...
delete_vertex_attr <- function(graph, name) {
  ...
  vattr <- .Call(C_R_igraph_mybracket2, graph, igraph_t_idx_attr, 3L)
  vattr[[name]] <- NULL

  .Call(C_R_igraph_mybracket2_set, graph, igraph_t_idx_attr, 3L, vattr)
}
...
delete_edge_attr <- function(graph, name) {
  ...
  eattr <- .Call(C_R_igraph_mybracket2, graph, igraph_t_idx_attr, 4L)
  eattr[[name]] <- NULL

  .Call(C_R_igraph_mybracket2_set, graph, igraph_t_idx_attr, 4L, eattr)
}
