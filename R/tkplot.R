...
#' @param \dots For `tkplot()`, additional plotting parameters, see [igraph.plotting] for the complete list.
#'   For `tk_close()`, `tk_fit()`, `tk_coords()` and `tk_rotate()`, these dots must be empty.
