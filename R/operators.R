...
graph.intersection <- function(...) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "graph.intersection()", "intersection()")
  intersection(...)
} # nocov end
...
graph.union <- function(..., byname = "auto") { # nocov start
  lifecycle::deprecate_soft("1.7.0", "graph.union()", "union.igraph()")
...
graph.difference <- function(...) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "graph.difference()", "difference()")
  difference(...)
} # nocov end
...
graph.disjoint.union <- function(...) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "graph.disjoint.union()", "disjoint_union()")
  disjoint_union(...)
} # nocov end
...
graph.compose <- function(g1, g2, byname = "auto") { # nocov start
  lifecycle::deprecate_soft("1.7.0", "graph.compose()", "compose()")
...
graph.complementer <- function(graph, loops = FALSE) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "graph.complementer()", "complementer()")
