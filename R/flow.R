...
#'     }
#'     \item{partition1}{
#'       The vertices in the first partition after the cut
...
#'     }
#'     \item{partition2}{
#'       The vertices in the second partition
...
#'       containing edge ids. Each vector is an \eqn{
#'         (s,t)
#'       }-cut.
#'     }
#'     \item{partition1s}{
...
#'     }
#'     \item{cut}{
#'       A numeric vector of edge ids, the minimum cut corresponding
#'       to the maximum flow.
#'     }
#'     \item{partition1}{
#'       A numeric vector of vertex ids, the vertices in the
