...
#' @return A list with entries: \describe{\item{cuts}{A list of numeric vectors
...
#'   here.
#' @return A list with entries: \describe{\item{value}{Numeric scalar, the size of the
...
#' @return A list with components: \describe{\item{dom}{ A numeric vector giving the
