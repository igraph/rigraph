...
#' @param \dots For `layout_nicely()` the extra arguments are passed to the real layout function.
#'   For `nicely()` all argument are passed to `layout_nicely()`.
...
#' @param \dots Additional arguments to pass to the `layout` layout function.
