...
component_wise <- function(
  ...
  # BEGIN GENERATED ARG_HANDLE: component_wise, do not edit, see tools/generate-migrations.R
  if (...length() > 0L) {
    .arg_handle <- migrate_recover_args(
      list(...),
      current = list(merge_method = merge_method),
      recover_new = c("merge_method"),
      recover_old = c("merge_method"),
      match_names = c("merge_method"),
      match_to = c("merge_method"),
      defaults = list(merge_method = "dla"),
      head_args = character(0),
      fn_name = "component_wise"
    )
...
normalize <- function(
  ...
  # BEGIN GENERATED ARG_HANDLE: normalize, do not edit, see tools/generate-migrations.R
  if (...length() > 0L) {
    .arg_handle <- migrate_recover_args(
      list(...),
      current = list(
