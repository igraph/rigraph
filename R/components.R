...
no.clusters <- function(graph, mode = c("weak", "strong")) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "no.clusters()", "count_components()")
...
decompose.graph <- function(graph, mode = c("weak", "strong"), max.comps = NA, min.vertices = 0) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "decompose.graph()", "decompose()")
...
cluster.distribution <- function(graph, cumulative = FALSE, mul.size = FALSE, ...) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "cluster.distribution()", "component_distribution()")
...
biconnected.components <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "biconnected.components()", "biconnected_components()")
...
articulation.points <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "articulation.points()", "articulation_points()")
