...
igraph.to.graphNEL <- function(graph) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "igraph.to.graphNEL()", "as_graphnel()")
...
graph.adjlist <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "graph.adjlist()", "graph_from_adj_list()")
...
get.edgelist <- function(graph, names = TRUE) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "get.edgelist()", "as_edgelist()")
...
get.data.frame <- function(x, what = c("edges", "vertices", "both")) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "get.data.frame()", "as_data_frame()")
...
get.adjacency <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "get.adjacency()", "as_adjacency_matrix()")
  as_adjacency_matrix(
    graph = graph,
    type = type,
    attr = attr,
...
get.adjlist <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "get.adjlist()", "as_adj_list()")
...
get.adjedgelist <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "get.adjedgelist()", "as_adj_edge_list()")
...
as_adjacency_matrix <- function(
  ...
  if (lifecycle::is_present(edges) && isTRUE(edges)) {
    lifecycle::deprecate_stop("2.2.0", "as_adjacency_matrix(edges = )")
  }
...
as_adj <- function(
  ...
  lifecycle::deprecate_warn("2.2.0", "as_adj()", "as_adjacency_matrix()")
...
as.directed <- function(
  ...
  lifecycle::deprecate_warn("2.2.0", "as.directed()", "as_directed()")
...
as.undirected <- function(
  ...
  lifecycle::deprecate_warn("2.2.0", "as.undirected()", "as_undirected()")
