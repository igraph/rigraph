...
add.edges <- function(graph , edges , ... , attr = list()) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "add.edges()", "add_edges()")
...
add.vertices <- function(graph , nv , ... , attr = list()) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "add.vertices()", "add_vertices()")
...
delete.edges <- function(graph , edges) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "delete.edges()", "delete_edges()")
...
delete.vertices <- function(graph , v) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "delete.vertices()", "delete_vertices()")
...
is.directed <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.directed()", "is_directed()")
