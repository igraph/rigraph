...
adjacent.triangles <- function(graph , vids = V(graph)) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "adjacent.triangles()", "count_triangles()")
...
automorphisms <- function(graph , colors , sh = c("fm","f","fs","fl","flm","fsm")) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "automorphisms()", "count_automorphisms()")
...
average.path.length <- function(graph , weights = NULL , directed = TRUE , unconnected = TRUE , details = FALSE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "average.path.length()", "mean_distance()")
...
bipartite.mapping <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "bipartite.mapping()", "bipartite_mapping()")
...
bipartite.projection.size <- function(graph , types = NULL) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "bipartite.projection.size()", "bipartite_projection_size()")
...
canonical.permutation <- function(graph , colors , sh = c("fm","f","fs","fl","flm","fsm")) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "canonical.permutation()", "canonical_permutation()")
...
centralization.betweenness.tmax <- function(graph = NULL , nodes = 0 , directed = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralization.betweenness.tmax()", "centr_betw_tmax()")
...
centralization.closeness <- function(graph , mode = c("out","in","all","total") , normalized = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralization.closeness()", "centr_clo()")
...
centralization.closeness.tmax <- function(graph = NULL , nodes = 0 , mode = c("out","in","all","total")) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralization.closeness.tmax()", "centr_clo_tmax()")
...
centralization.degree <- function(graph , mode = c("all","out","in","total") , loops = TRUE , normalized = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralization.degree()", "centr_degree()")
...
centralization.evcent <- function(graph , directed = FALSE , scale = TRUE , options = arpack_defaults() , normalized = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralization.evcent()", "centr_eigen()")
...
centralization.evcent.tmax <- function(graph = NULL , nodes = 0 , directed = FALSE , scale = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralization.evcent.tmax()", "centr_eigen_tmax()")
...
centralize.scores <- function(scores , theoretical.max = 0 , normalized = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "centralize.scores()", "centralize()")
...
clique.number <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "clique.number()", "clique_num()")
...
contract.vertices <- function(graph , mapping , vertex.attr.comb = igraph_opt("vertex.attr.comb")) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "contract.vertices()", "contract()")
...
count.multiple <- function(graph , eids = E(graph)) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "count.multiple()", "count_multiple()")
...
forest.fire.game <- function(nodes , fw.prob , bw.factor = 1 , ambs = 1 , directed = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "forest.fire.game()", "sample_forestfire()")
...
graph.adjlist <- function(adjlist , mode = c("out","in","all","total") , duplicate = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.adjlist()", "graph_from_adj_list()")
...
graph.automorphisms <- function(graph , colors , sh = c("fm","f","fs","fl","flm","fsm")) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.automorphisms()", "count_automorphisms()")
   count_automorphisms(graph = graph, colors = colors, sh = sh)
} # nocov end
...
graph.diversity <- function(graph , weights = NULL , vids = V(graph)) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.diversity()", "diversity()")
...
graph.isocreate <- function(size , number , directed = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.isocreate()", "graph_from_isomorphism_class()")
...
graph.knn <- function(graph , vids = V(graph) , mode = c("all","out","in","total") , neighbor.degree.mode = c("all","out","in","total") , weights = NULL) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.knn()", "knn()")
...
graph.lcf <- function(n , shifts , repeats = 1) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.lcf()", "graph_from_lcf()")
...
graph.maxflow <- function(graph , source , target , capacity = NULL) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.maxflow()", "max_flow()")
...
graph.strength <- function(graph , vids = V(graph) , mode = c("all","out","in","total") , loops = TRUE , weights = NULL) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "graph.strength()", "strength()")
...
has.multiple <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "has.multiple()", "any_multiple()")
...
hrg.consensus <- function(graph , hrg = NULL , start = FALSE , num.samples = 10000) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "hrg.consensus()", "consensus_tree()")
...
hrg.create <- function(graph , prob) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "hrg.create()", "hrg()")
...
hrg.dendrogram <- function(hrg) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "hrg.dendrogram()", "hrg_tree()")
   hrg_tree(hrg = hrg)
} # nocov end
...
hrg.game <- function(hrg) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "hrg.game()", "sample_hrg()")
   sample_hrg(hrg = hrg)
} # nocov end
...
interconnected.islands.game <- function(islands.n , islands.size , islands.pin , n.inter) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "interconnected.islands.game()", "sample_islands()")
...
is.connected <- function(graph , mode = c("weak","strong")) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.connected()", "is_connected()")
...
is.dag <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.dag()", "is_dag()")
   is_dag(graph = graph)
} # nocov end
...
is.loop <- function(graph , eids = E(graph)) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.loop()", "which_loop()")
...
is.minimal.separator <- function(graph , candidate) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.minimal.separator()", "is_min_separator()")
...
is.multiple <- function(graph , eids = E(graph)) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.multiple()", "which_multiple()")
...
#' @keywords internal
#' @export
is.mutual <- function(graph , eids = E(graph)) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.mutual()", "which_mutual()")
...
is.separator <- function(graph , candidate) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.separator()", "is_separator()")
...
is.simple <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "is.simple()", "is_simple()")
...
k.regular.game <- function(no.of.nodes , k , directed = FALSE , multiple = FALSE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "k.regular.game()", "sample_k_regular()")
...
largest.cliques <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "largest.cliques()", "largest_cliques()")
...
minimal.st.separators <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "minimal.st.separators()", "min_st_separators()")
...
maximum.cardinality.search <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "maximum.cardinality.search()", "max_cardinality()")
...
minimum.size.separators <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "minimum.size.separators()", "min_separators()")
...
page.rank <- function(graph , algo = c("prpack","arpack") , vids = V(graph) , directed = TRUE , damping = 0.85 , personalized = NULL , weights = NULL , options = NULL) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "page.rank()", "page_rank()")
...
path.length.hist <- function(graph , directed = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "path.length.hist()", "distance_table()")
...
permute.vertices <- function(graph , permutation) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "permute.vertices()", "permute()")
...
sbm.game <- function(n , pref.matrix , block.sizes , directed = FALSE , loops = FALSE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "sbm.game()", "sample_sbm()")
...
stCuts <- function(graph , source , target) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "stCuts()", "st_cuts()")
...
stMincuts <- function(graph , source , target , capacity = NULL) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "stMincuts()", "st_min_cuts()")
...
static.fitness.game <- function(no.of.edges , fitness.out , fitness.in = NULL , loops = FALSE , multiple = FALSE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "static.fitness.game()", "sample_fitness()")
...
static.power.law.game <- function(no.of.nodes , no.of.edges , exponent.out , exponent.in = -1 , loops = FALSE , multiple = FALSE , finite.size.correction = TRUE) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "static.power.law.game()", "sample_fitness_pl()")
...
triad.census <- function(graph) { # nocov start
   lifecycle::deprecate_soft("1.6.0", "triad.census()", "triad_census()")
