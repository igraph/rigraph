...
cluster_leading_eigen <- function(
  ...
  # Function call using autogenerated implementation with callback support
  # Get the environment for the ARPACK multiplier helper function
  levc_arp_env <- environment(igraph.i.levc.arp)
