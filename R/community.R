...
create.communities <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "create.communities()", "make_clusters()")
  make_clusters(
    graph = graph,
...
showtrace <- function(communities) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "showtrace()", "show_trace()")
...
optimal.community <- function(graph, weights = NULL) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "optimal.community()", "cluster_optimal()")
...
mod.matrix <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "mod.matrix()", "modularity_matrix()")
  modularity_matrix(
    graph = graph,
    membership = membership,
    weights = weights,
...
is.hierarchical <- function(communities) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "is.hierarchical()", "is_hierarchical()")
...
infomap.community <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "infomap.community()", "cluster_infomap()")
  cluster_infomap(
    graph = graph,
    e.weights = e.weights,
    v.weights = v.weights,
...
dendPlot <- function(x, mode = igraph_opt("dend.plot.type"), ...) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "dendPlot()", "plot_dendrogram()")
...
cutat <- function(communities, no, steps) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "cutat()", "cut_at()")
...
contract.vertices <- function(
  ...
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "contract.vertices()", "contract()")
  contract(
    graph = graph,
    mapping = mapping,
...
code.length <- function(communities) {
  # nocov start
  lifecycle::deprecate_warn("2.2.0", "code.length()", "code_len()")
