...
cluster_leading_eigen <- function(
  ...
  if (!is.null(callback)) {
    lifecycle::deprecate_stop(
      "2.1.0",
      "cluster_leading_eigen(callback = )",
      details = "The callback functionality has been removed."
    )
  }
  if (!is.null(extra)) {
    lifecycle::deprecate_stop(
      "2.1.0",
      "cluster_leading_eigen(extra = )",
      details = "The extra functionality has been removed."
    )
  }
  ...
  # Function call using autogenerated implementation
