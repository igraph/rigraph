...
#'   \describe{
#'     \item{Bull}{
#'       The bull graph, 5 vertices, 5 edges, resembles to the head
...
#'     }
#'     \item{Coxeter}{
#'       A non-Hamiltonian cubic symmetric graph with 28 vertices and
#'       42 edges.
#'     }
#'     \item{Cubical}{
...
#'     }
#'     \item{Franklin}{
#'       This is a graph whose embedding
...
#'     }
#'     \item{Frucht}{
#'       The Frucht Graph is the smallest
...
#'     }
#'     \item{Heawood}{
#'       The Heawood graph is an undirected graph with 14 vertices and
...
#'       A Platonic solid with 12 vertices and 30
#'       edges.
#'     }
#'     \item{Krackhardt kite}{
#'       A social network with 10 vertices and 18
...
#'     }
#'     \item{Levi}{
#'       The graph is a 4-arc transitive cubic graph, it has 30
...
#'       A connected graph with 16 vertices and 27 edges
...
#'     }
#'     \item{Nonline}{
#'       A graph whose connected components are the 9 graphs whose
...
#'       A smallest nontrivial graph whose automorphism
...
#'     }
#'     \item{Thomassen}{
#'       The smallest hypotraceable graph, on 34 vertices and 52
...
#'     }
#'     \item{Tutte}{
#'       Tait's Hamiltonian graph conjecture states that every
...
#'       Returns a 12-vertex, triangle-free graph with
