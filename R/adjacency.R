...
#'   \describe{
#'     \item{"directed"}{
#'       The graph will be directed and a matrix element
...
#'     }
#'     \item{"lower"}{
#'       An undirected graph will be created, only
