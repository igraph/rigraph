...
running.mean <- function(v, binwidth) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "running.mean()", "running_mean()")
...
igraph.sample <- function(low, high, length) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "igraph.sample()", "sample_seq()")
...
convex.hull <- function(data) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "convex.hull()", "convex_hull()")
