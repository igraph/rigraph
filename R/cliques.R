...
maximal.independent.vertex.sets <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "maximal.independent.vertex.sets()", "maximal_ivs()")
...
maximal.cliques.count <- function(graph, min = NULL, max = NULL, subset = NULL) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "maximal.cliques.count()", "count_max_cliques()")
...
maximal.cliques <- function(graph, min = NULL, max = NULL, subset = NULL, file = NULL) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "maximal.cliques()", "max_cliques()")
...
largest.independent.vertex.sets <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "largest.independent.vertex.sets()", "largest_ivs()")
...
largest.cliques <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "largest.cliques()", "largest_cliques()")
...
independent.vertex.sets <- function(graph, min = NULL, max = NULL) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "independent.vertex.sets()", "ivs()")
...
independence.number <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "independence.number()", "ivs_size()")
...
clique.number <- function(graph) { # nocov start
  lifecycle::deprecate_soft("1.7.0", "clique.number()", "clique_num()")
