test_that("motif finding works", {
  ...
  expect_that(
    ...
    equals(c(
      0.654821903845065, 0.666289144345659,
      0.668393831285275
    ))
  )
  ...
  expect_that(
    ...
    equals(c(
      0.443959957465819, 0.441952797125797,
      0.446004870037941
    ))
  )
  ...
  expect_that(m0 / m, equals(c(
    NA, NA, 0.653972107372707, NA,
  ...
  expect_that(m1 / m, equals(c(
    NA, NA, 0.669562138856225, NA,
  ...
  expect_that(m2 / m, equals(c(
    NA, NA, 0.666451718949538, NA,
  ...
  expect_that(m3 / m, equals(c(
    NA, NA, 0.445611905574732, NA,
  ...
  expect_that(m4 / m, equals(c(
    NA, NA, 0.439251981944392, NA,
  ...
  expect_that(m5 / m, equals(c(
    NA, NA, 0.439985332979302, NA,
