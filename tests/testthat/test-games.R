...
test_that("sample_bipartite works -- directed gnp", {
  g_rand_bip_dir <- sample_bipartite(
    10,
    5,
    type = "gnp",
    p = .1,
  ...
  g_rand_bip_in <- sample_bipartite(
    10,
    5,
    type = "gnp",
    p = .1,
...
test_that("sample_bipartite works -- directed gnm", {
  g_rand_bip_gnm_dir <- sample_bipartite(
    10,
    5,
    type = "gnm",
    m = 8,
  ...
  g_rand_bip_gnm_in <- sample_bipartite(
    10,
    5,
    type = "gnm",
    m = 8,
  ...
  g_rand_bip_full <- sample_bipartite(
    10,
    5,
    type = "gnp",
    p = 0.9999,
  ...
  g_rand_bip_edges <- sample_bipartite(
    10,
    5,
    type = "gnm",
    m = 99,
