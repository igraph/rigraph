...
test_that("General scan-stat works, US, scan-1, unweighted, directed", {
  ...
  expect_that(digest::digest(s1o), equals("ac463c21b2b6bc91abf82f0141a4a7d4"))

  s1i <- local_scan(g, k = 1, weighted = FALSE, mode = "in")
  expect_that(digest::digest(s1i), equals("13fdaaeec54118e217821b56d8c3ff03"))
})
...
test_that("General scan-stat works, US, scan-1, weighted, directed", {
  ...
  expect_that(digest::digest(s1i), equals("f5f07eebb907ae0a244195a20971be11"))
})
