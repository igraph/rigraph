...
test_that("ring_impl basic", {
  withr::local_seed(20250909)
  local_igraph_options(print.id = FALSE)
  expect_snapshot(ring_impl(n = 5, directed = FALSE, mutual = FALSE, circular = TRUE))
  expect_snapshot(ring_impl(n = 4, directed = TRUE, mutual = FALSE, circular = FALSE))
})
...
test_that("kary_tree_impl basic", {
  withr::local_seed(20250909)
  local_igraph_options(print.id = FALSE)
  expect_snapshot(kary_tree_impl(n = 7, children = 2, type = c("out", "in", "undirected")))
  expect_snapshot(kary_tree_impl(n = 10, children = 3, type = c("in", "out", "undirected")))
})
...
test_that("growing_random_game_impl basic", {
  withr::local_seed(20250909)
  local_igraph_options(print.id = FALSE)
  expect_snapshot(growing_random_game_impl(n = 10, m = 1, directed = TRUE, citation = FALSE))
})
...
test_that("watts_strogatz_game_impl basic", {
  withr::local_seed(20250909)
  local_igraph_options(print.id = FALSE)
  expect_snapshot(watts_strogatz_game_impl(dim = 1, size = 10, nei = 2, p = 0.1))
})
...
test_that("distances_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(distances_impl(graph = g, from = V(g), to = V(g), mode = c("out", "in", "all", "total")))
})
...
test_that("diameter_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(10)
  expect_snapshot(diameter_impl(graph = g, directed = FALSE, unconnected = TRUE))
})
...
test_that("get_shortest_paths_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(get_shortest_paths_impl(graph = g, from = 1, to = 3, mode = c("out", "in", "all", "total")))
})
...
test_that("subcomponent_impl basic", {
  ...
  expect_snapshot(subcomponent_impl(graph = g, v = 1, mode = c("all", "out", "in")))
})
...
test_that("closeness_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(closeness_impl(graph = g, vids = V(g), mode = c("out", "in", "all", "total")))
})
...
test_that("harmonic_centrality_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_star(5, mode = "undirected")
  expect_snapshot(harmonic_centrality_impl(graph = g, vids = V(g), mode = c("out", "in", "all", "total")))
})
...
test_that("pagerank_impl basic", {
  ...
  expect_snapshot(pagerank_impl(graph = g, vids = V(g), directed = TRUE, damping = 0.85))
})
...
test_that("create_bipartite_impl basic", {
  withr::local_seed(20250909)
  local_igraph_options(print.id = FALSE)
  expect_snapshot(create_bipartite_impl(types = c(FALSE, FALSE, TRUE, TRUE), edges = c(0, 2, 0, 3, 1, 2, 1, 3), directed = FALSE))
})
...
test_that("neighborhood_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(neighborhood_impl(graph = g, order = 1, vids = V(g), mode = c("all", "out", "in")))
})
...
test_that("neighborhood_size_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(neighborhood_size_impl(graph = g, order = 1, vids = V(g), mode = c("all", "out", "in")))
})
...
test_that("get_adjacency_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(3)
  expect_snapshot(get_adjacency_impl(graph = g, type = c("both", "upper", "lower")))
})
...
test_that("read_graph_edgelist_impl basic", {
  ...
  expect_snapshot(read_graph_edgelist_impl(instream = tmp, n = 3, directed = FALSE))
  unlink(tmp)
})
...
test_that("compare_communities_impl basic", {
  ...
  comm1 <- c(1, 1, 2, 2, 3, 3)
  comm2 <- c(1, 1, 2, 2, 2, 3)
  expect_snapshot(compare_communities_impl(comm1 = comm1, comm2 = comm2, method = "vi"))
})
...
test_that("connect_neighborhood_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(connect_neighborhood_impl(graph = g, order = 1, mode = c("all", "out", "in")))
})
...
test_that("eccentricity_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(eccentricity_impl(graph = g, vids = V(g), mode = c("out", "in", "all")))
})
...
test_that("voronoi_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(10)
  expect_snapshot(voronoi_impl(graph = g, generators = c(1, 5), mode = c("out", "in", "all")))
})
...
test_that("independent_vertex_sets_impl basic", {
  ...
  local_igraph_options(print.id = FALSE)
  g <- make_ring(5)
  expect_snapshot(independent_vertex_sets_impl(graph = g, min_size = 1, max_size = 0))
})
