...
- The callback is optional, `callback = NULL` uses a sensible built-in
  callback or an existing function
- See [`tools/AGENTS.md`](https://r.igraph.org/tools/AGENTS.md) for
