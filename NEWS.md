...
- `console()` and `tkplot()` have been removed from the package; users should use alternative terminal and interactive plotting tools (#39, #2187).
...
- Function reference pages are formatted correctly again after a regression (#2591).
