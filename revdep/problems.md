...
*   checking tests ... ERROR
    ...
    Last 13 lines of output:
       ...
       19. │           └─dplyr (local) eval()
       20. ├─tidygraph::group_leading_eigen(n_groups = 32)
       21. │ └─igraph::cut_at(group, no = n_groups)
       22. │   └─base::stop("Not a hierarchical communitity structure")
       23. └─base::.handleSimpleError(...)
       24.   └─dplyr (local) h(simpleError(msg, call))
       25.     └─rlang::abort(message, class = error_class, parent = parent, call = error_call)
      
      [ FAIL 1 | WARN 0 | SKIP 0 | PASS 278 ]
      Error: Test failures
      Execution halted
    ```
