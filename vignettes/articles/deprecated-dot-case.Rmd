...
Currently, for each function both alternatives work, but we'll incrementally remove the dot case functions,
first emitting deprecation messages when they are used, then in a further version warnings, until they actually result in an error.
