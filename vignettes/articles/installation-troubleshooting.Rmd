...
If you have an Anaconda environment active, deactivate them _before_ compiling igraph. Having conda environments active are known to cause a number of issues, both during compilation and later during usage.
