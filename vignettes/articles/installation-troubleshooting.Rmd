...
CRAN provides Windows and macOS binaries only for the last two minor releases of R (e.g. 4.4 and 4.3), but not for older ones (e.g. 4.2). Make sure that you are using one of these supported R versions. Refer to https://r-project.org/ to find out what the latest R version is at the moment.
