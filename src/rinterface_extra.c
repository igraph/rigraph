...
SEXP Rx_igraph_handle_safe_eval_result_in_env(SEXP result, SEXP rho) {
  ...
  switch (Rx_igraph_safe_eval_classify_result(result)) {
    ...
    case SAFEEVAL_ERROR:
      /* extract the error message, call IGRAPH_LOCAL_FINALLY_FREE() and then throw
...
igraph_error_t Rz_SEXP_to_attr_comb(SEXP input, igraph_attribute_combination_t *comb) {
  ...
  IGRAPH_LOCAL_FINALLY(igraph_attribute_combination_destroy, comb);
...
igraph_error_t Rx_igraph_attribute_add_vertices(igraph_t *graph, igraph_integer_t nv,
  ...
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &news);
  ...
  IGRAPH_LOCAL_FINALLY_CLEAN(1);      /* news */
...
igraph_error_t Rx_igraph_attribute_add_edges(igraph_t *graph, const igraph_vector_int_t *edges,
  ...
  /* Now append the new values */
  Rx_igraph_attribute_add_edges_append(eal, edges, nattr);
...
/* void Rx_igraph_attribute_delete_edges(igraph_t *graph,  */
...
igraph_error_t Rx_igraph_attribute_permute_edges_same(const igraph_t *graph,
                                          igraph_t *newgraph,
                                          const igraph_vector_int_t *idx) {
...
igraph_error_t Rx_igraph_attribute_permute_edges_diff(const igraph_t *graph,
                                          igraph_t *newgraph,
                                          const igraph_vector_int_t *idx) {
...
igraph_error_t Rx_igraph_attribute_permute_edges(const igraph_t *graph,
                                    igraph_t *newgraph, const igraph_vector_int_t *idx) {
  if (graph==newgraph) {
    return Rx_igraph_attribute_permute_edges_same(graph, newgraph, idx);
  } else {
    return Rx_igraph_attribute_permute_edges_diff(graph, newgraph, idx);
  }
}

igraph_error_t Rx_igraph_attribute_get_info(const igraph_t *graph,
  ...
  for (igraph_integer_t i=0; i<3; i++) {
    ...
    if (n) {                    /* return names */
      ...
      Rx_igraph_SEXP_to_strvector_copy(names, n);
      UNPROTECT(1);
    }
...
igraph_bool_t Rx_igraph_attribute_has_attr(const igraph_t *graph,
  ...
  res=Rx_igraph_getListElement(VECTOR_ELT(graph->attr, attrnum), name);
  return res != R_NilValue;
}

igraph_error_t Rx_igraph_attribute_gettype(const igraph_t *graph,
...
igraph_error_t Rx_igraph_attribute_get_numeric_graph_attr(const igraph_t *graph,
                                              const char *name,
...
igraph_error_t Rx_igraph_attribute_get_bool_graph_attr(const igraph_t *graph,
                                           const char *name,
...
igraph_error_t Rx_igraph_attribute_get_numeric_vertex_attr(const igraph_t *graph,
                                               const char *name,
                                               igraph_vs_t vs,
                                               igraph_vector_t *value) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  if (igraph_vs_is_all(&vs)) {
    Rz_SEXP_to_vector_copy(AS_NUMERIC(va), &newvalue);
    ...
    *value=newvalue;
    ...
    IGRAPH_LOCAL_FINALLY(igraph_vit_destroy, &it);
...
igraph_error_t Rx_igraph_attribute_get_bool_vertex_attr(const igraph_t *graph,
                                            const char *name,
                                            igraph_vs_t vs,
                                            igraph_vector_bool_t *value) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  if (igraph_vs_is_all(&vs)) {
    Rz_SEXP_to_vector_bool_copy(va, &newvalue);
...
igraph_error_t Rx_igraph_attribute_get_string_vertex_attr(const igraph_t *graph,
                                              const char *name,
                                              igraph_vs_t vs,
                                              igraph_strvector_t *value) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  va=Rx_igraph_getListElement(val, name);
  if (va == R_NilValue) {
    IGRAPH_ERROR("No such attribute", IGRAPH_EINVAL);
  }
  if (!IS_CHARACTER(va)) {
  ...
  if (igraph_vs_is_all(&vs)) {
    Rx_igraph_SEXP_to_strvector_copy(va, value);
  } else {
    igraph_vit_t it;
    igraph_integer_t i=0;
    IGRAPH_CHECK(igraph_vit_create(graph, vs, &it));
...
igraph_error_t Rx_igraph_attribute_get_numeric_edge_attr(const igraph_t *graph,
                                             const char *name,
                                             igraph_es_t es,
                                             igraph_vector_t *value) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  if (igraph_es_is_all(&es)) {
    Rz_SEXP_to_vector_copy(AS_NUMERIC(ea), &newvalue);
    igraph_vector_destroy(value);
    *value=newvalue;
  } else {
    igraph_eit_t it;
    ...
    IGRAPH_LOCAL_FINALLY(igraph_eit_destroy, &it);
...
igraph_error_t Rx_igraph_attribute_get_bool_edge_attr(const igraph_t *graph,
                                          const char *name,
                                          igraph_es_t es,
                                          igraph_vector_bool_t *value) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  if (igraph_es_is_all(&es)) {
    Rz_SEXP_to_vector_bool_copy(ea, &newvalue);
    igraph_vector_bool_destroy(value);
    *value=newvalue;
  } else {
    igraph_eit_t it;
...
igraph_error_t Rx_igraph_attribute_get_string_edge_attr(const igraph_t *graph,
                                            const char *name,
                                            igraph_es_t es,
                                            igraph_strvector_t *value) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  if (igraph_es_is_all(&es)) {
    Rx_igraph_SEXP_to_strvector_copy(ea, value);
  } else {
    igraph_eit_t it;
    igraph_integer_t i=0;
    IGRAPH_CHECK(igraph_eit_create(graph, es, &it));
...
SEXP Rx_igraph_ac_sum_numeric(SEXP attr,
...
SEXP Rx_igraph_ac_prod_numeric(SEXP attr,
                              const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_min_numeric(SEXP attr,
                             const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_max_numeric(SEXP attr,
                             const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_random_numeric(SEXP attr,
                                const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_first_numeric(SEXP attr,
                               const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_last_numeric(SEXP attr,
                              const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_mean_numeric(SEXP attr,
                              const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_median_numeric(SEXP attr,
                                const igraph_vector_int_list_t *merges) {
  SEXP res;
  SEXP attr2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
...
SEXP Rx_igraph_ac_all_other(SEXP attr,
                           const igraph_vector_int_list_t *merges,
  ...
  for (igraph_integer_t i=0; i<len; i++) {
    ...
    SET_VECTOR_ELT(res, i, Rx_igraph_handle_safe_eval_result(l6));
    UNPROTECT(6);
    UNPROTECT(1);
  }
...
SEXP Rx_igraph_ac_func(SEXP attr,
                      const igraph_vector_int_list_t *merges,
                      SEXP func) {
  SEXP res, res2;
  igraph_integer_t len=igraph_vector_int_list_size(merges);
  ...
  for (igraph_integer_t i=0; i<len; i++) {
    ...
    SET_VECTOR_ELT(res, i, Rx_igraph_handle_safe_eval_result(l5));
    UNPROTECT(5);
    UNPROTECT(1);
  }
...
igraph_error_t Rx_igraph_attribute_combine_vertices(const igraph_t *graph,
                         igraph_t *newgraph,
                         const igraph_vector_int_list_t *merges,
  ...
  IGRAPH_LOCAL_FINALLY(igraph_free, TODO);
  ...
  IGRAPH_LOCAL_FINALLY(igraph_free, funcs);
  for (igraph_integer_t i=0; i<valno; i++) {
  ...
  for (igraph_integer_t i=0, j=0; i<valno; i++) {
    ...
    Rx_igraph_attribute_gettype(graph, &type,
    ...
    case IGRAPH_ATTRIBUTE_COMBINE_FUNCTION:
      ...
      SET_VECTOR_ELT(res, j, Rx_igraph_ac_func(va, merges, func));
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_SUM:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_sum_numeric(va, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "sum", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_PROD:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_prod_numeric(va, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "prod", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MIN:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_min_numeric(va, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "min", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MAX:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_max_numeric(va, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "max", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_RANDOM:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_random_numeric(va, merges));
      } else {
        SEXP tx = PROTECT(Rf_ScalarInteger(1));
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "sample",
                                                     tx));
        UNPROTECT(1);
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_FIRST:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_first_numeric(va, merges));
      } else {
        SEXP tx = PROTECT(Rf_ScalarInteger(1));
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "head",
                                                     tx));
        UNPROTECT(1);
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_LAST:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_last_numeric(va, merges));
      } else {
        SEXP tx = PROTECT(Rf_ScalarInteger(1));
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "tail",
                                                     tx));
        UNPROTECT(1);
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MEAN:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_mean_numeric(va, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "mean", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MEDIAN:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_median_numeric(va, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "median", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_CONCAT:
      SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(va, merges, "c", NULL));
      break;
    default:
      UNPROTECT(px);
...
igraph_error_t Rx_igraph_attribute_combine_edges(const igraph_t *graph,
                                    igraph_t *newgraph,
                                    const igraph_vector_int_list_t *merges,
                                    const igraph_attribute_combination_t *comb) {
  IGRAPH_LOCAL_FINALLY_STACK;
  ...
  for (igraph_integer_t i=0, j=0; i<ealno; i++) {
    ...
    /* What kind of attribute */
    Rx_igraph_attribute_gettype(graph, &type, IGRAPH_ATTRIBUTE_EDGE, name);
    ...
    case IGRAPH_ATTRIBUTE_COMBINE_FUNCTION:
      func = (SEXP) (void*) voidfunc;
      SET_VECTOR_ELT(res, j, Rx_igraph_ac_func(ea, merges, func));
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_SUM:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_sum_numeric(ea, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "sum", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_PROD:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_prod_numeric(ea, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "prod", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MIN:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_min_numeric(ea, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "min", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MAX:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_max_numeric(ea, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "max", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_RANDOM:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_random_numeric(ea, merges));
      } else {
        SEXP tx = PROTECT(Rf_ScalarInteger(1));
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "sample",
                                                     tx));
        UNPROTECT(1);
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_FIRST:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_first_numeric(ea, merges));
      } else {
        SEXP tx = PROTECT(Rf_ScalarInteger(1));
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "head",
                                                     tx));
        UNPROTECT(1);
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_LAST:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_last_numeric(ea, merges));
      } else {
        SEXP tx = PROTECT(Rf_ScalarInteger(1));
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "tail",
                                                     tx));
        UNPROTECT(1);
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MEAN:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_mean_numeric(ea, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "mean", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_MEDIAN:
      if (type==IGRAPH_ATTRIBUTE_NUMERIC) {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_median_numeric(ea, merges));
      } else {
        SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "median", NULL));
      }
      break;
    case IGRAPH_ATTRIBUTE_COMBINE_CONCAT:
      SET_VECTOR_ELT(res, j, Rx_igraph_ac_all_other(ea, merges, "c", NULL));
      break;
    default:
      UNPROTECT(px);
      IGRAPH_ERROR("Unknown attribute combination",
...
igraph_attribute_table_t Rx_igraph_attribute_table={
  &Rx_igraph_attribute_init, &Rx_igraph_attribute_destroy,
  &Rx_igraph_attribute_copy, &Rx_igraph_attribute_add_vertices,
  &Rx_igraph_attribute_permute_vertices,
  &Rx_igraph_attribute_combine_vertices,
  &Rx_igraph_attribute_add_edges,
  &Rx_igraph_attribute_permute_edges,
  &Rx_igraph_attribute_combine_edges,
  &Rx_igraph_attribute_get_info,
  &Rx_igraph_attribute_has_attr, &Rx_igraph_attribute_gettype,
  &Rx_igraph_attribute_get_numeric_graph_attr,
  &Rx_igraph_attribute_get_string_graph_attr,
  &Rx_igraph_attribute_get_bool_graph_attr,
  &Rx_igraph_attribute_get_numeric_vertex_attr,
  &Rx_igraph_attribute_get_string_vertex_attr,
  &Rx_igraph_attribute_get_bool_vertex_attr,
  &Rx_igraph_attribute_get_numeric_edge_attr,
  &Rx_igraph_attribute_get_string_edge_attr,
  &Rx_igraph_attribute_get_bool_edge_attr
};

igraph_attribute_table_t *Rx_igraph_attribute_oldtable;
...
static char Rx_igraph_error_reason[4096];
static int Rx_igraph_errors_count = 0;

static char Rx_igraph_warning_reason[4096];
static int Rx_igraph_warnings_count = 0;

static bool Rx_igraph_in_r_check = false;
...
void Rx_igraph_interrupt(void) {
  ...
  // stop(structure(list(message = Rx_igraph_error_reason), class = c("interrupt", "condition")))
  Rf_error("%s", Rx_igraph_error_reason);
}
...
void Rx_igraph_error_handler(const char *reason, const char *file,
  ...
  if (Rx_igraph_errors_count == 0 || !Rx_igraph_in_r_check) {
    ...
    if (!Rx_igraph_in_r_check) {
      IGRAPH_LOCAL_FINALLY_FREE();
      Rx_igraph_error();
    }
  }
  Rx_igraph_errors_count++;
...
igraph_error_t Rx_igraph_interrupt_handler(void *data) {
   ...
   * pending, we then call IGRAPH_LOCAL_FINALLY_FREE(), knowing that the upcoming
...
static void *Rx_igraph_altrep_from(SEXP vec, Rboolean writeable) {
...
static void *Rx_igraph_altrep_to(SEXP vec, Rboolean writeable) {
  SEXP data=R_altrep_data2(vec);
  if (data == R_NilValue) {
...
void Rx_igraph_init_handlers(DllInfo *dll) {
  igraph_rng_R_install();

  igraph_set_fatal_handler(Rx_igraph_fatal_handler);
  igraph_set_error_handler(Rx_igraph_error_handler);
  igraph_set_warning_handler(Rx_igraph_warning_handler);
  igraph_set_interruption_handler(Rx_igraph_interrupt_handler);
  igraph_set_attribute_table(&Rx_igraph_attribute_table);
}

SEXP Rx_igraph_set_verbose(SEXP verbose) {
  if (LOGICAL(verbose)[0]) {
    igraph_set_status_handler(Rx_igraph_status_handler);
    igraph_set_progress_handler(Rx_igraph_progress_handler);
  } else {
...
SEXP Ry_igraph_0orvector_to_SEXP(const igraph_vector_t *v) {
  SEXP result;
  if (v) {
    PROTECT(result=Ry_igraph_vector_to_SEXP(v));
  } else {
...
SEXP Rx_igraph_0orvector_int_to_SEXP(const igraph_vector_int_t *v) {
  SEXP result;
  if (v) {
    PROTECT(result=Ry_igraph_vector_int_to_SEXP(v));
  } else {
    PROTECT(result=R_NilValue);
  }
  UNPROTECT(1);
...
SEXP Rx_igraph_0orvector_int_to_SEXP_d(igraph_vector_int_t *v) {
  SEXP result;
  if (v) {
    PROTECT(result=Ry_igraph_vector_int_to_SEXP(v));
...
SEXP Rx_igraph_0orvector_int_to_SEXPp1(const igraph_vector_int_t *v) {
  SEXP result;
  if (v) {
    PROTECT(result=Ry_igraph_vector_int_to_SEXPp1(v));
  } else {
    PROTECT(result=R_NilValue);
  }
  UNPROTECT(1);
...
SEXP Rx_igraph_0orvector_bool_to_SEXP(const igraph_vector_bool_t *v) {
  SEXP result;
  if (v) {
    PROTECT(result=Ry_igraph_vector_bool_to_SEXP(v));
  } else {
    PROTECT(result=R_NilValue);
  }
  UNPROTECT(1);
...
SEXP Ry_igraph_0orvector_complex_to_SEXP(const igraph_vector_complex_t *v) {
  SEXP result;
  if (v) {
    PROTECT(result=Rx_igraph_vector_complex_to_SEXP(v));
  } else {
    PROTECT(result=R_NilValue);
  }
  UNPROTECT(1);
...
SEXP Rx_igraph_0ormatrix_to_SEXP(const igraph_matrix_t *m) {
  ...
  return Ry_igraph_matrix_to_SEXP(m);
}
...
SEXP Rx_igraph_0ormatrix_int_to_SEXP(const igraph_matrix_int_t *m) {
  ...
  return Ry_igraph_matrix_int_to_SEXP(m);
}
...
SEXP Ry_igraph_0ormatrix_complex_to_SEXP(const igraph_matrix_complex_t *m) {
  SEXP result;
  if (m) {
    PROTECT(result=Rx_igraph_matrix_complex_to_SEXP(m));
  } else {
    PROTECT(result=R_NilValue);
  }
  UNPROTECT(1);
...
static void free_graph(SEXP xp) {
  Rx_igraph_status_handler("Free graph external pointer.\n", NULL);
...
static igraph_error_t restore_pointer(SEXP graph, igraph_t *g) {
  ...
  Rx_igraph_status_handler("Restore graph external pointer.\n", NULL);

  igraph_vector_int_t from;
  Rz_SEXP_to_vector_int_copy(VECTOR_ELT(graph, igraph_t_idx_from), &from);
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &from);

  igraph_vector_int_t to;
  Rz_SEXP_to_vector_int_copy(VECTOR_ELT(graph, igraph_t_idx_to), &to);
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &to);
  ...
  IGRAPH_LOCAL_FINALLY_CLEAN(4); /* +1 for g */

  return IGRAPH_SUCCESS;
}

void Rx_igraph_restore_pointer(SEXP graph) {
  igraph_t g;
  IGRAPH_R_CHECK(restore_pointer(graph, &g));
  Rx_igraph_set_pointer(graph, &g);
}

igraph_t *Rx_igraph_get_pointer(SEXP graph) {
...
igraph_integer_t Rx_igraph_get_n(SEXP graph) {
  igraph_t *pgraph=Rx_igraph_get_pointer(graph);
  return pgraph->n;
}
...
igraph_bool_t Rx_igraph_get_directed(SEXP graph) {
  igraph_t *pgraph=Rx_igraph_get_pointer(graph);
...
void Rx_igraph_get_from(SEXP graph, igraph_vector_int_t* from) {
  igraph_t *pgraph=Rx_igraph_get_pointer(graph);
  *from = pgraph->from;
}
...
void Rx_igraph_get_to(SEXP graph, igraph_vector_int_t* to) {
  igraph_t *pgraph=Rx_igraph_get_pointer(graph);
  *to = pgraph->to;
}
...
SEXP Rx_igraph_vector_list_to_SEXP(const igraph_vector_list_t *list) {
  ...
  for (igraph_integer_t i=0; i<n; i++) {
    ...
    SET_VECTOR_ELT(result, i, Ry_igraph_vector_to_SEXP(v));
  }
...
SEXP Ry_igraph_vector_int_list_to_SEXP(const igraph_vector_int_list_t *list) {
  ...
  for (igraph_integer_t i=0; i<n; i++) {
    ...
    SET_VECTOR_ELT(result, i, Ry_igraph_vector_int_to_SEXP(v));
  }
...
SEXP Rx_igraph_vectorlist_int_to_SEXP(const igraph_vector_ptr_t *ptr) {
  SEXP result;
...
SEXP Rx_igraph_0orvector_int_list_to_SEXP(const igraph_vector_int_list_t *list) {
  SEXP result;
  if (list) {
    PROTECT(result=Ry_igraph_vector_int_list_to_SEXP(list));
  } else {
    PROTECT(result=R_NilValue);
  }
...
SEXP Rx_igraph_matrixlist_to_SEXP(const igraph_matrix_list_t *ptr) {
  ...
  for (igraph_integer_t i=0; i<n; i++) {
    ...
    SET_VECTOR_ELT(result, i, Ry_igraph_matrix_to_SEXP(v));
  }
...
SEXP Ry_igraph_hrg_to_SEXP(const igraph_hrg_t *hrg) {
  ...
  SET_VECTOR_ELT(result, 0, Ry_igraph_vector_int_to_SEXP(&hrg->left));
  SET_VECTOR_ELT(result, 1, Ry_igraph_vector_int_to_SEXP(&hrg->right));
  SET_VECTOR_ELT(result, 2, Ry_igraph_vector_to_SEXP(&hrg->prob));
  SET_VECTOR_ELT(result, 3, Ry_igraph_vector_int_to_SEXP(&hrg->edges));
  SET_VECTOR_ELT(result, 4, Ry_igraph_vector_int_to_SEXP(&hrg->vertices));
...
igraph_error_t Rz_SEXP_to_hrg_copy(SEXP shrg, igraph_hrg_t *hrg) {
  ...
  IGRAPH_CHECK(Rz_SEXP_to_vector_int_copy(VECTOR_ELT(shrg, 0), &hrg->left));
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &hrg->left);

  IGRAPH_CHECK(Rz_SEXP_to_vector_int_copy(VECTOR_ELT(shrg, 1), &hrg->right));
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &hrg->right);

  IGRAPH_CHECK(Rz_SEXP_to_vector_copy(VECTOR_ELT(shrg, 2), &hrg->prob));
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_destroy, &hrg->prob);

  IGRAPH_CHECK(Rz_SEXP_to_vector_int_copy(VECTOR_ELT(shrg, 3), &hrg->edges));
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &hrg->edges);

  IGRAPH_CHECK(Rz_SEXP_to_vector_int_copy(VECTOR_ELT(shrg, 4), &hrg->vertices));
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &hrg->vertices);

  IGRAPH_LOCAL_FINALLY_CLEAN(5);
...
SEXP Rx_igraph_arpack_unpack_complex(SEXP vectors, SEXP values, SEXP nev) {
  IGRAPH_LOCAL_FINALLY_STACK;
                                        /* Declarations */
  ...
  SEXP r_result, r_names;
                                        /* Convert input */
  if (0 != Rz_SEXP_to_igraph_matrix_copy(vectors, &c_vectors)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_matrix_destroy, &c_vectors);
  ...
  IGRAPH_LOCAL_FINALLY_CLEAN(1);
  PROTECT(values=Ry_igraph_matrix_to_SEXP(&c_values));
...
SEXP Ry_igraph_sparsemat_to_SEXP_triplet(const igraph_sparsemat_t *sp) {
  IGRAPH_LOCAL_FINALLY_STACK;
  SEXP res, names;
  ...
  if (nz > 0) {
    ...
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &i);

    igraph_vector_int_init(&j, nz);
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &j);

    igraph_vector_init(&x, nz);
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_destroy, &x);

    igraph_sparsemat_getelements(sp, &j, &i, &x);
    SET_VECTOR_ELT(res, 2, Ry_igraph_vector_int_to_SEXP(&i));
    SET_VECTOR_ELT(res, 3, Ry_igraph_vector_int_to_SEXP(&j));
    SET_VECTOR_ELT(res, 4, Ry_igraph_vector_to_SEXP(&x));

    igraph_vector_int_destroy(&i);
    igraph_vector_int_destroy(&j);
    igraph_vector_destroy(&x);
    IGRAPH_LOCAL_FINALLY_CLEAN(3);
  }
...
SEXP Ry_igraph_sparsemat_to_SEXP_cc(const igraph_sparsemat_t *sp) {
  SEXP res, names;
  int nz=igraph_sparsemat_nonzero_storage(sp);
...
SEXP Ry_igraph_sparsemat_to_SEXP(const igraph_sparsemat_t *sp) {
  if (igraph_sparsemat_is_triplet(sp)) {
    return Ry_igraph_sparsemat_to_SEXP_triplet(sp);
  } else {
    return Ry_igraph_sparsemat_to_SEXP_cc(sp);
  }
}
...
SEXP Rx_igraph_0orsparsemat_to_SEXP(const igraph_sparsemat_t *sp) {
  if (!sp) {
    ...
    return Ry_igraph_sparsemat_to_SEXP(sp);
  }
}
...
igraph_error_t Rz_SEXP_to_igraph_adjlist(SEXP vectorlist, igraph_adjlist_t *ptr) {
  ...
  IGRAPH_LOCAL_FINALLY(igraph_adjlist_destroy, ptr);
...
igraph_error_t Ry_igraph_SEXP_to_vector_int_list(SEXP vectorlist,
...
void Rz_SEXP_to_matrix(SEXP pakl, igraph_matrix_t *akl) {
  Rz_SEXP_to_vector(pakl, &akl->data);
...
igraph_error_t Rz_SEXP_to_matrix_int(SEXP pakl, igraph_matrix_int_t *akl) {
  IGRAPH_CHECK(Rz_SEXP_to_vector_int_copy(pakl, &akl->data));
  akl->nrow=INTEGER(GET_DIM(pakl))[0];
  akl->ncol=INTEGER(GET_DIM(pakl))[1];
...
void Rz_SEXP_to_vector_complex(SEXP pv, igraph_vector_complex_t *v) {
  v->stor_begin=(igraph_complex_t*) COMPLEX(pv);
  v->stor_end=v->stor_begin + Rf_xlength(pv);
  v->end=v->stor_end;
}

igraph_error_t Rz_SEXP_to_vector_complex_copy(SEXP pv, igraph_vector_complex_t *v) {
...
void Rz_SEXP_to_matrix_complex(SEXP pakl, igraph_matrix_complex_t *akl) {
  Rz_SEXP_to_vector_complex(pakl, &akl->data);
  akl->nrow=INTEGER(GET_DIM(pakl))[0];
  akl->ncol=INTEGER(GET_DIM(pakl))[1];
}

igraph_error_t Rz_SEXP_to_matrix_complex_copy(SEXP pakl, igraph_matrix_complex_t *akl) {
...
igraph_error_t Rz_SEXP_to_igraph_copy(SEXP graph, igraph_t *res) {
  IGRAPH_CHECK(igraph_copy(res, Rx_igraph_get_pointer(graph)));
...
igraph_error_t Rz_SEXP_to_igraph_vs(SEXP rit, igraph_t *graph, igraph_vs_t *it, igraph_vector_int_t *data) {
  ...
  IGRAPH_CHECK(Rz_SEXP_to_vector_int_copy(rit, data));
...
void Rz_SEXP_to_igraph_layout_drl_options(SEXP in, igraph_layout_drl_options_t *opt) {
  opt->edge_cut = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "edge.cut")))[0];
  opt->init_iterations   = (igraph_integer_t) REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "init.iterations")))[0];
  opt->init_temperature  = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "init.temperature")))[0];
  opt->init_attraction   = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "init.attraction")))[0];
  opt->init_damping_mult = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "init.damping.mult")))[0];
  opt->liquid_iterations   = (igraph_integer_t) REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "liquid.iterations")))[0];
  opt->liquid_temperature  = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "liquid.temperature")))[0];
  opt->liquid_attraction   = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "liquid.attraction")))[0];
  opt->liquid_damping_mult = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "liquid.damping.mult")))[0];
  opt->expansion_iterations   = (igraph_integer_t) REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "expansion.iterations")))[0];
  opt->expansion_temperature  = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "expansion.temperature")))[0];
  opt->expansion_attraction   = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "expansion.attraction")))[0];
  opt->expansion_damping_mult = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "expansion.damping.mult")))[0];
  opt->cooldown_iterations   = (igraph_integer_t) REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "cooldown.iterations")))[0];
  opt->cooldown_temperature  = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "cooldown.temperature")))[0];
  opt->cooldown_attraction   = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "cooldown.attraction")))[0];
  opt->cooldown_damping_mult = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "cooldown.damping.mult")))[0];
  opt->crunch_iterations   = (igraph_integer_t) REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "crunch.iterations")))[0];
  opt->crunch_temperature  = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "crunch.temperature")))[0];
  opt->crunch_attraction   = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "crunch.attraction")))[0];
  opt->crunch_damping_mult = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "crunch.damping.mult")))[0];
  opt->simmer_iterations   = (igraph_integer_t) REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "simmer.iterations")))[0];
  opt->simmer_temperature  = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "simmer.temperature")))[0];
  opt->simmer_attraction   = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "simmer.attraction")))[0];
  opt->simmer_damping_mult = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "simmer.damping.mult")))[0];
}
...
void Rz_SEXP_to_igraph_arpack_options(SEXP in, igraph_arpack_options_t *opt) {
  ...
  opt -> bmat[0] = CHAR(STRING_ELT(AS_CHARACTER
                                   (Rx_igraph_getListElement(in, "bmat")), 0))[0];
  opt -> n = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "n")))[0];
  tmpstr=CHAR(STRING_ELT(AS_CHARACTER(Rx_igraph_getListElement(in, "which")), 0));
  opt -> which[0]=tmpstr[0]; opt -> which[1]=tmpstr[1];
  opt -> nev = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "nev")))[0];
  opt -> tol = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "tol")))[0];
  opt -> ncv = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "ncv")))[0];
  opt -> ldv = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "ldv")))[0];
  opt -> ishift = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "ishift")))[0];
  opt -> mxiter = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "maxiter")))[0];
  opt -> nb = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "nb")))[0];
  opt -> mode = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "mode")))[0];
  opt -> start = INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "start")))[0];
  opt -> lworkl = 0;
  opt -> sigma = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "sigma")))[0];
  opt -> sigmai = REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "sigmai")))[0];
  opt -> info = opt -> start;
...
igraph_error_t Rz_SEXP_to_igraph_eigen_which(SEXP in, igraph_eigen_which_t *out) {
  SEXP pos=PROTECT(AS_CHARACTER(Rx_igraph_getListElement(in, "pos")));
  SEXP balance=PROTECT(AS_CHARACTER(Rx_igraph_getListElement(in, "balance")));
  ...
  out->howmany=INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "howmany")))[0];
  out->il=INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "il")))[0];
  out->iu=INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "iu")))[0];
  out->vl=REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "vl")))[0];
  out->vu=REAL(AS_NUMERIC(Rx_igraph_getListElement(in, "vu")))[0];
  out->vestimate=INTEGER(AS_INTEGER(Rx_igraph_getListElement(in, "vestimate")))[0];
...
SEXP Rx_igraph_copy_from(SEXP graph)
{
  igraph_vector_int_t from;
  Rx_igraph_get_from(graph, &from);
  return Ry_igraph_vector_int_to_SEXP(&from);
}

SEXP Rx_igraph_copy_to(SEXP graph)
{
  igraph_vector_int_t to;
  Rx_igraph_get_to(graph, &to);
  return Ry_igraph_vector_int_to_SEXP(&to);
}

SEXP Rx_igraph_copy_env(SEXP graph)
{
  return Rf_duplicate(Rx_igraph_graph_env(graph));
}

SEXP Rx_igraph_mybracket(SEXP graph, SEXP pidx) {
  int idx=INTEGER(pidx)[0]-1;
  return Rf_duplicate(VECTOR_ELT(graph, idx));
}

SEXP Rx_igraph_mybracket2(SEXP graph, SEXP pidx1, SEXP pidx2) {
  int idx1=INTEGER(pidx1)[0]-1;
  int idx2=INTEGER(pidx2)[0]-1;
  return Rf_duplicate(VECTOR_ELT(VECTOR_ELT(graph, idx1), idx2));
}

SEXP Rx_igraph_mybracket2_names(SEXP graph, SEXP pidx1, SEXP pidx2) {
  SEXP result;
  int idx1=INTEGER(pidx1)[0]-1;
  int idx2=INTEGER(pidx2)[0]-1;
...
SEXP Rx_igraph_mybracket2_copy(SEXP graph, SEXP pidx1, SEXP pidx2) {
  int idx1=INTEGER(pidx1)[0]-1;
  int idx2=INTEGER(pidx2)[0]-1;
  return Rf_duplicate(VECTOR_ELT(VECTOR_ELT(graph, idx1), idx2));
}

SEXP Rx_igraph_mybracket2_set(SEXP graph, SEXP pidx1, SEXP pidx2,
                             SEXP value) {
  SEXP newgraph;
  int idx1=INTEGER(pidx1)[0]-1;
  int idx2=INTEGER(pidx2)[0]-1;
...
SEXP Rx_igraph_mybracket3_set(SEXP graph, SEXP pidx1, SEXP pidx2,
...
SEXP Rx_igraph_add_edges_manual(SEXP graph, SEXP edges) {
  ...
  IGRAPH_LOCAL_FINALLY_STACK;
  Rz_SEXP_to_vector_int_copy(edges, &v);
...
SEXP Rx_igraph_create(SEXP edges, SEXP pn, SEXP pdirected) {
...
SEXP Rx_igraph_diameter(SEXP graph, SEXP pdirected, SEXP punconnected,
                       SEXP pweights) {
  ...
  if (!Rf_isNull(pweights)) {
    Rz_SEXP_to_vector(pweights, &weights);
  }
...
SEXP Rx_igraph_get_diameter(SEXP graph, SEXP pdirected, SEXP punconnected,
                           SEXP pweights) {
...
SEXP Rx_igraph_farthest_points(SEXP graph, SEXP pdirected, SEXP punconnected,
                              SEXP pweights) {
...
SEXP Rx_igraph_subcomponent(SEXP graph, SEXP pvertex, SEXP pmode) {
...
SEXP Rx_igraph_shortest_paths(SEXP graph, SEXP pvids, SEXP pto,
  ...
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_igraph_vs(pvids, &g, &vs, &vs_data);
  Rz_SEXP_to_igraph_vs(pto, &g, &to, &to_data);
  if (Rf_isNull(weights)) {
    pw=0;
  } else {
    Rz_SEXP_to_vector(weights, &w);
...
SEXP Rx_igraph_barabasi_game(SEXP pn, SEXP ppower, SEXP pm, SEXP poutseq,
  ...
  if (have_outseq) {
    Rz_SEXP_to_vector_int_copy(poutseq, &outseq);
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &outseq);
    myoutseq = &outseq;
  }

  if (!Rf_isNull(pstart)) {
    Rz_SEXP_to_igraph(pstart, &start);
    ppstart=&start;
  }
...
SEXP Rx_igraph_layout_fruchterman_reingold(SEXP graph, SEXP coords,
  ...
  if (!Rf_isNull(coords)) {
    if (0 != Rz_SEXP_to_igraph_matrix_copy(coords, &c_coords)) {
      igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
    }
  } else {
    igraph_matrix_init(&c_coords, 0, 0);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_matrix_destroy, &c_coords);
  c_niter=(igraph_integer_t) REAL(niter)[0];
  c_start_temp=REAL(start_temp)[0];
  if (!Rf_isNull(weights)) { Rz_SEXP_to_vector(weights, &c_weights); }
  if (!Rf_isNull(minx)) { Rz_SEXP_to_vector(minx, &c_minx); }
  if (!Rf_isNull(maxx)) { Rz_SEXP_to_vector(maxx, &c_maxx); }
...
SEXP Rx_igraph_layout_fruchterman_reingold_3d(SEXP graph, SEXP coords,
                                             SEXP niter, SEXP start_temp,
                                             SEXP weights,
                                             SEXP minx, SEXP maxx,
                                             SEXP miny, SEXP maxy,
...
SEXP Rx_igraph_layout_kamada_kawai(SEXP graph, SEXP coords, SEXP maxiter,
...
SEXP Rx_igraph_layout_kamada_kawai_3d(SEXP graph, SEXP coords, SEXP maxiter,
...
SEXP Rx_igraph_layout_graphopt(SEXP graph, SEXP pniter, SEXP pcharge,
...
SEXP Rx_igraph_layout_lgl(SEXP graph, SEXP pmaxiter, SEXP pmaxdelta,
...
SEXP Rx_igraph_get_shortest_paths(SEXP graph, SEXP pfrom, SEXP pto,
  ...
  IGRAPH_R_CHECK(Rw_get_int_scalar(pfrom, 0, &from));
  igraph_vs_t to;
  ...
  if (verts) {
    ...
    for (igraph_integer_t i=0; i<no; i++) {
      SET_VECTOR_ELT(result1, i, Ry_igraph_vector_int_to_SEXP(igraph_vector_int_list_get_ptr(&list, i)));
    }
  ...
  if (edges) {
    ...
    for (igraph_integer_t i=0; i<no; i++) {
      SET_VECTOR_ELT(result2, i, Ry_igraph_vector_int_to_SEXP(igraph_vector_int_list_get_ptr(&elist, i)));
    }
  ...
  if (pred) {
    SET_VECTOR_ELT(result, 2, Ry_igraph_vector_int_to_SEXP(&predvec));
    igraph_vector_int_destroy(&predvec);
  } else {
    SET_VECTOR_ELT(result, 2, R_NilValue);
  }
  if (inbound) {
    SET_VECTOR_ELT(result, 3, Ry_igraph_vector_int_to_SEXP(&inboundvec));
...
SEXP Rx_igraph_star(SEXP pn, SEXP pmode, SEXP pcenter) {

  igraph_t g;
  igraph_integer_t n;
  IGRAPH_R_CHECK(Rw_get_int_scalar(pn, 0, &n));
  igraph_integer_t mode;
  IGRAPH_R_CHECK(Rw_get_int_scalar(pmode, 0, &mode));
  igraph_integer_t center;
  IGRAPH_R_CHECK(Rw_get_int_scalar(pcenter, 0, &center));
  SEXP result;
...
SEXP Rx_igraph_ring(SEXP pn, SEXP pdirected, SEXP pmutual, SEXP pcircular) {
...
SEXP Rx_igraph_kary_tree(SEXP pn, SEXP pchildren, SEXP pmode) {
...
SEXP Rx_igraph_full(SEXP pn, SEXP pdirected, SEXP ploops) {
...
SEXP Rx_igraph_random_sample(SEXP plow, SEXP phigh, SEXP plength) {
...
SEXP Rx_igraph_degree_sequence_game(SEXP pout_seq, SEXP pin_seq,
                                   SEXP pmethod) {
  igraph_t g;
  ...
  if (!Rf_isNull(pin_seq)) {
    IGRAPH_R_CHECK(Rz_SEXP_to_vector_int_copy(pin_seq, &inseq));
  } else {
    IGRAPH_R_CHECK(igraph_vector_int_init(&inseq, 0));
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &inseq);
...
SEXP Rx_igraph_transitivity_local_undirected_all(SEXP graph, SEXP mode) {
...
SEXP Rx_igraph_read_graph_edgelist(SEXP pvfile, SEXP pn, SEXP pdirected) {
  igraph_t g;
  igraph_integer_t n=(igraph_integer_t) REAL(pn)[0];
  igraph_bool_t directed=LOGICAL(pdirected)[0];
  FILE *file;
...
SEXP Rx_igraph_read_graph_ncol(SEXP pvfile, SEXP ppredef,
...
SEXP Rx_igraph_write_graph_ncol(SEXP graph, SEXP file, SEXP pnames,
                               SEXP pweights) {
  igraph_t g;
  FILE *stream;
...
SEXP Rx_igraph_read_graph_lgl(SEXP pvfile, SEXP pnames, SEXP pweights, SEXP pdirected) {
  igraph_t g;
  igraph_bool_t names=LOGICAL(pnames)[0];
  igraph_add_weights_t weights=INTEGER(pweights)[0];
  igraph_bool_t directed=LOGICAL(pdirected)[0];
...
SEXP Rx_igraph_write_graph_lgl(SEXP graph, SEXP file, SEXP pnames,
...
SEXP Rx_igraph_decompose(SEXP graph, SEXP pmode, SEXP pmaxcompno,
                        SEXP pminelements) {
  ...
  IGRAPH_LOCAL_FINALLY(igraph_graph_list_destroy, &comps);
  IGRAPH_R_CHECK(igraph_decompose(&g, &comps, mode, maxcompno, minelements));
  PROTECT(result=Ry_igraph_graphlist_to_SEXP(&comps));
...
SEXP Rx_igraph_callaway_traits_game(SEXP pnodes, SEXP ptypes,
  ...
  Rz_SEXP_to_vector(ptype_dist, &type_dist);
  Rz_SEXP_to_matrix(pmatrix, &matrix);
...
SEXP Rx_igraph_establishment_game(SEXP pnodes, SEXP ptypes, SEXP pk,
...
SEXP Rx_igraph_layout_merge_dla(SEXP graphs, SEXP layouts) {
...
SEXP Rx_igraph_disjoint_union(SEXP pgraphs) {
  ...
  for (igraph_integer_t i=0; i < Rf_xlength(pgraphs); i++) {
    Rz_SEXP_to_igraph(VECTOR_ELT(pgraphs, i), &graphs[i]);
...
SEXP Rx_igraph_union(SEXP pgraphs, SEXP pedgemaps) {
  ...
  SET_VECTOR_ELT(result, 1, Rx_igraph_0orvector_int_list_to_SEXP(my_edgemaps));
...
SEXP Rx_igraph_intersection(SEXP pgraphs, SEXP pedgemaps) {
...
SEXP Rx_igraph_compose(SEXP pleft, SEXP pright, SEXP pedgemaps) {
  ...
  if (edgemaps) {
    ...
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, my_edgemap1);
  ...
  SET_VECTOR_ELT(result, 0, Ry_igraph_to_SEXP(&res));
  IGRAPH_I_DESTROY(&res);
  SET_VECTOR_ELT(result, 2, Rx_igraph_0orvector_int_to_SEXP(my_edgemap2));
  if (edgemaps) {
    igraph_vector_int_destroy(my_edgemap2);
    IGRAPH_LOCAL_FINALLY_CLEAN(1);
  }
  IGRAPH_I_DESTROY(&res);
  SET_VECTOR_ELT(result, 1, Rx_igraph_0orvector_int_to_SEXP(my_edgemap1));
  if (edgemaps) {
...
SEXP Rx_igraph_barabasi_aging_game(SEXP pn, SEXP ppa_exp, SEXP paging_exp,
  ...
  Rz_SEXP_to_vector_int_copy(pout_seq, &out_seq);
...
SEXP Rx_igraph_recent_degree_aging_game(SEXP pn, SEXP ppa_exp, SEXP paging_exp,
                                       SEXP paging_bin, SEXP pm, SEXP pout_seq,
...
SEXP Rx_igraph_get_edge(SEXP graph, SEXP peid) {
...
SEXP Rx_igraph_es_path(SEXP graph, SEXP pp, SEXP pdir) {
  ...
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_vector_int_copy(pp, &p);
...
SEXP Rx_igraph_es_pairs(SEXP graph, SEXP pp, SEXP pdir) {
...
SEXP Rx_igraph_layout_reingold_tilford(SEXP graph, SEXP proot,
  ...
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_vector_int_copy(proot, &root);
  Rz_SEXP_to_vector_int_copy(prootlevel, &rootlevel);
  igraph_matrix_init(&res, 0, 0);
  if (!circ) {
...
SEXP Rx_igraph_vs_nei(SEXP graph, SEXP px, SEXP pv, SEXP pmode) {
  ...
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_igraph_vs(pv, &g, &v, &v_data);
...
SEXP Rx_igraph_vs_adj(SEXP graph, SEXP px, SEXP pe, SEXP pmode) {
  ...
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_igraph_es(pe, &g, &e, &e_data);
...
SEXP Rx_igraph_es_adj(SEXP graph, SEXP x, SEXP pv, SEXP pmode) {
...
SEXP Rx_igraph_grg_game(SEXP pn, SEXP pradius, SEXP ptorus,
                       SEXP pcoords) {

  igraph_t g;
  igraph_integer_t n=(igraph_integer_t) REAL(pn)[0];
  igraph_real_t radius;
  IGRAPH_R_CHECK(Rw_get_real_scalar(pradius, 0, &radius));
  igraph_bool_t torus;
  IGRAPH_R_CHECK(Rw_get_bool_scalar(ptorus, 0, &torus));
  igraph_bool_t coords;
  IGRAPH_R_CHECK(Rw_get_bool_scalar(pcoords, 0, &coords));
  ...
  PROTECT(result=NEW_LIST(3));
  SET_VECTOR_ELT(result, 0, Ry_igraph_to_SEXP(&g));
  IGRAPH_I_DESTROY(&g);
  SET_VECTOR_ELT(result, 1, Ry_igraph_0orvector_to_SEXP(px));
  if (coords) { igraph_vector_destroy(px); }
  SET_VECTOR_ELT(result, 2, Ry_igraph_0orvector_to_SEXP(py));
...
SEXP Rx_igraph_read_graph_dimacs(SEXP pvfile, SEXP pdirected) {
  ...
  if (!strcmp(igraph_strvector_get(&problem, 0), "max")) {
    ...
    SET_VECTOR_ELT(result, 0, Rx_igraph_strvector_to_SEXP(&problem));
    igraph_strvector_destroy(&problem);
    SET_VECTOR_ELT(result, 1, Ry_igraph_to_SEXP(&g));
    IGRAPH_I_DESTROY(&g);
    ...
    SET_VECTOR_ELT(result, 1, Ry_igraph_to_SEXP(&g));
    IGRAPH_I_DESTROY(&g);
    SET_VECTOR_ELT(result, 2, Ry_igraph_vector_int_to_SEXP(&label));
...
SEXP Rx_igraph_write_graph_dimacs(SEXP graph, SEXP file,
...
SEXP Rx_igraph_st_vertex_connectivity(SEXP graph, SEXP psource,
                                     SEXP ptarget) {
...
SEXP Rx_igraph_st_edge_connectivity(SEXP graph, SEXP psource, SEXP ptarget) {
...
SEXP Rx_igraph_st_mincut_value(SEXP graph, SEXP psource, SEXP ptarget,
                              SEXP pcapacity) {
  igraph_t g;
  igraph_integer_t source=(igraph_integer_t) REAL(psource)[0];
  igraph_integer_t target=(igraph_integer_t) REAL(ptarget)[0];
  ...
  if (!Rf_isNull(pcapacity)) {
    Rz_SEXP_to_vector(pcapacity, &capacity);
    ppcapacity=&capacity;
  }
...
SEXP Rx_igraph_edge_disjoint_paths(SEXP graph, SEXP psource, SEXP ptarget) {
...
SEXP Rx_igraph_vertex_disjoint_paths(SEXP graph, SEXP psource, SEXP ptarget) {
...
SEXP Rx_igraph_spinglass_community(SEXP graph, SEXP weights,
  ...
  Rz_SEXP_to_igraph(graph, &g);
  if (!Rf_isNull(weights)) {
    pweights=&v_weights; Rz_SEXP_to_vector(weights, &v_weights);
  }
  ...
  PROTECT(result=NEW_LIST(4));
  PROTECT(names=NEW_CHARACTER(4));
  SET_VECTOR_ELT(result, 0, Ry_igraph_vector_int_to_SEXP(&membership));
  SET_VECTOR_ELT(result, 1, Ry_igraph_vector_int_to_SEXP(&csize));
  SET_VECTOR_ELT(result, 2, NEW_NUMERIC(1));
  SET_VECTOR_ELT(result, 3, NEW_NUMERIC(1));
...
SEXP Rx_igraph_spinglass_my_community(SEXP graph, SEXP weights,
  ...
  PROTECT(result=NEW_LIST(5));
  PROTECT(names=NEW_CHARACTER(5));
  SET_VECTOR_ELT(result, 0, Ry_igraph_vector_int_to_SEXP(&community));
...
SEXP Rx_igraph_no_components(SEXP graph, SEXP pmode) {
...
SEXP Rx_igraph_neighborhood_size(SEXP graph, SEXP pvids, SEXP porder,
  ...
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_igraph_vs(pvids, &g, &vids, &vids_data);
  igraph_vector_int_init(&res, 0);
...
SEXP Rx_igraph_neighborhood(SEXP graph, SEXP pvids, SEXP porder,
                           SEXP pmode, SEXP pmindist) {
  igraph_t g;
  igraph_vs_t vids;
  igraph_vector_int_t vids_data;
  ...
  PROTECT(result=Ry_igraph_vector_int_list_to_SEXP(&res));
...
SEXP Rx_igraph_neighborhood_graphs(SEXP graph, SEXP pvids, SEXP porder,
                                  SEXP pmode, SEXP pmindist) {
  igraph_t g;
  igraph_vs_t vids;
  igraph_vector_int_t vids_data;
  ...
  PROTECT(result=Ry_igraph_graphlist_to_SEXP(&res));
...
SEXP Rx_igraph_connect_neighborhood(SEXP graph, SEXP porder, SEXP pmode) {
...
SEXP Rx_igraph_watts_strogatz_game(SEXP pdim, SEXP psize, SEXP pnei, SEXP pp,
...
SEXP Rx_igraph_maximal_cliques(SEXP graph, SEXP psubset,
  ...
  if (!Rf_isNull(psubset)) {
    Rz_SEXP_to_vector_int_copy(psubset, &subset);
  } else {
    IGRAPH_R_CHECK(igraph_vector_int_init(&subset, 0));
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &subset);
...
SEXP Rx_igraph_maximal_cliques_count(SEXP graph, SEXP psubset,
...
SEXP Rx_igraph_independent_vertex_sets(SEXP graph,
                                      SEXP pminsize, SEXP pmaxsize) {
  igraph_t g;
  igraph_vector_int_list_t list;
  igraph_integer_t minsize=(igraph_integer_t) REAL(pminsize)[0];
...
SEXP Rx_igraph_lastcit_game(SEXP pnodes, SEXP pedges, SEXP pagebins,
  ...
  Rz_SEXP_to_vector(ppreference, &preference);
...
SEXP Rx_igraph_cited_type_game(SEXP pnodes, SEXP pedges, SEXP ptypes,
  ...
  Rz_SEXP_to_vector_int_copy(ptypes, &types);
  Rz_SEXP_to_vector(ppref, &pref);
...
SEXP Rx_igraph_citing_cited_type_game(SEXP pnodes, SEXP ptypes, SEXP ppref,
...
SEXP Rx_igraph_walktrap_community(SEXP graph, SEXP pweights,
  ...
  if (!Rf_isNull(pweights)) {
    ppweights=&weights;
    Rz_SEXP_to_vector(pweights, ppweights);
  }
  ...
  if (LOGICAL(pmerges)[0]) {
    SET_VECTOR_ELT(result, 0, Rx_igraph_0ormatrix_int_to_SEXP(&merges));
  } else {
    SET_VECTOR_ELT(result, 0, R_NilValue);
  }
  igraph_matrix_int_destroy(&merges);
  if (LOGICAL(pmodularity)[0]) {
    SET_VECTOR_ELT(result, 1, Ry_igraph_0orvector_to_SEXP(&modularity));
  } else {
    SET_VECTOR_ELT(result, 1, R_NilValue);
  }
  igraph_vector_destroy(&modularity);
  if (LOGICAL(pmembership)[0]) {
    SET_VECTOR_ELT(result, 2, Rx_igraph_0orvector_int_to_SEXP(&membership));
  } else {
    SET_VECTOR_ELT(result, 2, R_NilValue);
  }
  igraph_vector_int_destroy(&membership);
...
SEXP Rx_igraph_community_edge_betweenness(SEXP graph, SEXP pweights,
                                         SEXP pdirected,
  ...
  PROTECT(result=NEW_LIST(6));
  SET_VECTOR_ELT(result, 0, Ry_igraph_vector_int_to_SEXP(&res));
  igraph_vector_int_destroy(&res);
  SET_VECTOR_ELT(result, 1, Ry_igraph_0orvector_to_SEXP(ppeb));
  if (ppeb) { igraph_vector_destroy(ppeb); }
  SET_VECTOR_ELT(result, 2, Rx_igraph_0ormatrix_int_to_SEXP(ppmerges));
  if (ppmerges) { igraph_matrix_int_destroy(ppmerges); }
  SET_VECTOR_ELT(result, 3, Rx_igraph_0orvector_int_to_SEXP(ppbridges));
  if (ppbridges) { igraph_vector_int_destroy(ppbridges); }
  SET_VECTOR_ELT(result, 4, Ry_igraph_0orvector_to_SEXP(ppmodularity));
  if (ppmodularity) { igraph_vector_destroy(ppmodularity); }
  SET_VECTOR_ELT(result, 5, Rx_igraph_0orvector_int_to_SEXP(ppmembership));
...
SEXP Rx_igraph_community_fastgreedy(SEXP graph, SEXP pmerges, SEXP pmodularity,
  ...
  PROTECT(result=NEW_LIST(3));
  SET_VECTOR_ELT(result, 0, Rx_igraph_0ormatrix_int_to_SEXP(ppmerges));
  if (ppmerges) { igraph_matrix_int_destroy(ppmerges); }
  SET_VECTOR_ELT(result, 1, Ry_igraph_0orvector_to_SEXP(ppmodularity));
  if (ppmodularity) { igraph_vector_destroy(ppmodularity); }
  SET_VECTOR_ELT(result, 2, Rx_igraph_0orvector_int_to_SEXP(ppmembership));
  if (ppmembership) { igraph_vector_int_destroy(ppmembership); }
  PROTECT(names=NEW_CHARACTER(3));
  SET_STRING_ELT(names, 0, Rf_mkChar("merges"));
  SET_STRING_ELT(names, 1, Rf_mkChar("modularity"));
...
SEXP Rx_igraph_community_to_membership(SEXP graph, SEXP pmerges,
  ...
  Rz_SEXP_to_matrix_int(pmerges, &merges);
  if (LOGICAL(pmembership)[0]) {
    ppmembership=&membership;
  ...
  PROTECT(result=NEW_LIST(2));
  SET_VECTOR_ELT(result, 0, Rx_igraph_0orvector_int_to_SEXP(ppmembership));
  if (ppmembership) { igraph_vector_int_destroy(ppmembership); }
  IGRAPH_LOCAL_FINALLY_STACK;
  SET_VECTOR_ELT(result, 1, Rx_igraph_0orvector_int_to_SEXP(ppcsize));
...
SEXP Rx_igraph_community_to_membership2(SEXP pmerges, SEXP pvcount,
                                       SEXP psteps) {
  ...
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &membership);

  IGRAPH_R_CHECK(igraph_community_to_membership(&merges, vcount, steps, &membership, 0));
  PROTECT(result=Ry_igraph_vector_int_to_SEXP(&membership));
...
SEXP Rx_igraph_girth(SEXP graph, SEXP pcircle) {
  ...
  SET_VECTOR_ELT(result, 1, Rx_igraph_0orvector_int_to_SEXPp1(ppcircle));
...
SEXP Rx_igraph_get_adjedgelist(SEXP graph, SEXP pmode, SEXP ploops) {
...
typedef struct Rx_igraph_i_arpack_data_t {
  SEXP fun;
  SEXP extra;
  SEXP rho;
} Rx_igraph_i_arpack_data_t;

igraph_error_t Rx_igraph_i_arpack_callback(igraph_real_t *to, const igraph_real_t *from,
                               int n, void *extra) {
  IGRAPH_LOCAL_FINALLY_STACK;
  SEXP s_from, s_to;
  SEXP R_fcall;
  Rx_igraph_i_arpack_data_t *data=extra;
...
SEXP Rx_igraph_arpack(SEXP function, SEXP extra, SEXP options, SEXP rho,
                     SEXP sym) {
  ...
  IGRAPH_LOCAL_FINALLY_PV(igraph_matrix_destroy, &vectors);
  if (LOGICAL(sym)[0]) {
    if (0 != igraph_vector_init(&values, 0)) {
      igraph_error("Cannot run ARPACK", __FILE__, __LINE__, IGRAPH_ENOMEM);
    }
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_destroy, &values);
  } else {
    if (0 != igraph_matrix_init(&values2, 0, 0)) {
      igraph_error("Cannot run ARPACK", __FILE__, __LINE__, IGRAPH_ENOMEM);
    }
    IGRAPH_LOCAL_FINALLY_PV(igraph_matrix_destroy, &values2);
  }
  ...
  if (LOGICAL(sym)[0]) {
    if (0 != igraph_arpack_rssolve(Rx_igraph_i_arpack_callback, &data,
                                   &c_options, 0, &values, &vectors)) {
      igraph_error("ARPACK failed", __FILE__, __LINE__, IGRAPH_FAILURE);
    }
  } else {
    if (0 != igraph_arpack_rnsolve(Rx_igraph_i_arpack_callback, &data,
  ...
  if (LOGICAL(sym)[0]) {
  IGRAPH_LOCAL_FINALLY_STACK;
    SET_VECTOR_ELT(result, 0, Ry_igraph_vector_to_SEXP(&values));
    igraph_vector_destroy(&values); IGRAPH_LOCAL_FINALLY_CLEAN(1);
  } else {
    SET_VECTOR_ELT(result, 0, Ry_igraph_matrix_to_SEXP(&values2));
    igraph_matrix_destroy(&values2); IGRAPH_LOCAL_FINALLY_CLEAN(1);
  }
  SET_VECTOR_ELT(result, 1, Ry_igraph_matrix_to_SEXP(&vectors));
  igraph_matrix_destroy(&vectors); IGRAPH_LOCAL_FINALLY_CLEAN(1);
  SET_VECTOR_ELT(result, 2, Ry_igraph_arpack_options_to_SEXP(&c_options));
  PROTECT(names=NEW_CHARACTER(3));
...
SEXP Rx_igraph_is_chordal(SEXP graph, SEXP alpha, SEXP alpham1,
  ...
  if (LOGICAL(pfillin)[0]) {
    ...
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &c_fillin);
  }
  ...
  if (LOGICAL(pnewgraph)[0]) {
    IGRAPH_LOCAL_FINALLY_PV(igraph_destroy, &c_newgraph);
...
} Rx_igraph_i_bfs_data_t;

igraph_error_t Rx_igraph_bfshandler(const igraph_t *graph,
  ...
  Rx_igraph_i_bfs_data_t *data=extra;
  ...
  PROTECT(result = Rx_igraph_safe_eval_in_env(R_fcall, data->rho, NULL));
  cres = Rf_asLogical(Rx_igraph_handle_safe_eval_result_in_env(result, data->rho));

  UNPROTECT(4);
  return cres ? IGRAPH_STOP : IGRAPH_SUCCESS;
}

SEXP Rx_igraph_bfs(SEXP graph, SEXP proot, SEXP proots, SEXP pmode,
  ...
  Rx_igraph_i_bfs_data_t cb_data, *p_cb_data=0;

  Rz_SEXP_to_igraph(graph, &g);
  if (!Rf_isNull(proots)) {
    Rz_SEXP_to_vector_int_copy(proots, &roots);
  } else {
    igraph_vector_int_init(&roots, 0);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &roots);

  if (!Rf_isNull(prestricted)) {
    Rz_SEXP_to_vector_int_copy(prestricted, &restricted);
  } else {
    igraph_vector_int_init(&restricted, 0);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &restricted);

  if (LOGICAL(porder)[0]) {
    igraph_vector_int_init(&order, 0); IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &order);
    p_order=&order;
  }
  if (LOGICAL(prank)[0]) {
    igraph_vector_int_init(&rank, 0); IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &rank);
    p_rank=&rank;
  }
  if (LOGICAL(pparent)[0]) {
    igraph_vector_int_init(&parent, 0); IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &parent);
    p_parent=&parent;
  }
  if (LOGICAL(ppred)[0]) {
    igraph_vector_int_init(&pred, 0); IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &pred);
    p_pred=&pred;
  }
  if (LOGICAL(psucc)[0]) {
    igraph_vector_int_init(&succ, 0); IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &succ);
    p_succ=&succ;
  }
  if (LOGICAL(pdist)[0]) {
    igraph_vector_int_init(&dist, 0); IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &dist);
    p_dist=&dist;
  }
  ...
  SET_VECTOR_ELT(result, 2, Rx_igraph_0orvector_int_to_SEXP_d(p_order));
  SET_STRING_ELT(names, 3, Rf_mkChar("rank"));
  SET_VECTOR_ELT(result, 3, Rx_igraph_0orvector_int_to_SEXP_d(p_rank));
  SET_STRING_ELT(names, 4, Rf_mkChar("parent"));
  SET_VECTOR_ELT(result, 4, Rx_igraph_0orvector_int_to_SEXP_d(p_parent));
  SET_STRING_ELT(names, 5, Rf_mkChar("pred"));
  SET_VECTOR_ELT(result, 5, Rx_igraph_0orvector_int_to_SEXP_d(p_pred));
  SET_STRING_ELT(names, 6, Rf_mkChar("succ"));
  SET_VECTOR_ELT(result, 6, Rx_igraph_0orvector_int_to_SEXP_d(p_succ));
  SET_STRING_ELT(names, 7, Rf_mkChar("dist"));
  SET_VECTOR_ELT(result, 7, Rx_igraph_0orvector_int_to_SEXP_d(p_dist));
  ...
  if (p_dist) { igraph_vector_int_destroy(p_dist); IGRAPH_LOCAL_FINALLY_CLEAN(1); p_dist = 0; }
  if (p_succ) { igraph_vector_int_destroy(p_succ); IGRAPH_LOCAL_FINALLY_CLEAN(1); p_succ = 0; }
  if (p_pred) { igraph_vector_int_destroy(p_pred); IGRAPH_LOCAL_FINALLY_CLEAN(1); p_pred = 0; }
  if (p_parent) { igraph_vector_int_destroy(p_parent); IGRAPH_LOCAL_FINALLY_CLEAN(1); p_parent = 0; }
  if (p_rank) { igraph_vector_int_destroy(p_rank); IGRAPH_LOCAL_FINALLY_CLEAN(1); p_rank = 0; }
  if (p_order) { igraph_vector_int_destroy(p_order); IGRAPH_LOCAL_FINALLY_CLEAN(1); p_order = 0; }
...
} Rx_igraph_i_dfs_data_t;

igraph_error_t Rx_igraph_dfshandler(const igraph_t *graph,
                                  igraph_integer_t vid,
                                  igraph_integer_t dist,
                                  void *extra,
                                  int which) {

  Rx_igraph_i_dfs_data_t *data=extra;
  SEXP args, R_fcall, result, names;
  igraph_bool_t cres;
...
igraph_error_t Rx_igraph_dfshandler_in(const igraph_t *graph,
                                      igraph_integer_t vid,
                                      igraph_integer_t dist,
                                      void *extra) {
...
igraph_error_t Rx_igraph_dfshandler_out(const igraph_t *graph,
                                       igraph_integer_t vid,
                                       igraph_integer_t dist,
                                       void *extra) {

  return Rx_igraph_dfshandler(graph, vid, dist, extra, 1);
}

SEXP Rx_igraph_dfs(SEXP graph, SEXP proot, SEXP pmode, SEXP punreachable,
  ...
  Rx_igraph_i_dfs_data_t cb_data, *p_cb_data=0;
  ...
  if (!Rf_isNull(pin_callback)) {
    in_callback=Rx_igraph_dfshandler_in;
  }
  if (!Rf_isNull(pout_callback)) {
    out_callback=Rx_igraph_dfshandler_out;
  }
  ...
  SET_VECTOR_ELT(result, 3, Rx_igraph_0orvector_int_to_SEXP_d(p_order_out));
  SET_STRING_ELT(names, 4, Rf_mkChar("parent"));
  SET_VECTOR_ELT(result, 4, Rx_igraph_0orvector_int_to_SEXP_d(p_parent));
  SET_STRING_ELT(names, 5, Rf_mkChar("dist"));
  SET_VECTOR_ELT(result, 5, Rx_igraph_0orvector_int_to_SEXP_d(p_dist));
...
} Rx_igraph_i_function_container_t;

SEXP Rx_igraph_i_levc_arp(SEXP extP, SEXP extE, SEXP pv) {
  Rx_igraph_i_function_container_t *cont = R_ExternalPtrAddr(extP);
...
typedef struct Rx_igraph_i_levc_data_t {
  SEXP fun;
  SEXP extra;
  SEXP rho;
  SEXP rho2;
} Rx_igraph_i_levc_data_t;

igraph_error_t Rx_igraph_i_levc_callback(const igraph_vector_int_t *membership,
  ...
  SEXP res, l1, l2, l3;
  int result;
  Rx_igraph_i_levc_data_t *data=extra;
  Rx_igraph_i_function_container_t cont = { arpack_multiplier };
  ...
  PROTECT(R_fcall = Rx_igraph_i_lang7(data->fun, s_memb, s_comm,
...
SEXP Rx_igraph_community_leading_eigenvector(SEXP graph, SEXP steps,
                                            SEXP weights,
  ...
  Rx_igraph_i_levc_data_t callback_data = { callback, callback_extra,
  ...
  IGRAPH_LOCAL_FINALLY(igraph_matrix_int_destroy, &c_merges);
  if (c_start) {
    Rz_SEXP_to_vector_int_copy(pstart, &c_membership);
  } else {
    if (0 != igraph_vector_int_init(&c_membership, 0)) {
      igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
    }
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &c_membership);
  ...
  igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
                                        ...
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_community_leading_eigenvector(&c_graph, pweights, &c_merges, &c_membership, c_steps, &c_options, &c_modularity, c_start, &c_eigenvalues, &c_eigenvectors, &c_history, Rf_isNull(callback) ? 0 : Rx_igraph_i_levc_callback, &callback_data));
...
SEXP Rx_igraph_get_eids(SEXP graph, SEXP pvp, SEXP pdirected,
                       SEXP perror) {
  igraph_t g;
  ...
  IGRAPH_LOCAL_FINALLY_STACK;
  Rz_SEXP_to_igraph(graph, &g);
  Rz_SEXP_to_vector_int_copy(pvp, &vp);
  igraph_vector_int_init(&res, 0);
...
SEXP Rx_igraph_subisomorphic_lad(SEXP pattern, SEXP target, SEXP domains,
  ...
  if (!Rf_isNull(domains)) {
    Ry_igraph_SEXP_to_vector_int_list(domains, &c_domains);
  } else {
    igraph_vector_int_list_init(&c_domains, 0);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_list_destroy, &c_domains);
  ...
  if (c_qmap) {
    ...
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &c_map);
  ...
  if (c_qall_maps) {
    ...
    IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_list_destroy, &c_maps);
  ...
  LOGICAL(iso)[0]=c_iso;
  if (!Rf_isNull(map)) {
    PROTECT(map=Rx_igraph_0orvector_int_to_SEXP(&c_map));
  ...
  if (!Rf_isNull(maps)) {
  IGRAPH_LOCAL_FINALLY_STACK;
    PROTECT(maps=Rx_igraph_0orvector_int_list_to_SEXP(&c_maps));
...
SEXP Rx_igraph_graphlets(SEXP graph, SEXP weights, SEXP niter) {
  ...
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_list_destroy, &c_cliques);
...
SEXP Rx_igraph_adjacency_spectral_embedding(SEXP graph, SEXP no,
  ...
  IGRAPH_LOCAL_FINALLY_PV(igraph_matrix_destroy, &c_X);
  if (directed) {
    if (0 != igraph_matrix_init(&c_Y, 0, 0)) {
      igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
    }
    IGRAPH_LOCAL_FINALLY_PV(igraph_matrix_destroy, &c_Y);
  }
  if (0 != igraph_vector_init(&c_D, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_destroy, &c_D);
...
SEXP Rx_igraph_laplacian_spectral_embedding(SEXP graph, SEXP no,
  ...
  PROTECT(D=Ry_igraph_0orvector_to_SEXP(&c_D));
  igraph_vector_destroy(&c_D);
  IGRAPH_LOCAL_FINALLY_CLEAN(1);
  PROTECT(options=Ry_igraph_arpack_options_to_SEXP(&c_options));
  SET_VECTOR_ELT(result, 0, X);
...
SEXP Rx_igraph_bipartite_projection(SEXP graph, SEXP types, SEXP probe1,
                                   SEXP pwhich) {
  /* Declarations */
  igraph_t c_graph;
  ...
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &c_multiplicity1);
  multiplicity1 = R_GlobalEnv; /* hack to have a non-NULL value */
  if (0 != igraph_vector_int_init(&c_multiplicity2, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &c_multiplicity2);
  ...
  PROTECT(names=NEW_CHARACTER(4));
  if (do_1) {
    IGRAPH_LOCAL_FINALLY_PV(igraph_destroy, &c_proj1);
  ...
  if (do_2) {
    IGRAPH_LOCAL_FINALLY_PV(igraph_destroy, &c_proj2);
  ...
  PROTECT(multiplicity1=Rx_igraph_0orvector_int_to_SEXP(&c_multiplicity1));
  igraph_vector_int_destroy(&c_multiplicity1);
  IGRAPH_LOCAL_FINALLY_CLEAN(1);
  PROTECT(multiplicity2=Rx_igraph_0orvector_int_to_SEXP(&c_multiplicity2));
...
SEXP Rx_igraph_adjacent_vertices(SEXP pgraph, SEXP pv, SEXP pmode) {
  ...
  IGRAPH_LOCAL_FINALLY(igraph_vs_destroy, &vs);
  IGRAPH_LOCAL_FINALLY_PV(igraph_vector_int_destroy, &vs_data);

  igraph_vit_create(&graph, vs, &vit);
  IGRAPH_LOCAL_FINALLY(igraph_vit_destroy, &vit);
  ...
  IGRAPH_LOCAL_FINALLY(igraph_lazy_adjlist_destroy, &adjlist);
  ...
  igraph_vs_destroy(&vs);
  igraph_vector_int_destroy(&vs_data);
  IGRAPH_LOCAL_FINALLY_CLEAN(4);

  UNPROTECT(1);
  return result;
}

SEXP Rx_igraph_incident_edges(SEXP pgraph, SEXP pe, SEXP pmode) {
  ...
  IGRAPH_LOCAL_FINALLY(igraph_lazy_inclist_destroy, &adjlist);
...
SEXP Rx_igraph_power_law_fit_new(SEXP data, SEXP xmin, SEXP force_continuous, SEXP compute_pvalue, SEXP precision)
{
  ...
  // Can't use the generated `Rx_igraph_power_law_fit()` because we need `c_res` to compute the p-value
...
SEXP Rx_igraph_get_all_simple_paths_pp(SEXP vector) {
  SEXP result;
...
SEXP Rx_igraph_address(SEXP object) {
  char s[64];
  snprintf(s, 64, "%p", (void*) object);
  return Rf_ScalarString(Rf_mkChar(s));
}

SEXP Rx_igraph_make_weak_ref(SEXP key, SEXP value, SEXP finalizer) {
  return R_MakeWeakRef(key, value, finalizer, Rf_isNull(finalizer) ? 0 : 1);
}

SEXP Rx_igraph_weak_ref_key(SEXP ref) {
  return R_WeakRefKey(ref);
}

SEXP Rx_igraph_weak_ref_value(SEXP ref) {
  return R_WeakRefValue(ref);
}

SEXP Rx_igraph_weak_ref_run_finalizer(SEXP ref) {
  R_RunWeakRefFinalizer(ref);
  return R_NilValue;
}

SEXP Rx_igraph_identical_graphs(SEXP g1, SEXP g2, SEXP attrs) {
...
SEXP Rx_igraph_graph_version(SEXP graph) {
  if (Rf_xlength(graph) == 11) {
...
SEXP Rx_igraph_add_myid_to_env(SEXP graph) {
  uuid_t my_id;
  char my_id_chr[40];
  ...
  Rf_defineVar(l1, l2, Rx_igraph_graph_env(graph));
  UNPROTECT(2);

  return graph;
}

SEXP Rx_igraph_add_version_to_env(SEXP graph) {
