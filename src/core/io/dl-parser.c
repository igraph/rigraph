...
#line 78 "src/core/io/dl-parser.y"
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 104 "src/core/io/dl-parser.y"
    {
...
;}
  ...
  case 7:
#line 118 "src/core/io/dl-parser.y"
...
#line 123 "src/core/io/dl-parser.y"
  ...
  case 14:
#line 127 "src/core/io/dl-parser.y"
    { ;}
    break;
...
#line 129 "src/core/io/dl-parser.y"
  ...
  case 17:
#line 132 "src/core/io/dl-parser.y"
    {;}
    break;

  case 18:
#line 133 "src/core/io/dl-parser.y"
    {
  ...
  case 19:
#line 139 "src/core/io/dl-parser.y"
    {;}
    break;
...
#line 139 "src/core/io/dl-parser.y"
 ...
 ;}
  ...
  case 22:
#line 144 "src/core/io/dl-parser.y"
    { ;}
    break;

  case 23:
#line 146 "src/core/io/dl-parser.y"
    {
...
;}
  ...
  case 24:
#line 161 "src/core/io/dl-parser.y"
    {;}
    break;
...
#line 186 "src/core/io/dl-parser.y"
  ...
  case 34:
#line 187 "src/core/io/dl-parser.y"
    {;}
    break;
...
#line 190 "src/core/io/dl-parser.y"
  ...
  case 38:
#line 193 "src/core/io/dl-parser.y"
    {;}
    break;
...
;}
  ...
  case 42:
#line 209 "src/core/io/dl-parser.y"
    {
...
;}
  ...
  case 43:
#line 217 "src/core/io/dl-parser.y"
    {;}
    break;

  case 44:
#line 218 "src/core/io/dl-parser.y"
    {;}
    break;

  case 45:
#line 221 "src/core/io/dl-parser.y"
    {
                          IGRAPH_YY_CHECK(igraph_i_dl_add_edge_w((yyvsp[(1) - (4)].integer), (yyvsp[(2) - (4)].integer), (yyvsp[(3) - (4)].real), context)); ;}
    break;

  case 46:
#line 223 "src/core/io/dl-parser.y"
    {
...
#line 257 "src/core/io/dl-parser.y"
  ...
  case 52:
#line 258 "src/core/io/dl-parser.y"
    {;}
    break;

  case 53:
#line 259 "src/core/io/dl-parser.y"
    {;}
    break;
...
#line 260 "src/core/io/dl-parser.y"
  ...
  case 55:
#line 263 "src/core/io/dl-parser.y"
    {;}
    break;

  case 56:
#line 264 "src/core/io/dl-parser.y"
    {;}
    break;
...
#line 267 "src/core/io/dl-parser.y"
  ...
  case 58:
#line 269 "src/core/io/dl-parser.y"
    {
  IGRAPH_YY_CHECK(igraph_i_parse_integer(igraph_dl_yyget_text(scanner),
                  igraph_dl_yyget_leng(scanner),
                  &context->from));
...
;}
  ...
  case 59:
#line 276 "src/core/io/dl-parser.y"
    {;}
    break;
...
#line 276 "src/core/io/dl-parser.y"
 ...
 ;}
  ...
  case 61:
#line 284 "src/core/io/dl-parser.y"
    {;}
    break;

  case 62:
#line 285 "src/core/io/dl-parser.y"
    {;}
    break;

  case 63:
#line 288 "src/core/io/dl-parser.y"
    { ;}
    break;

  case 64:
#line 290 "src/core/io/dl-parser.y"
    {
 ...
 ;}
  ...
  case 66:
#line 294 "src/core/io/dl-parser.y"
    {
  IGRAPH_YY_CHECK(igraph_vector_int_push_back(&context->edges,
                                              context->from));
...
#line 300 "src/core/io/dl-parser.y"
