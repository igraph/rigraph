...
/*
   ...
   02110-1301 USA
*/
#line 22 "src/core/io/gml-lexer.l"
...
#line 1065 "src/core/io/gml-lexer.c"
...
case 4:
YY_RULE_SETUP
#line 85 "src/core/io/gml-lexer.l"
{ BEGIN(INITIAL); return NUM; }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 86 "src/core/io/gml-lexer.l"
{ BEGIN(VALUE); return KEYWORD; }
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 87 "src/core/io/gml-lexer.l"
{
                          BEGIN(INITIAL);
                          yyextra->depth++;
                          if (yyextra->depth >= 32) {
...
case 7:
YY_RULE_SETUP
#line 96 "src/core/io/gml-lexer.l"
{
                          yyextra->depth--;
                          return LISTCLOSE;
                        }
...
case 9:
YY_RULE_SETUP
#line 102 "src/core/io/gml-lexer.l"
{ return ERROR; }
	YY_BREAK
case 10:
YY_RULE_SETUP
...
YY_FATAL_ERROR( "flex scanner jammed" );
	YY_BREAK
#line 1198 "src/core/io/gml-lexer.c"
