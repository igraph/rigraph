...
#line 76 "src/core/io/lgl-parser.y"
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 6:
#line 99 "src/core/io/lgl-parser.y"
    { context->actvertex=(yyvsp[(2) - (3)].edgenum); ;}
    break;

  case 9:
#line 103 "src/core/io/lgl-parser.y"
    {
  ...
  case 10:
#line 108 "src/core/io/lgl-parser.y"
    {
             IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, context->actvertex));
  ...
  case 11:
#line 117 "src/core/io/lgl-parser.y"
    {
...
#line 135 "src/core/io/lgl-parser.y"
