...
#line 77 "src/core/io/ncol-parser.y"
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 97 "src/core/io/ncol-parser.y"
    {
           IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, (yyvsp[(1) - (3)].edgenum)));
           IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, (yyvsp[(2) - (3)].edgenum)));
           IGRAPH_YY_CHECK(igraph_vector_push_back(context->weights, 0.0));
       ;}
    break;

  case 6:
#line 102 "src/core/io/ncol-parser.y"
    {
           IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, (yyvsp[(1) - (4)].edgenum)));
           IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, (yyvsp[(2) - (4)].edgenum)));
           IGRAPH_YY_CHECK(igraph_vector_push_back(context->weights, (yyvsp[(3) - (4)].weightnum)));
           context->has_weights = 1;
       ;}
    break;

  case 7:
#line 110 "src/core/io/ncol-parser.y"
    {
...
#line 128 "src/core/io/ncol-parser.y"
