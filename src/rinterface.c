...
/ igraph_bfs                                 /
/-------------------------------------------*/
SEXP R_igraph_bfs(SEXP graph, SEXP root, SEXP roots, SEXP mode, SEXP unreachable, SEXP restricted, SEXP callback) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  igraph_bfshandler_t c_callback;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_dist);
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_bfs(&c_graph, c_root, (Rf_isNull(roots) ? 0 : &c_roots), c_mode, c_unreachable, &c_restricted, &c_order, &c_rank, &c_parents, &c_pred, &c_succ, &c_dist, (Rf_isNull(callback) ? 0 : c_callback), 0));
...
/ igraph_dfs                                 /
/-------------------------------------------*/
SEXP R_igraph_dfs(SEXP graph, SEXP root, SEXP mode, SEXP unreachable, SEXP in_callback, SEXP out_callback) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_integer_t c_root;
  igraph_neimode_t c_mode;
  ...
  igraph_vector_int_t c_dist;
  igraph_dfshandler_t c_in_callback;
  igraph_dfshandler_t c_out_callback;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_dist);
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_dfs(&c_graph, c_root, c_mode, c_unreachable, &c_order, &c_order_out, &c_father, &c_dist, (Rf_isNull(in_callback) ? 0 : c_in_callback), (Rf_isNull(out_callback) ? 0 : c_out_callback), 0));
