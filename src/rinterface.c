...
/-------------------------------------------*/
SEXP R_igraph_community_leading_eigenvector(SEXP graph, SEXP weights, SEXP membership, SEXP steps, SEXP options, SEXP start) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_matrix_int_t c_merges;
  ...
  IGRAPH_FINALLY(igraph_vector_destroy, &c_history);
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_community_leading_eigenvector(&c_graph, (Rf_isNull(weights) ? 0 : &c_weights), &c_merges, &c_membership, c_steps, &c_options, &c_modularity, c_start, &c_eigenvalues, &c_eigenvectors, &c_history, 0, 0));
