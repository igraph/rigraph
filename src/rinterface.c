...
SEXP R_igraph_delete_edges(SEXP graph, SEXP edges) {
  ...
  IGRAPH_R_CHECK(R_SEXP_to_igraph_es(edges, &c_graph, &c_edges, &c_edges_data));
                                        /* Call igraph */
...
/-------------------------------------------*/
SEXP R_igraph_delete_vertices_map(SEXP graph, SEXP vertices) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vs_t c_vertices;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_invidx);
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_delete_vertices_map(&c_graph, c_vertices, &c_idx, &c_invidx));
...
/ igraph_edges                               /
/-------------------------------------------*/
SEXP R_igraph_edges(SEXP graph, SEXP eids, SEXP bycol) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_es_t c_eids;
  igraph_vector_int_t c_edges;
  ...
  c_bycol = LOGICAL(bycol)[0];
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_edges(&c_graph, c_eids, &c_edges, c_bycol));
...
/ igraph_incident                            /
/-------------------------------------------*/
SEXP R_igraph_incident(SEXP graph, SEXP vid, SEXP mode, SEXP loops) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_eids;
  igraph_integer_t c_vid;
  ...
  c_loops = (igraph_loops_t) Rf_asInteger(loops);
                                        /* Call igraph */
  IGRAPH_R_CHECK(igraph_incident(&c_graph, &c_eids, c_vid, c_mode, c_loops));
...
SEXP R_igraph_square_lattice(SEXP dimvector, SEXP nei, SEXP directed, SEXP mutual, SEXP periodic) {
  ...
  if (!Rf_isNull(periodic)) {
    R_SEXP_to_vector_bool(periodic, &c_periodic);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_square_lattice(&c_graph, &c_dimvector, c_nei, c_directed, c_mutual, (Rf_isNull(periodic) ? NULL : &c_periodic)));
  PutRNGstate();
...
SEXP R_igraph_symmetric_tree(SEXP branches, SEXP type) {
  ...
  SEXP r_result;
                                        /* Convert input */
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(branches, &c_branches));
...
/ igraph_lcf                                 /
/-------------------------------------------*/
SEXP R_igraph_lcf(SEXP n, SEXP shifts, SEXP repeats) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_integer_t c_n;
...
SEXP R_igraph_adjlist(SEXP adjlist, SEXP mode, SEXP duplicate) {
  ...
  SEXP r_result;
                                        /* Convert input */
  IGRAPH_R_CHECK(R_SEXP_to_igraph_adjlist(adjlist, &c_adjlist));
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
...
SEXP R_igraph_full_multipartite(SEXP n, SEXP directed, SEXP mode) {
  ...
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(n, &c_n));
...
SEXP R_igraph_realize_degree_sequence(SEXP out_deg, SEXP in_deg, SEXP allowed_edge_types, SEXP method) {
  ...
  if (!Rf_isNull(in_deg)) {
    IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(in_deg, &c_in_deg));
  ...
  c_method = (igraph_realize_degseq_t) Rf_asInteger(method);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_realize_degree_sequence(&c_graph, &c_out_deg, (Rf_isNull(in_deg) ? NULL : &c_in_deg), c_allowed_edge_types, c_method));
  PutRNGstate();
...
SEXP R_igraph_realize_bipartite_degree_sequence(SEXP degrees1, SEXP degrees2, SEXP allowed_edge_types, SEXP method) {
  ...
  SEXP r_result;
                                        /* Convert input */
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(degrees1, &c_degrees1));
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_degrees1);
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(degrees2, &c_degrees2));
...
/-------------------------------------------*/
SEXP R_igraph_erdos_renyi_game_gnp(SEXP n, SEXP p, SEXP directed, SEXP allowed_edge_types, SEXP edge_labeled) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_integer_t c_n;
  igraph_real_t c_p;
  ...
  c_edge_labeled = LOGICAL(edge_labeled)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_erdos_renyi_game_gnp(&c_graph, c_n, c_p, c_directed, c_allowed_edge_types, c_edge_labeled));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_erdos_renyi_game_gnm(SEXP n, SEXP m, SEXP directed, SEXP allowed_edge_types, SEXP edge_labeled) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_integer_t c_n;
  igraph_integer_t c_m;
  ...
  c_edge_labeled = LOGICAL(edge_labeled)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_erdos_renyi_game_gnm(&c_graph, c_n, c_m, c_directed, c_allowed_edge_types, c_edge_labeled));
  PutRNGstate();
...
/ igraph_iea_game                            /
/-------------------------------------------*/
SEXP R_igraph_iea_game(SEXP n, SEXP m, SEXP directed, SEXP loops) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_integer_t c_n;
  igraph_integer_t c_m;
  ...
  c_loops = LOGICAL(loops)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_iea_game(&c_graph, c_n, c_m, c_directed, c_loops));
  PutRNGstate();
...
/ igraph_rewire_edges                        /
/-------------------------------------------*/
SEXP R_igraph_rewire_edges(SEXP graph, SEXP prob, SEXP allowed_edge_types) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  c_allowed_edge_types = (igraph_edge_type_sw_t) Rf_asInteger(allowed_edge_types);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_rewire_edges(&c_graph, c_prob, c_allowed_edge_types));
  PutRNGstate();
...
SEXP R_igraph_chung_lu_game(SEXP out_weights, SEXP in_weights, SEXP loops, SEXP variant) {
  ...
  c_variant = (igraph_chung_lu_t) Rf_asInteger(variant);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_chung_lu_game(&c_graph, &c_out_weights, (Rf_isNull(in_weights) ? NULL : &c_in_weights), c_loops, c_variant));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_static_fitness_game(SEXP no_of_edges, SEXP fitness_out, SEXP fitness_in, SEXP allowed_edge_types) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  c_allowed_edge_types = (igraph_edge_type_sw_t) Rf_asInteger(allowed_edge_types);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_static_fitness_game(&c_graph, c_no_of_edges, &c_fitness_out, (Rf_isNull(fitness_in) ? NULL : &c_fitness_in), c_allowed_edge_types));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_static_power_law_game(SEXP no_of_nodes, SEXP no_of_edges, SEXP exponent_out, SEXP exponent_in, SEXP allowed_edge_types, SEXP finite_size_correction) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  c_finite_size_correction = LOGICAL(finite_size_correction)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_static_power_law_game(&c_graph, c_no_of_nodes, c_no_of_edges, c_exponent_out, c_exponent_in, c_allowed_edge_types, c_finite_size_correction));
  PutRNGstate();
...
/ igraph_sbm_game                            /
/-------------------------------------------*/
SEXP R_igraph_sbm_game(SEXP pref_matrix, SEXP block_sizes, SEXP directed, SEXP allowed_edge_types) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_pref_matrix;
  ...
  c_allowed_edge_types = (igraph_edge_type_sw_t) Rf_asInteger(allowed_edge_types);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_sbm_game(&c_graph, &c_pref_matrix, &c_block_sizes, c_directed, c_allowed_edge_types));
  PutRNGstate();
...
SEXP R_igraph_hsbm_list_game(SEXP n, SEXP mlist, SEXP rholist, SEXP Clist, SEXP p) {
  ...
  IGRAPH_R_CHECK_INT(n);
  c_n = (igraph_integer_t) REAL(n)[0];
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(mlist, &c_mlist));
...
SEXP R_igraph_correlated_game(SEXP old_graph, SEXP corr, SEXP p, SEXP permutation) {
  ...
  if (!Rf_isNull(permutation)) {
    ...
    IGRAPH_FINALLY(igraph_vector_int_destroy, &c_permutation);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_correlated_game(&c_new_graph, &c_old_graph, c_corr, c_p, (Rf_isNull(permutation) ? NULL : &c_permutation)));
  PutRNGstate();
...
SEXP R_igraph_correlated_pair_game(SEXP n, SEXP corr, SEXP p, SEXP directed, SEXP permutation) {
  ...
  if (!Rf_isNull(permutation)) {
    ...
    IGRAPH_FINALLY(igraph_vector_int_destroy, &c_permutation);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_correlated_pair_game(&c_graph1, &c_graph2, c_n, c_corr, c_p, c_directed, (Rf_isNull(permutation) ? NULL : &c_permutation)));
  PutRNGstate();
...
/ igraph_diameter                            /
/-------------------------------------------*/
SEXP R_igraph_diameter(SEXP graph, SEXP weights, SEXP directed, SEXP unconnected) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_real_t c_res;
  ...
  c_unconnected = LOGICAL(unconnected)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_diameter(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, &c_from, &c_to, &c_vertex_path, &c_edge_path, c_directed, c_unconnected));
  PutRNGstate();
...
SEXP R_igraph_closeness(SEXP graph, SEXP vids, SEXP mode, SEXP weights, SEXP normalized) {
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_closeness(&c_graph, &c_res, &c_reachable_count, &c_all_reachable, c_vids, c_mode, (Rf_isNull(weights) ? NULL : &c_weights), c_normalized));
  PutRNGstate();
...
SEXP R_igraph_closeness_cutoff(SEXP graph, SEXP vids, SEXP mode, SEXP weights, SEXP normalized, SEXP cutoff) {
  ...
  c_cutoff = REAL(cutoff)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_closeness_cutoff(&c_graph, &c_res, &c_reachable_count, &c_all_reachable, c_vids, c_mode, (Rf_isNull(weights) ? NULL : &c_weights), c_normalized, c_cutoff));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_get_shortest_path(SEXP graph, SEXP weights, SEXP from, SEXP to, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_shortest_path(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_vertices, &c_edges, c_from, c_to, c_mode));
  PutRNGstate();
...
SEXP R_igraph_get_shortest_path_bellman_ford(SEXP graph, SEXP from, SEXP to, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_shortest_path_bellman_ford(&c_graph, &c_vertices, &c_edges, c_from, c_to, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
SEXP R_igraph_get_shortest_path_dijkstra(SEXP graph, SEXP from, SEXP to, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_shortest_path_dijkstra(&c_graph, &c_vertices, &c_edges, c_from, c_to, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_get_all_shortest_paths(SEXP graph, SEXP weights, SEXP from, SEXP to, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_vertices);
  if (0 != igraph_vector_int_list_init(&c_edges, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_edges);
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_all_shortest_paths(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_vertices, &c_edges, &c_nrgeo, c_from, c_to, c_mode));
  PutRNGstate();
...
SEXP R_igraph_get_all_shortest_paths_dijkstra(SEXP graph, SEXP from, SEXP to, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_all_shortest_paths_dijkstra(&c_graph, &c_vertices, &c_edges, &c_nrgeo, c_from, c_to, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
SEXP R_igraph_voronoi(SEXP graph, SEXP generators, SEXP weights, SEXP mode, SEXP tiebreaker) {
  ...
  c_tiebreaker = (igraph_voronoi_tiebreaker_t) Rf_asInteger(tiebreaker);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_voronoi(&c_graph, &c_membership, &c_distances, &c_generators, (Rf_isNull(weights) ? NULL : &c_weights), c_mode, c_tiebreaker));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_get_all_simple_paths(SEXP graph, SEXP from, SEXP to, SEXP mode, SEXP minlen, SEXP maxlen, SEXP max_results) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  igraph_vs_t c_to;
  igraph_neimode_t c_mode;
  igraph_integer_t c_minlen;
  igraph_integer_t c_maxlen;
  igraph_integer_t c_max_results;
  SEXP res;
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_res);
  c_from = (igraph_integer_t) REAL(from)[0];
  igraph_vector_int_t c_to_data;
  R_SEXP_to_igraph_vs(to, &c_graph, &c_to, &c_to_data);
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
  IGRAPH_R_CHECK_INT(minlen);
  c_minlen = (igraph_integer_t) REAL(minlen)[0];
  IGRAPH_R_CHECK_INT(maxlen);
  c_maxlen = (igraph_integer_t) REAL(maxlen)[0];
  IGRAPH_R_CHECK_INT(max_results);
  c_max_results = (igraph_integer_t) REAL(max_results)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_all_simple_paths(&c_graph, &c_res, c_from, c_to, c_mode, c_minlen, c_maxlen, c_max_results));
  PutRNGstate();
...
SEXP R_igraph_get_k_shortest_paths(SEXP graph, SEXP weights, SEXP k, SEXP from, SEXP to, SEXP mode) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_vertex_paths);
  if (0 != igraph_vector_int_list_init(&c_edge_paths, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_edge_paths);
  IGRAPH_R_CHECK_INT(k);
  c_k = (igraph_integer_t) REAL(k)[0];
  c_from = (igraph_integer_t) REAL(from)[0];
  c_to = (igraph_integer_t) REAL(to)[0];
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_k_shortest_paths(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_vertex_paths, &c_edge_paths, c_k, c_from, c_to, c_mode));
  PutRNGstate();
...
SEXP R_igraph_spanner(SEXP graph, SEXP stretch, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_spanner(&c_graph, &c_spanner, c_stretch, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_betweenness_cutoff(SEXP graph, SEXP weights, SEXP vids, SEXP directed, SEXP normalized, SEXP cutoff) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_cutoff = REAL(cutoff)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_betweenness_cutoff(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_vids, c_directed, c_normalized, c_cutoff));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_betweenness_subset(SEXP graph, SEXP weights, SEXP vids, SEXP sources, SEXP targets, SEXP directed, SEXP normalized) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_betweenness_subset(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_vids, c_sources, c_targets, c_directed, c_normalized));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_edge_betweenness(SEXP graph, SEXP weights, SEXP eids, SEXP directed, SEXP normalized) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_edge_betweenness(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_eids, c_directed, c_normalized));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_edge_betweenness_cutoff(SEXP graph, SEXP weights, SEXP eids, SEXP directed, SEXP normalized, SEXP cutoff) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_cutoff = REAL(cutoff)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_edge_betweenness_cutoff(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_eids, c_directed, c_normalized, c_cutoff));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_edge_betweenness_subset(SEXP graph, SEXP weights, SEXP sources, SEXP targets, SEXP eids, SEXP directed, SEXP normalized) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_edge_betweenness_subset(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_sources, c_targets, c_eids, c_directed, c_normalized));
  PutRNGstate();
...
SEXP R_igraph_harmonic_centrality_cutoff(SEXP graph, SEXP vids, SEXP mode, SEXP weights, SEXP normalized, SEXP cutoff) {
  ...
  c_cutoff = REAL(cutoff)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_harmonic_centrality_cutoff(&c_graph, &c_res, c_vids, c_mode, (Rf_isNull(weights) ? NULL : &c_weights), c_normalized, c_cutoff));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_personalized_pagerank(SEXP graph, SEXP weights, SEXP reset, SEXP damping, SEXP directed, SEXP vids, SEXP algo, SEXP options) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_vector;
  igraph_real_t c_value;
  igraph_vector_t c_reset;
  ...
  if (!Rf_isNull(reset)) {
    R_SEXP_to_vector(reset, &c_reset);
  }
  ...
  if (!Rf_isNull(options)) {
    if (c_algo == IGRAPH_PAGERANK_ALGO_ARPACK) {
      ...
      c_options = NULL;
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_personalized_pagerank(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_vector, &c_value, (Rf_isNull(reset) ? NULL : &c_reset), c_damping, c_directed, c_vids, c_algo, c_options));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_personalized_pagerank_vs(SEXP graph, SEXP weights, SEXP reset_vids, SEXP damping, SEXP directed, SEXP vids, SEXP algo, SEXP options) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_vector;
  ...
  if (!Rf_isNull(options)) {
    if (c_algo == IGRAPH_PAGERANK_ALGO_ARPACK) {
      ...
      c_options = NULL;
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_personalized_pagerank_vs(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_vector, &c_value, c_reset_vids, c_damping, c_directed, c_vids, c_algo, c_options));
  PutRNGstate();
...
/ igraph_rewire                              /
/-------------------------------------------*/
SEXP R_igraph_rewire(SEXP rewire, SEXP n, SEXP allowed_edge_types) {
                                        /* Declarations */
  igraph_t c_rewire;
  igraph_integer_t c_n;
  igraph_edge_type_sw_t c_allowed_edge_types;
  igraph_rewiring_stats_t c_stats;
  SEXP stats;

  SEXP r_result, r_names;
                                        /* Convert input */
  R_SEXP_to_igraph_copy(rewire, &c_rewire);
  ...
  c_allowed_edge_types = (igraph_edge_type_sw_t) Rf_asInteger(allowed_edge_types);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_rewire(&c_rewire, c_n, c_allowed_edge_types, &c_stats));
  PutRNGstate();

                                        /* Convert output */
  PROTECT(r_result=NEW_LIST(2));
  PROTECT(r_names=NEW_CHARACTER(2));
  PROTECT(rewire=R_igraph_to_SEXP(&c_rewire));
  IGRAPH_I_DESTROY(&c_rewire);
  IGRAPH_FINALLY_CLEAN(1);
  SET_VECTOR_ELT(r_result, 0, rewire);
  SET_VECTOR_ELT(r_result, 1, stats);
  SET_STRING_ELT(r_names, 0, Rf_mkChar("rewire"));
...
/-------------------------------------------*/
SEXP R_igraph_average_path_length(SEXP graph, SEXP weights, SEXP directed, SEXP unconn) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_real_t c_res;
  ...
  c_unconn = LOGICAL(unconn)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_average_path_length(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, &c_unconn_pairs, c_directed, c_unconn));
  PutRNGstate();
...
SEXP R_igraph_transitivity_barrat(SEXP graph, SEXP vids, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_transitivity_mode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_transitivity_barrat(&c_graph, &c_res, c_vids, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
SEXP R_igraph_constraint(SEXP graph, SEXP vids, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_constraint(&c_graph, &c_res, c_vids, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
/ igraph_density                             /
/-------------------------------------------*/
SEXP R_igraph_density(SEXP graph, SEXP weights, SEXP loops) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_real_t c_res;
  ...
  c_loops = LOGICAL(loops)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_density(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_loops));
  PutRNGstate();
...
SEXP R_igraph_feedback_arc_set(SEXP graph, SEXP weights, SEXP algo) {
  ...
  c_algo = (igraph_fas_algorithm_t) Rf_asInteger(algo);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_feedback_arc_set(&c_graph, &c_result, (Rf_isNull(weights) ? NULL : &c_weights), c_algo));
  PutRNGstate();
...
SEXP R_igraph_feedback_vertex_set(SEXP graph, SEXP weights, SEXP algo) {
  ...
  c_algo = (igraph_fvs_algorithm_t) Rf_asInteger(algo);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_feedback_vertex_set(&c_graph, &c_result, (Rf_isNull(weights) ? NULL : &c_weights), c_algo));
  PutRNGstate();
...
SEXP R_igraph_is_loop(SEXP graph, SEXP es) {
  ...
  IGRAPH_R_CHECK(R_SEXP_to_igraph_es(es, &c_graph, &c_es, &c_es_data));
                                        /* Call igraph */
  GetRNGstate();
...
/ igraph_is_simple                           /
/-------------------------------------------*/
SEXP R_igraph_is_simple(SEXP graph, SEXP directed) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_bool_t c_res;
  igraph_bool_t c_directed;
  ...
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_is_simple(&c_graph, &c_res, c_directed));
  PutRNGstate();
...
SEXP R_igraph_girth(SEXP graph) {
  ...
  SEXP r_result, r_names;
                                        /* Convert input */
  R_SEXP_to_igraph(graph, &c_graph);
  IGRAPH_R_CHECK(igraph_vector_int_init(&c_cycle, 0));
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_cycle);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_girth(&c_graph, &c_girth, &c_cycle));
  PutRNGstate();
  ...
  PROTECT(cycle=R_igraph_vector_int_to_SEXPp1(&c_cycle));
  igraph_vector_int_destroy(&c_cycle);
  IGRAPH_FINALLY_CLEAN(1);
  SET_VECTOR_ELT(r_result, 0, girth);
  SET_VECTOR_ELT(r_result, 1, cycle);
  SET_STRING_ELT(r_names, 0, Rf_mkChar("girth"));
  SET_STRING_ELT(r_names, 1, Rf_mkChar("cycle"));
  SET_NAMES(r_result, r_names);
  UNPROTECT(3);
...
/-------------------------------------------*/
SEXP R_igraph_eigenvector_centrality(SEXP graph, SEXP mode, SEXP weights, SEXP options) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_vector;
  igraph_real_t c_value;
  ...
  R_SEXP_to_igraph_arpack_options(options, &c_options);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_eigenvector_centrality(&c_graph, &c_vector, &c_value, c_mode, (Rf_isNull(weights) ? NULL : &c_weights), &c_options));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_hub_and_authority_scores(SEXP graph, SEXP weights, SEXP options) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  SEXP r_result, r_names;
                                        /* Convert input */
  R_SEXP_to_igraph(graph, &c_graph);
  IGRAPH_R_CHECK(igraph_vector_init(&c_hub_vector, 0));
  IGRAPH_FINALLY(igraph_vector_destroy, &c_hub_vector);
  IGRAPH_R_CHECK(igraph_vector_init(&c_authority_vector, 0));
  ...
  R_SEXP_to_igraph_arpack_options(options, &c_options);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_hub_and_authority_scores(&c_graph, &c_hub_vector, &c_authority_vector, &c_value, (Rf_isNull(weights) ? NULL : &c_weights), &c_options));
  PutRNGstate();
...
SEXP R_igraph_unfold_tree(SEXP graph, SEXP mode, SEXP roots) {
  ...
  R_SEXP_to_igraph(graph, &c_graph);
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(roots, &c_roots));
...
SEXP R_igraph_avg_nearest_neighbor_degree(SEXP graph, SEXP vids, SEXP mode, SEXP neighbor_degree_mode, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_avg_nearest_neighbor_degree(&c_graph, c_vids, c_mode, c_neighbor_degree_mode, &c_knn, &c_knnk, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_degree_correlation_vector(SEXP graph, SEXP weights, SEXP from_mode, SEXP to_mode, SEXP directed_neighbors) {
  ...
  c_directed_neighbors = LOGICAL(directed_neighbors)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_degree_correlation_vector(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_knnk, c_from_mode, c_to_mode, c_directed_neighbors));
  PutRNGstate();
...
SEXP R_igraph_rich_club_sequence(SEXP graph, SEXP weights, SEXP vertex_order, SEXP normalized, SEXP loops, SEXP directed) {
  ...
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_rich_club_sequence(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, &c_vertex_order, c_normalized, c_loops, c_directed));
  PutRNGstate();
...
SEXP R_igraph_strength(SEXP graph, SEXP vids, SEXP mode, SEXP loops, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_strength(&c_graph, &c_res, c_vids, c_mode, c_loops, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_centralization_degree_tmax(SEXP graph, SEXP nodes, SEXP mode, SEXP loops) {
  ...
  c_loops = (igraph_loops_t) Rf_asInteger(loops);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_centralization_degree_tmax((Rf_isNull(graph) ? NULL : &c_graph), c_nodes, c_mode, c_loops, &c_res));
  PutRNGstate();
...
SEXP R_igraph_centralization_betweenness_tmax(SEXP graph, SEXP nodes, SEXP directed) {
  ...
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_centralization_betweenness_tmax((Rf_isNull(graph) ? NULL : &c_graph), c_nodes, c_directed, &c_res));
  PutRNGstate();
...
SEXP R_igraph_centralization_closeness_tmax(SEXP graph, SEXP nodes, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_centralization_closeness_tmax((Rf_isNull(graph) ? NULL : &c_graph), c_nodes, c_mode, &c_res));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_centralization_eigenvector_centrality(SEXP graph, SEXP mode, SEXP options, SEXP normalized) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_vector;
  igraph_real_t c_value;
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_centralization_eigenvector_centrality(&c_graph, &c_vector, &c_value, c_mode, &c_options, &c_centralization, &c_theoretical_max, c_normalized));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_centralization_eigenvector_centrality_tmax(SEXP graph, SEXP nodes, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_integer_t c_nodes;
  igraph_neimode_t c_mode;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_centralization_eigenvector_centrality_tmax((Rf_isNull(graph) ? NULL : &c_graph), c_nodes, c_mode, &c_res));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_assortativity_nominal(SEXP graph, SEXP weights, SEXP types, SEXP directed, SEXP normalized) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_int_t c_types;
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_assortativity_nominal(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_types, &c_res, c_directed, c_normalized));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_assortativity(SEXP graph, SEXP weights, SEXP values, SEXP values_in, SEXP directed, SEXP normalized) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_assortativity(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_values, (Rf_isNull(values_in) ? NULL : &c_values_in), &c_res, c_directed, c_normalized));
  PutRNGstate();
...
SEXP R_igraph_joint_degree_matrix(SEXP graph, SEXP weights, SEXP max_out_degree, SEXP max_in_degree) {
  ...
  c_max_in_degree = (igraph_integer_t) REAL(max_in_degree)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_joint_degree_matrix(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_jdm, c_max_out_degree, c_max_in_degree));
  PutRNGstate();
...
SEXP R_igraph_joint_degree_distribution(SEXP graph, SEXP weights, SEXP from_mode, SEXP to_mode, SEXP directed_neighbors, SEXP normalized, SEXP max_from_degree, SEXP max_to_degree) {
  ...
  c_max_to_degree = (igraph_integer_t) REAL(max_to_degree)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_joint_degree_distribution(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_p, c_from_mode, c_to_mode, c_directed_neighbors, c_normalized, c_max_from_degree, c_max_to_degree));
  PutRNGstate();
...
SEXP R_igraph_joint_type_distribution(SEXP graph, SEXP weights, SEXP from_types, SEXP to_types, SEXP directed, SEXP normalized) {
  ...
  c_normalized = LOGICAL(normalized)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_joint_type_distribution(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_p, &c_from_types, (Rf_isNull(to_types) ? NULL : &c_to_types), c_directed, c_normalized));
  PutRNGstate();
...
/ igraph_eccentricity                        /
/-------------------------------------------*/
SEXP R_igraph_eccentricity(SEXP graph, SEXP weights, SEXP vids, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_eccentricity(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_vids, c_mode));
  PutRNGstate();
...
/ igraph_graph_center                        /
/-------------------------------------------*/
SEXP R_igraph_graph_center(SEXP graph, SEXP weights, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_int_t c_res;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_graph_center(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_mode));
  PutRNGstate();
...
SEXP R_igraph_pseudo_diameter(SEXP graph, SEXP weights, SEXP start_vid, SEXP directed, SEXP unconnected) {
  ...
  c_unconnected = LOGICAL(unconnected)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_pseudo_diameter(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_diameter, c_start_vid, &c_from, &c_to, c_directed, c_unconnected));
  PutRNGstate();
...
SEXP R_igraph_diversity(SEXP graph, SEXP weights, SEXP vids) {
  ...
  R_SEXP_to_igraph_vs(vids, &c_graph, &c_vids, &c_vids_data);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_diversity(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_vids));
  PutRNGstate();
...
SEXP R_igraph_random_walk(SEXP graph, SEXP weights, SEXP start, SEXP mode, SEXP steps, SEXP stuck) {
  ...
  c_stuck = (igraph_random_walk_stuck_t) Rf_asInteger(stuck);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_random_walk(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_vertices, &c_edges, c_start, c_mode, c_steps, c_stuck));
  PutRNGstate();
...
SEXP R_igraph_global_efficiency(SEXP graph, SEXP weights, SEXP directed) {
  ...
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_global_efficiency(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_directed));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_local_efficiency(SEXP graph, SEXP weights, SEXP vids, SEXP directed, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_res;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_efficiency(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_vids, c_directed, c_mode));
  PutRNGstate();
...
SEXP R_igraph_average_local_efficiency(SEXP graph, SEXP weights, SEXP directed, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_average_local_efficiency(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, c_directed, c_mode));
  PutRNGstate();
...
SEXP R_igraph_is_graphical(SEXP out_deg, SEXP in_deg, SEXP allowed_edge_types) {
  ...
  c_allowed_edge_types = (igraph_edge_type_sw_t) Rf_asInteger(allowed_edge_types);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_is_graphical(&c_out_deg, (Rf_isNull(in_deg) ? NULL : &c_in_deg), c_allowed_edge_types, &c_res));
  PutRNGstate();
...
SEXP R_igraph_create_bipartite(SEXP types, SEXP edges, SEXP directed) {
  ...
  SEXP r_result;
                                        /* Convert input */
  R_SEXP_to_vector_bool(types, &c_types);
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(edges, &c_edges));
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_edges);
  IGRAPH_R_CHECK_BOOL(directed);
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
...
/ igraph_biadjacency                         /
/-------------------------------------------*/
SEXP R_igraph_biadjacency(SEXP biadjmatrix, SEXP directed, SEXP mode, SEXP multiple) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_bool_t c_types;
  igraph_matrix_t c_biadjmatrix;
  igraph_bool_t c_directed;
  igraph_neimode_t c_mode;
  igraph_bool_t c_multiple;
  SEXP graph;
  ...
  IGRAPH_R_CHECK(igraph_vector_bool_init(&c_types, 0));
  IGRAPH_FINALLY(igraph_vector_bool_destroy, &c_types);
  R_SEXP_to_matrix(biadjmatrix, &c_biadjmatrix);
  IGRAPH_R_CHECK_BOOL(directed);
  c_directed = LOGICAL(directed)[0];
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
  IGRAPH_R_CHECK_BOOL(multiple);
  c_multiple = LOGICAL(multiple)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_biadjacency(&c_graph, &c_types, &c_biadjmatrix, c_directed, c_mode, c_multiple));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_weighted_biadjacency(SEXP biadjmatrix, SEXP directed, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_bool_t c_types;
  igraph_vector_t c_weights;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_weighted_biadjacency(&c_graph, &c_types, &c_weights, &c_biadjmatrix, c_directed, c_mode));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_get_biadjacency(SEXP graph, SEXP types, SEXP weights) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_bool_t c_types;
  igraph_vector_t c_weights;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_col_ids);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_biadjacency(&c_graph, &c_types, (Rf_isNull(weights) ? NULL : &c_weights), &c_res, &c_row_ids, &c_col_ids));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_bipartite_game_gnm(SEXP n1, SEXP n2, SEXP m, SEXP directed, SEXP mode, SEXP allowed_edge_types, SEXP edge_labeled) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_bool_t c_types;
  igraph_integer_t c_n1;
  ...
  c_edge_labeled = LOGICAL(edge_labeled)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_bipartite_game_gnm(&c_graph, &c_types, c_n1, c_n2, c_m, c_directed, c_mode, c_allowed_edge_types, c_edge_labeled));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_bipartite_iea_game(SEXP n1, SEXP n2, SEXP m, SEXP directed, SEXP mode) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_bool_t c_types;
  igraph_integer_t c_n1;
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_bipartite_iea_game(&c_graph, &c_types, c_n1, c_n2, c_m, c_directed, c_mode));
  PutRNGstate();
...
SEXP R_igraph_get_laplacian(SEXP graph, SEXP mode, SEXP normalization, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_laplacian(&c_graph, &c_res, c_mode, c_normalization, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_get_laplacian_sparse(SEXP graph, SEXP mode, SEXP normalization, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_laplacian_sparse(&c_graph, &c_sparseres, c_mode, c_normalization, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_biconnected_components(SEXP graph) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_tree_edges);
  if (0 != igraph_vector_int_list_init(&c_component_edges, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_component_edges);
  if (0 != igraph_vector_int_list_init(&c_components, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_components);
...
SEXP R_igraph_bond_percolation(SEXP graph, SEXP edge_order) {
  ...
  if (!Rf_isNull(edge_order)) {
    ...
    IGRAPH_FINALLY(igraph_vector_int_destroy, &c_edge_order);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_bond_percolation(&c_graph, &c_giant_size, &c_vetex_count, (Rf_isNull(edge_order) ? NULL : &c_edge_order)));
  PutRNGstate();
...
SEXP R_igraph_site_percolation(SEXP graph, SEXP vertex_order) {
  ...
  if (!Rf_isNull(vertex_order)) {
    ...
    IGRAPH_FINALLY(igraph_vector_int_destroy, &c_vertex_order);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_site_percolation(&c_graph, &c_giant_size, &c_edge_count, (Rf_isNull(vertex_order) ? NULL : &c_vertex_order)));
  PutRNGstate();
...
/ igraph_cliques                             /
/-------------------------------------------*/
SEXP R_igraph_cliques(SEXP graph, SEXP min_size, SEXP max_size, SEXP max_results) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_list_t c_res;
  ...
  c_max_results = (igraph_integer_t) REAL(max_results)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_cliques(&c_graph, &c_res, c_min_size, c_max_size, c_max_results));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_weighted_cliques(SEXP graph, SEXP vertex_weights, SEXP maximal, SEXP min_weight, SEXP max_weight, SEXP max_results) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  if (!Rf_isNull(vertex_weights)) {
    R_SEXP_to_vector(vertex_weights, &c_vertex_weights);
  }
  if (0 != igraph_vector_int_list_init(&c_res, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  ...
  c_max_results = (igraph_integer_t) REAL(max_results)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_weighted_cliques(&c_graph, (Rf_isNull(vertex_weights) ? NULL : &c_vertex_weights), &c_res, c_maximal, c_min_weight, c_max_weight, c_max_results));
  PutRNGstate();
...
SEXP R_igraph_largest_weighted_cliques(SEXP graph, SEXP vertex_weights) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_res);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_largest_weighted_cliques(&c_graph, (Rf_isNull(vertex_weights) ? NULL : &c_vertex_weights), &c_res));
  PutRNGstate();
...
SEXP R_igraph_weighted_clique_number(SEXP graph, SEXP vertex_weights) {
  ...
  if (!Rf_isNull(vertex_weights)) {
    R_SEXP_to_vector(vertex_weights, &c_vertex_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_weighted_clique_number(&c_graph, (Rf_isNull(vertex_weights) ? NULL : &c_vertex_weights), &c_res));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_maximal_independent_vertex_sets(SEXP graph, SEXP min_size, SEXP max_size, SEXP max_results) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_list_t c_res;
  igraph_integer_t c_min_size;
  ...
  c_max_results = (igraph_integer_t) REAL(max_results)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_maximal_independent_vertex_sets(&c_graph, &c_res, c_min_size, c_max_size, c_max_results));
  PutRNGstate();
...
SEXP R_igraph_layout_star(SEXP graph, SEXP center, SEXP order) {
  ...
  if (!Rf_isNull(order)) {
    ...
    IGRAPH_FINALLY(igraph_vector_int_destroy, &c_order);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_star(&c_graph, &c_res, c_center, (Rf_isNull(order) ? NULL : &c_order)));
  PutRNGstate();
...
SEXP R_igraph_layout_drl(SEXP graph, SEXP res, SEXP use_seed, SEXP options, SEXP weights) {
  ...
  SEXP r_result;
                                        /* Convert input */
  R_SEXP_to_igraph(graph, &c_graph);
  IGRAPH_R_CHECK(R_SEXP_to_igraph_matrix_copy(res, &c_res));
  IGRAPH_FINALLY(igraph_matrix_destroy, &c_res);
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_drl(&c_graph, &c_res, c_use_seed, &c_options, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_layout_drl_3d(SEXP graph, SEXP res, SEXP use_seed, SEXP options, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_drl_3d(&c_graph, &c_res, c_use_seed, &c_options, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_layout_sugiyama(SEXP graph, SEXP layers, SEXP hgap, SEXP vgap, SEXP maxiter, SEXP weights) {
  ...
  igraph_t c_graph;
  igraph_matrix_t c_res;
  igraph_matrix_list_t c_routing;
  igraph_vector_int_t c_layers;
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_sugiyama(&c_graph, &c_res, &c_routing, (Rf_isNull(layers) ? NULL : &c_layers), c_hgap, c_vgap, c_maxiter, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
  ...
  IGRAPH_FINALLY_CLEAN(1);
  SET_VECTOR_ELT(r_result, 0, res);
  SET_VECTOR_ELT(r_result, 1, routing);
  SET_STRING_ELT(r_names, 0, Rf_mkChar("res"));
  SET_STRING_ELT(r_names, 1, Rf_mkChar("routing"));
  SET_NAMES(r_result, r_names);
  UNPROTECT(3);
...
SEXP R_igraph_layout_mds(SEXP graph, SEXP dist, SEXP dim) {
  ...
  c_dim = (igraph_integer_t) REAL(dim)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_mds(&c_graph, &c_res, (Rf_isNull(dist) ? NULL : &c_dist), c_dim));
  PutRNGstate();
...
SEXP R_igraph_layout_umap(SEXP graph, SEXP res, SEXP use_seed, SEXP distances, SEXP min_dist, SEXP epochs, SEXP distances_are_weights) {
  ...
  c_distances_are_weights = LOGICAL(distances_are_weights)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_umap(&c_graph, &c_res, c_use_seed, (Rf_isNull(distances) ? NULL : &c_distances), c_min_dist, c_epochs, c_distances_are_weights));
  PutRNGstate();
...
SEXP R_igraph_layout_umap_3d(SEXP graph, SEXP res, SEXP use_seed, SEXP distances, SEXP min_dist, SEXP epochs, SEXP distances_are_weights) {
  ...
  c_distances_are_weights = LOGICAL(distances_are_weights)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_layout_umap_3d(&c_graph, &c_res, c_use_seed, (Rf_isNull(distances) ? NULL : &c_distances), c_min_dist, c_epochs, c_distances_are_weights));
  PutRNGstate();
...
SEXP R_igraph_layout_umap_compute_weights(SEXP graph, SEXP distances, SEXP weights) {
  ...
  R_SEXP_to_igraph(graph, &c_graph);
  R_SEXP_to_vector(distances, &c_distances);
  IGRAPH_R_CHECK(R_SEXP_to_vector_copy(weights, &c_weights));
  IGRAPH_FINALLY(igraph_vector_destroy, &c_weights);
                                        /* Call igraph */
  GetRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_similarity_dice(SEXP graph, SEXP from, SEXP to, SEXP mode, SEXP loops) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_res;
  igraph_vs_t c_from;
  ...
  c_loops = LOGICAL(loops)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_similarity_dice(&c_graph, &c_res, c_from, c_to, c_mode, c_loops));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_similarity_jaccard(SEXP graph, SEXP from, SEXP to, SEXP mode, SEXP loops) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_res;
  igraph_vs_t c_from;
  ...
  c_loops = LOGICAL(loops)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_similarity_jaccard(&c_graph, &c_res, c_from, c_to, c_mode, c_loops));
  PutRNGstate();
...
SEXP R_igraph_compare_communities(SEXP comm1, SEXP comm2, SEXP method) {
  ...
  SEXP r_result;
                                        /* Convert input */
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(comm1, &c_comm1));
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_comm1);
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(comm2, &c_comm2));
...
SEXP R_igraph_modularity(SEXP graph, SEXP membership, SEXP weights, SEXP resolution, SEXP directed) {
  ...
  SEXP r_result;
                                        /* Convert input */
  R_SEXP_to_igraph(graph, &c_graph);
  IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(membership, &c_membership));
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_membership);
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
  }
  ...
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_modularity(&c_graph, &c_membership, (Rf_isNull(weights) ? NULL : &c_weights), c_resolution, c_directed, &c_modularity));
  PutRNGstate();
...
SEXP R_igraph_modularity_matrix(SEXP graph, SEXP weights, SEXP resolution, SEXP directed) {
  ...
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_modularity_matrix(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), c_resolution, &c_modmat, c_directed));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_community_label_propagation(SEXP graph, SEXP mode, SEXP weights, SEXP initial, SEXP fixed, SEXP lpa_variant) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_membership;
  igraph_neimode_t c_mode;
  ...
  igraph_lpa_variant_t c_lpa_variant;
  SEXP membership;
  ...
  c_lpa_variant = (igraph_lpa_variant_t) Rf_asInteger(lpa_variant);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_community_label_propagation(&c_graph, &c_membership, c_mode, (Rf_isNull(weights) ? NULL : &c_weights), (Rf_isNull(initial) ? NULL : &c_initial), (Rf_isNull(fixed) ? NULL : &c_fixed), c_lpa_variant));
  PutRNGstate();
...
SEXP R_igraph_community_multilevel(SEXP graph, SEXP weights, SEXP resolution) {
  ...
  IGRAPH_FINALLY(igraph_vector_destroy, &c_modularity);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_community_multilevel(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), c_resolution, &c_membership, &c_memberships, &c_modularity));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_community_optimal_modularity(SEXP graph, SEXP weights, SEXP resolution) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_real_t c_resolution;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_membership);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_community_optimal_modularity(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), c_resolution, &c_modularity, &c_membership));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_community_leiden(SEXP graph, SEXP weights, SEXP vertex_out_weights, SEXP vertex_in_weights, SEXP resolution, SEXP beta, SEXP start, SEXP n_iterations, SEXP membership) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_t c_vertex_out_weights;
  igraph_vector_t c_vertex_in_weights;
  igraph_real_t c_resolution;
  ...
  if (!Rf_isNull(vertex_out_weights)) {
    R_SEXP_to_vector(vertex_out_weights, &c_vertex_out_weights);
  }
  if (!Rf_isNull(vertex_in_weights)) {
    R_SEXP_to_vector(vertex_in_weights, &c_vertex_in_weights);
  }
  IGRAPH_R_CHECK_REAL(resolution);
  c_resolution = REAL(resolution)[0];
  ...
  c_nb_clusters=0;
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_community_leiden(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), (Rf_isNull(vertex_out_weights) ? NULL : &c_vertex_out_weights), (Rf_isNull(vertex_in_weights) ? NULL : &c_vertex_in_weights), c_resolution, c_beta, c_start, c_n_iterations, &c_membership, &c_nb_clusters, &c_quality));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_community_leiden_simple(SEXP graph, SEXP weights, SEXP objective, SEXP resolution, SEXP beta, SEXP start, SEXP n_iterations, SEXP membership) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_leiden_objective_t c_objective;
  igraph_real_t c_resolution;
  igraph_real_t c_beta;
  igraph_bool_t c_start;
  igraph_integer_t c_n_iterations;
  ...
  c_objective = (igraph_leiden_objective_t) Rf_asInteger(objective);
  IGRAPH_R_CHECK_REAL(resolution);
  c_resolution = REAL(resolution)[0];
  IGRAPH_R_CHECK_REAL(beta);
  c_beta = REAL(beta)[0];
  ...
  c_nb_clusters=0;
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_community_leiden_simple(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), c_objective, c_resolution, c_beta, c_start, c_n_iterations, &c_membership, &c_nb_clusters, &c_quality));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_community_infomap(SEXP graph, SEXP edge_weights, SEXP vertex_weights, SEXP nb_trials, SEXP is_regularized, SEXP regularization_strength) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_edge_weights;
  igraph_vector_t c_vertex_weights;
  igraph_integer_t c_nb_trials;
  igraph_bool_t c_is_regularized;
  igraph_real_t c_regularization_strength;
  igraph_vector_int_t c_membership;
  ...
  if (!Rf_isNull(edge_weights)) {
    R_SEXP_to_vector(edge_weights, &c_edge_weights);
  }
  if (!Rf_isNull(vertex_weights)) {
    R_SEXP_to_vector(vertex_weights, &c_vertex_weights);
  }
  ...
  IGRAPH_R_CHECK_BOOL(is_regularized);
  c_is_regularized = LOGICAL(is_regularized)[0];
  IGRAPH_R_CHECK_REAL(regularization_strength);
  c_regularization_strength = REAL(regularization_strength)[0];
  IGRAPH_R_CHECK(igraph_vector_int_init(&c_membership, 0));
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_membership);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_community_infomap(&c_graph, (Rf_isNull(edge_weights) ? NULL : &c_edge_weights), (Rf_isNull(vertex_weights) ? NULL : &c_vertex_weights), c_nb_trials, c_is_regularized, c_regularization_strength, &c_membership, &c_codelength));
  PutRNGstate();
...
SEXP R_igraph_graphlets_candidate_basis(SEXP graph, SEXP weights) {
  ...
  IGRAPH_FINALLY(igraph_vector_destroy, &c_thresholds);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_graphlets_candidate_basis(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_cliques, &c_thresholds));
  PutRNGstate();
...
SEXP R_igraph_graphlets_project(SEXP graph, SEXP weights, SEXP cliques, SEXP Muc, SEXP startMu, SEXP niter) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_cliques);
  IGRAPH_R_CHECK(R_SEXP_to_vector_copy(Muc, &c_Muc));
  ...
  c_niter = (igraph_integer_t) REAL(niter)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_graphlets_project(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_cliques, &c_Muc, c_startMu, c_niter));
  PutRNGstate();

                                        /* Convert output */
  igraph_vector_int_list_destroy(&c_cliques);
  IGRAPH_FINALLY_CLEAN(1);
  PROTECT(Muc=R_igraph_vector_to_SEXP(&c_Muc));
...
SEXP R_igraph_hrg_fit(SEXP graph, SEXP hrg, SEXP start, SEXP steps) {
  ...
  SEXP r_result;
                                        /* Convert input */
  R_SEXP_to_igraph(graph, &c_graph);
  IGRAPH_R_CHECK(R_SEXP_to_hrg_copy(hrg, &c_hrg));
...
SEXP R_igraph_get_adjacency_sparse(SEXP graph, SEXP type, SEXP weights, SEXP loops) {
  ...
  c_loops = (igraph_loops_t) Rf_asInteger(loops);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_adjacency_sparse(&c_graph, &c_sparsemat, c_type, (Rf_isNull(weights) ? NULL : &c_weights), c_loops));
  PutRNGstate();
...
SEXP R_igraph_get_stochastic(SEXP graph, SEXP column_wise, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_stochastic(&c_graph, &c_res, c_column_wise, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_get_stochastic_sparse(SEXP graph, SEXP column_wise, SEXP weights) {
  ...
  if (!Rf_isNull(weights)) {
    R_SEXP_to_vector(weights, &c_weights);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_stochastic_sparse(&c_graph, &c_sparsemat, c_column_wise, (Rf_isNull(weights) ? NULL : &c_weights)));
  PutRNGstate();
...
SEXP R_igraph_write_graph_gml(SEXP graph, SEXP outstream, SEXP options, SEXP id, SEXP creator) {
  ...
  if (!Rf_isNull(creator)) {
    c_creator = Rf_translateCharUTF8(STRING_ELT(creator, 0));
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_write_graph_gml(&c_graph, c_outstream, c_options, &c_id, (Rf_isNull(creator) ? NULL : c_creator)));
  PutRNGstate();
...
SEXP R_igraph_motifs_randesu(SEXP graph, SEXP size, SEXP cut_prob) {
  ...
  if (!Rf_isNull(cut_prob)) {
    R_SEXP_to_vector(cut_prob, &c_cut_prob);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_motifs_randesu(&c_graph, &c_hist, c_size, (Rf_isNull(cut_prob) ? NULL : &c_cut_prob)));
  PutRNGstate();
...
SEXP R_igraph_motifs_randesu_estimate(SEXP graph, SEXP size, SEXP cut_prob, SEXP sample_size, SEXP sample) {
  ...
  if (!Rf_isNull(sample)) {
    IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(sample, &c_sample));
    ...
    IGRAPH_FINALLY(igraph_vector_int_destroy, &c_sample);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_motifs_randesu_estimate(&c_graph, &c_est, c_size, (Rf_isNull(cut_prob) ? NULL : &c_cut_prob), c_sample_size, (Rf_isNull(sample) ? NULL : &c_sample)));
  PutRNGstate();
...
SEXP R_igraph_motifs_randesu_no(SEXP graph, SEXP size, SEXP cut_prob) {
  ...
  if (!Rf_isNull(cut_prob)) {
    R_SEXP_to_vector(cut_prob, &c_cut_prob);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_motifs_randesu_no(&c_graph, &c_no, c_size, (Rf_isNull(cut_prob) ? NULL : &c_cut_prob)));
  PutRNGstate();
...
SEXP R_igraph_local_scan_0(SEXP graph, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_0(&c_graph, &c_res, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
SEXP R_igraph_local_scan_0_them(SEXP us, SEXP them, SEXP weights_them, SEXP mode) {
  ...
  if (!Rf_isNull(weights_them)) {
    R_SEXP_to_vector(weights_them, &c_weights_them);
  }
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_0_them(&c_us, &c_them, &c_res, (Rf_isNull(weights_them) ? NULL : &c_weights_them), c_mode));
  PutRNGstate();
...
SEXP R_igraph_local_scan_1_ecount(SEXP graph, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_1_ecount(&c_graph, &c_res, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
SEXP R_igraph_local_scan_1_ecount_them(SEXP us, SEXP them, SEXP weights_them, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_1_ecount_them(&c_us, &c_them, &c_res, (Rf_isNull(weights_them) ? NULL : &c_weights_them), c_mode));
  PutRNGstate();
...
SEXP R_igraph_local_scan_k_ecount(SEXP graph, SEXP k, SEXP weights, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_k_ecount(&c_graph, c_k, &c_res, (Rf_isNull(weights) ? NULL : &c_weights), c_mode));
  PutRNGstate();
...
SEXP R_igraph_local_scan_k_ecount_them(SEXP us, SEXP them, SEXP k, SEXP weights_them, SEXP mode) {
  ...
  c_mode = (igraph_neimode_t) Rf_asInteger(mode);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_k_ecount_them(&c_us, &c_them, c_k, &c_res, (Rf_isNull(weights_them) ? NULL : &c_weights_them), c_mode));
  PutRNGstate();
...
SEXP R_igraph_local_scan_neighborhood_ecount(SEXP graph, SEXP weights, SEXP neighborhoods) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_neighborhoods);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_neighborhood_ecount(&c_graph, &c_res, (Rf_isNull(weights) ? NULL : &c_weights), &c_neighborhoods));
  PutRNGstate();
...
SEXP R_igraph_local_scan_subset_ecount(SEXP graph, SEXP weights, SEXP subsets) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_subsets);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_local_scan_subset_ecount(&c_graph, &c_res, (Rf_isNull(weights) ? NULL : &c_weights), &c_subsets));
  PutRNGstate();
...
SEXP R_igraph_union(SEXP left, SEXP right) {
  ...
  IGRAPH_I_DESTROY(&c_res);
  IGRAPH_FINALLY_CLEAN(1);
  PROTECT(edge_map_left=R_igraph_vector_int_to_SEXPp1(&c_edge_map_left));
  igraph_vector_int_destroy(&c_edge_map_left);
  IGRAPH_FINALLY_CLEAN(1);
  PROTECT(edge_map_right=R_igraph_vector_int_to_SEXPp1(&c_edge_map_right));
...
SEXP R_igraph_difference(SEXP orig, SEXP sub) {
  ...
  SEXP r_result;
                                        /* Convert input */
  R_SEXP_to_igraph(orig, &c_orig);
  R_SEXP_to_igraph(sub, &c_sub);
                                        /* Call igraph */
  GetRNGstate();
...
SEXP R_igraph_compose(SEXP g1, SEXP g2) {
  ...
  IGRAPH_I_DESTROY(&c_res);
  IGRAPH_FINALLY_CLEAN(1);
  PROTECT(edge_map1=R_igraph_vector_int_to_SEXPp1(&c_edge_map1));
  igraph_vector_int_destroy(&c_edge_map1);
  IGRAPH_FINALLY_CLEAN(1);
  PROTECT(edge_map2=R_igraph_vector_int_to_SEXPp1(&c_edge_map2));
...
SEXP R_igraph_gomory_hu_tree(SEXP graph, SEXP capacity) {
  ...
  if (!Rf_isNull(capacity)) {
    R_SEXP_to_vector(capacity, &c_capacity);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_gomory_hu_tree(&c_graph, &c_tree, &c_flows, (Rf_isNull(capacity) ? NULL : &c_capacity)));
  PutRNGstate();
...
SEXP R_igraph_maxflow(SEXP graph, SEXP source, SEXP target, SEXP capacity) {
  ...
  if (!Rf_isNull(capacity)) {
    R_SEXP_to_vector(capacity, &c_capacity);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_maxflow(&c_graph, &c_value, &c_flow, &c_cut, &c_partition1, &c_partition2, c_source, c_target, (Rf_isNull(capacity) ? NULL : &c_capacity), &c_stats));
  PutRNGstate();
...
SEXP R_igraph_mincut(SEXP graph, SEXP capacity) {
  ...
  if (!Rf_isNull(capacity)) {
    R_SEXP_to_vector(capacity, &c_capacity);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_mincut(&c_graph, &c_value, &c_partition1, &c_partition2, &c_cut, (Rf_isNull(capacity) ? NULL : &c_capacity)));
  PutRNGstate();
...
SEXP R_igraph_mincut_value(SEXP graph, SEXP capacity) {
  ...
  if (!Rf_isNull(capacity)) {
    R_SEXP_to_vector(capacity, &c_capacity);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_mincut_value(&c_graph, &c_res, (Rf_isNull(capacity) ? NULL : &c_capacity)));
  PutRNGstate();
...
SEXP R_igraph_st_mincut(SEXP graph, SEXP source, SEXP target, SEXP capacity) {
  ...
  if (!Rf_isNull(capacity)) {
    R_SEXP_to_vector(capacity, &c_capacity);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_st_mincut(&c_graph, &c_value, &c_cut, &c_partition1, &c_partition2, c_source, c_target, (Rf_isNull(capacity) ? NULL : &c_capacity)));
  PutRNGstate();
...
SEXP R_igraph_all_st_cuts(SEXP graph, SEXP source, SEXP target) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_cuts);
  if (0 != igraph_vector_int_list_init(&c_partition1s, 0)) {
    igraph_error("", __FILE__, __LINE__, IGRAPH_ENOMEM);
  }
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_partition1s);
  c_source = (igraph_integer_t) REAL(source)[0];
  c_target = (igraph_integer_t) REAL(target)[0];
                                        /* Call igraph */
  GetRNGstate();
...
SEXP R_igraph_all_st_mincuts(SEXP graph, SEXP source, SEXP target, SEXP capacity) {
  ...
  if (!Rf_isNull(capacity)) {
    R_SEXP_to_vector(capacity, &c_capacity);
                                        ...
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_all_st_mincuts(&c_graph, &c_value, &c_cuts, &c_partition1s, c_source, c_target, (Rf_isNull(capacity) ? NULL : &c_capacity)));
  PutRNGstate();
...
SEXP R_igraph_all_minimal_st_separators(SEXP graph) {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_separators);
                                        /* Call igraph */
  GetRNGstate();
...
SEXP R_igraph_coreness(SEXP graph, SEXP mode) {
  ...
  PutRNGstate();
                                        ...
                                        /* Convert output */
  PROTECT(cores=R_igraph_vector_int_to_SEXP(&c_cores));
...
/-------------------------------------------*/
SEXP R_igraph_automorphism_group(SEXP graph, SEXP colors) {
                                        /* Declarations */
  igraph_t c_graph;
  ...
  R_SEXP_to_igraph(graph, &c_graph);
  if (!Rf_isNull(colors)) {
    IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(colors, &c_colors));
  } else {
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_generators);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_automorphism_group(&c_graph, (Rf_isNull(colors) ? NULL : &c_colors), &c_generators));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_count_automorphisms(SEXP graph, SEXP colors) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_colors;
  igraph_real_t c_result;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_colors);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_count_automorphisms(&c_graph, (Rf_isNull(colors) ? NULL : &c_colors), &c_result));
  PutRNGstate();
...
SEXP R_igraph_isomorphic_vf2(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_map21);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_isomorphic_vf2(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_iso, &c_map12, &c_map21, 0, 0, 0));
  PutRNGstate();
...
SEXP R_igraph_get_isomorphisms_vf2_callback(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_map21);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_isomorphisms_vf2_callback(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_map12, &c_map21, 0, 0, 0, 0));
  PutRNGstate();
...
SEXP R_igraph_count_isomorphisms_vf2(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  c_count=0;
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_count_isomorphisms_vf2(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_count, 0, 0, 0));
  PutRNGstate();
...
SEXP R_igraph_get_isomorphisms_vf2(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_list_destroy, &c_maps);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_isomorphisms_vf2(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_maps, 0, 0, 0));
  PutRNGstate();
...
SEXP R_igraph_subisomorphic_vf2(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_map21);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_subisomorphic_vf2(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_iso, &c_map12, &c_map21, 0, 0, 0));
  PutRNGstate();
...
SEXP R_igraph_count_subisomorphisms_vf2(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  c_count=0;
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_count_subisomorphisms_vf2(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_count, 0, 0, 0));
  PutRNGstate();
...
SEXP R_igraph_get_subisomorphisms_vf2(SEXP graph1, SEXP graph2, SEXP vertex_color1, SEXP vertex_color2, SEXP edge_color1, SEXP edge_color2) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_list_destroy, &c_maps);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_get_subisomorphisms_vf2(&c_graph1, &c_graph2, (Rf_isNull(vertex_color1) ? NULL : &c_vertex_color1), (Rf_isNull(vertex_color2) ? NULL : &c_vertex_color2), (Rf_isNull(edge_color1) ? NULL : &c_edge_color1), (Rf_isNull(edge_color2) ? NULL : &c_edge_color2), &c_maps, 0, 0, 0));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_canonical_permutation(SEXP graph, SEXP colors) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_colors;
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_labeling);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_canonical_permutation(&c_graph, (Rf_isNull(colors) ? NULL : &c_colors), &c_labeling));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_canonical_permutation_bliss(SEXP graph, SEXP colors, SEXP sh) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_colors;
  igraph_vector_int_t c_labeling;
  ...
  c_sh = (igraph_bliss_sh_t) Rf_asInteger(sh);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_canonical_permutation_bliss(&c_graph, (Rf_isNull(colors) ? NULL : &c_colors), &c_labeling, c_sh, &c_info));
  PutRNGstate();
...
SEXP R_igraph_isomorphic_bliss(SEXP graph1, SEXP graph2, SEXP colors1, SEXP colors2, SEXP sh) {
  ...
  if (!Rf_isNull(colors1)) {
    IGRAPH_R_CHECK(R_SEXP_to_vector_int_copy(colors1, &c_colors1));
  } else {
  ...
  c_sh = (igraph_bliss_sh_t) Rf_asInteger(sh);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_isomorphic_bliss(&c_graph1, &c_graph2, (Rf_isNull(colors1) ? NULL : &c_colors1), (Rf_isNull(colors2) ? NULL : &c_colors2), &c_iso, &c_map12, &c_map21, c_sh, &c_info1, &c_info2));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_count_automorphisms_bliss(SEXP graph, SEXP colors, SEXP sh) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_colors;
  igraph_bliss_sh_t c_sh;
  ...
  c_sh = (igraph_bliss_sh_t) Rf_asInteger(sh);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_count_automorphisms_bliss(&c_graph, (Rf_isNull(colors) ? NULL : &c_colors), c_sh, &c_info));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_automorphism_group_bliss(SEXP graph, SEXP colors, SEXP sh) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_t c_colors;
  igraph_vector_int_list_t c_generators;
  ...
  c_sh = (igraph_bliss_sh_t) Rf_asInteger(sh);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_automorphism_group_bliss(&c_graph, (Rf_isNull(colors) ? NULL : &c_colors), &c_generators, c_sh, &c_info));
  PutRNGstate();
...
SEXP R_igraph_is_matching(SEXP graph, SEXP types, SEXP matching) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_matching);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_is_matching(&c_graph, (Rf_isNull(types) ? NULL : &c_types), &c_matching, &c_res));
  PutRNGstate();
...
SEXP R_igraph_is_maximal_matching(SEXP graph, SEXP types, SEXP matching) {
  ...
  IGRAPH_FINALLY(igraph_vector_int_destroy, &c_matching);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_is_maximal_matching(&c_graph, (Rf_isNull(types) ? NULL : &c_types), &c_matching, &c_res));
  PutRNGstate();
...
SEXP R_igraph_maximum_bipartite_matching(SEXP graph, SEXP types, SEXP weights, SEXP eps) {
  ...
  c_eps = REAL(eps)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_maximum_bipartite_matching(&c_graph, &c_types, &c_matching_size, &c_matching_weight, &c_matching, (Rf_isNull(weights) ? NULL : &c_weights), c_eps));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_simple_cycles(SEXP graph, SEXP mode, SEXP min_cycle_length, SEXP max_cycle_length, SEXP max_results) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_int_list_t c_vertices;
  igraph_vector_int_list_t c_edges;
  ...
  c_max_results = (igraph_integer_t) REAL(max_results)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_simple_cycles(&c_graph, &c_vertices, &c_edges, c_mode, c_min_cycle_length, c_max_cycle_length, c_max_results));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_fundamental_cycles(SEXP graph, SEXP weights, SEXP start, SEXP bfs_cutoff) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_int_list_t c_basis;
  igraph_integer_t c_start;
  igraph_real_t c_bfs_cutoff;
  SEXP basis;
  ...
  IGRAPH_FINALLY_PV(igraph_vector_int_list_destroy, &c_basis);
  if (!Rf_isNull(start)) {
    c_start = (igraph_integer_t) REAL(start)[0];
  }
  IGRAPH_R_CHECK_REAL(bfs_cutoff);
...
/-------------------------------------------*/
SEXP R_igraph_minimum_cycle_basis(SEXP graph, SEXP weights, SEXP bfs_cutoff, SEXP complete, SEXP use_cycle_order) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_vector_int_list_t c_basis;
  ...
  c_use_cycle_order = LOGICAL(use_cycle_order)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_minimum_cycle_basis(&c_graph, (Rf_isNull(weights) ? NULL : &c_weights), &c_basis, c_bfs_cutoff, c_complete, c_use_cycle_order));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_nearest_neighbor_graph(SEXP points, SEXP metric, SEXP neighbors, SEXP cutoff, SEXP directed) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_points;
  igraph_metric_t c_metric;
  igraph_integer_t c_neighbors;
  igraph_real_t c_cutoff;
  igraph_bool_t c_directed;
  SEXP graph;
  ...
  IGRAPH_R_CHECK_INT(neighbors);
  c_neighbors = (igraph_integer_t) REAL(neighbors)[0];
  IGRAPH_R_CHECK_REAL(cutoff);
  c_cutoff = REAL(cutoff)[0];
  IGRAPH_R_CHECK_BOOL(directed);
  c_directed = LOGICAL(directed)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_nearest_neighbor_graph(&c_graph, &c_points, c_metric, c_neighbors, c_cutoff, c_directed));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_delaunay_graph(SEXP points) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_points;
  SEXP graph;
  ...
  R_SEXP_to_matrix(points, &c_points);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_delaunay_graph(&c_graph, &c_points));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_gabriel_graph(SEXP points) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_points;
  SEXP graph;
  ...
  R_SEXP_to_matrix(points, &c_points);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_gabriel_graph(&c_graph, &c_points));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_relative_neighborhood_graph(SEXP points) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_points;
  SEXP graph;
  ...
  R_SEXP_to_matrix(points, &c_points);
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_relative_neighborhood_graph(&c_graph, &c_points));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_lune_beta_skeleton(SEXP points, SEXP beta) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_points;
  igraph_real_t c_beta;
  ...
  c_beta = REAL(beta)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_lune_beta_skeleton(&c_graph, &c_points, c_beta));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_circle_beta_skeleton(SEXP points, SEXP beta) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_matrix_t c_points;
  igraph_real_t c_beta;
  ...
  c_beta = REAL(beta)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_circle_beta_skeleton(&c_graph, &c_points, c_beta));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_beta_weighted_gabriel_graph(SEXP points, SEXP max_beta) {
                                        /* Declarations */
  igraph_t c_graph;
  igraph_vector_t c_weights;
  igraph_matrix_t c_points;
  igraph_real_t c_max_beta;
  SEXP graph;
  SEXP weights;
  ...
  weights=R_GlobalEnv; /* hack to have a non-NULL value */
  R_SEXP_to_matrix(points, &c_points);
  IGRAPH_R_CHECK_REAL(max_beta);
  c_max_beta = REAL(max_beta)[0];
                                        /* Call igraph */
  GetRNGstate();
  IGRAPH_R_CHECK(igraph_beta_weighted_gabriel_graph(&c_graph, &c_weights, &c_points, c_max_beta));
  PutRNGstate();
...
/-------------------------------------------*/
SEXP R_igraph_spatial_edge_lengths(SEXP graph, SEXP points, SEXP METRIC) {
                                        /* Declarations */
  igraph_t c_graph;
