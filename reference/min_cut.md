...
#> 
#> $partition1
#> ── <vertex sequence> 1/100 · from fbf66bf ──────────────────────────────────────
#> [1] 2
#> 
#> $partition2
#> ── <vertex sequence> 99/100 · from fbf66bf ─────────────────────────────────────
...
#> 
#> $cut
#> ── <edge sequence> 2/100 · from fbf66bf ────────────────────────────────────────
#> [1] 1 ─ 2  2 ─ 3 
#> 
...
#> 
#> $partition1
#> ── <vertex sequence> 1/6 · from 1586747 ────────────────────────────────────────
#> [1] 2
#> 
#> $partition2
#> ── <vertex sequence> 5/6 · from 1586747 ────────────────────────────────────────
#> [1] 1 3 4 5 6
#> 
#> $cut
#> ── <edge sequence> 1/7 · from 1586747 ──────────────────────────────────────────
#> [1] 2 → 3 
#> 
```
