...
g <- make_ring(10)
V(g)
#> ── <vertex sequence> 10/10 · from d5ad945 ──────────────────────────────────────
...
V(g2)
#> ── <vertex sequence> 10/10 · named · from 738b02b ──────────────────────────────
#>  [1] A B C D E F G H I J

# All vertices in the sequence
g3 <- make_ring(1000)
V(g3)
#> ── <vertex sequence> 1000/1000 · from 3ab7560 ──────────────────────────────────
...
V(g4)[[]]
#> ── <vertex sequence> 10/10 · named · from 88d500c ──────────────────────────────
#>    name color
#> 1     A   red
#> 2     B   red
#> 3     C   red
...
#> 10    J   red
V(g4)[[2:5, 7:8]]
#> ── <vertex sequence> 6/10 · named · from 88d500c ───────────────────────────────
#>   name color
#> 2    B   red
#> 3    C   red
#> 4    D   red
