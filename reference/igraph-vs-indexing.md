...
V(g)[.nei(c(2, 4))]
#> + 4/4 vertices, from bf5bef3:
#> [1] 1 2 3 4
V(g)[.nei(c(2, 4), "in")]
#> + 3/4 vertices, from bf5bef3:
#> [1] 1 2 4
V(g)[.nei(c(2, 4), "out")]
#> + 3/4 vertices, from bf5bef3:
#> [1] 2 3 4
...
V(g)[.nei(c("B", "D"))]
#> + 4/4 vertices, named, from 1e5201e:
#> [1] A B C D
V(g)[.nei(c("B", "D"), "in")]
#> + 3/4 vertices, named, from 1e5201e:
#> [1] A B D
V(g)[.nei(c("B", "D"), "out")]
#> + 3/4 vertices, named, from 1e5201e:
#> [1] B C D
...
V(g)[color == "red"]
#> + 2/4 vertices, named, from f32a902:
#> [1] A B
