...
V(g)[.nei(c(2, 4))]
#> ── <vertex sequence> 4/4 · from b21464f ────────────────────────────────────────
#> [1] 1 2 3 4
V(g)[.nei(c(2, 4), "in")]
#> ── <vertex sequence> 3/4 · from b21464f ────────────────────────────────────────
#> [1] 1 2 4
V(g)[.nei(c(2, 4), "out")]
#> ── <vertex sequence> 3/4 · from b21464f ────────────────────────────────────────
#> [1] 2 3 4
...
V(g)[.nei(c("B", "D"))]
#> ── <vertex sequence> 4/4 · named · from a1c66fb ────────────────────────────────
#> [1] A B C D
V(g)[.nei(c("B", "D"), "in")]
#> ── <vertex sequence> 3/4 · named · from a1c66fb ────────────────────────────────
#> [1] A B D
V(g)[.nei(c("B", "D"), "out")]
#> ── <vertex sequence> 3/4 · named · from a1c66fb ────────────────────────────────
#> [1] B C D
...
V(g)[color == "red"]
#> ── <vertex sequence> 2/4 · named · from cddf405 ────────────────────────────────
#> [1] A B
...
x <- 2
V(g)[.env$x]
#> ── <vertex sequence> 1/4 · named · from cddf405 ────────────────────────────────
#> [1] B
```
