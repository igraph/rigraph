...
V(g)[.nei(c(2, 4))]
#> + 4/4 vertices, from 8e4d480:
#> [1] 1 2 3 4
V(g)[.nei(c(2, 4), "in")]
#> + 3/4 vertices, from 8e4d480:
#> [1] 1 2 4
V(g)[.nei(c(2, 4), "out")]
#> + 3/4 vertices, from 8e4d480:
#> [1] 2 3 4
...
V(g)[.nei(c("B", "D"))]
#> + 4/4 vertices, named, from 7607c78:
#> [1] A B C D
V(g)[.nei(c("B", "D"), "in")]
#> + 3/4 vertices, named, from 7607c78:
#> [1] A B D
V(g)[.nei(c("B", "D"), "out")]
#> + 3/4 vertices, named, from 7607c78:
#> [1] B C D
...
V(g)[color == "red"]
#> + 2/4 vertices, named, from fcb8b83:
#> [1] A B
