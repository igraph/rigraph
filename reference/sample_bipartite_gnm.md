...
#> IGRAPH 3af072a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3af072a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 98150ff U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 98150ff:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 5e7c374 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5e7c374:
...
#> IGRAPH 55a26f8 D--B 15 20 -- Bipartite Gnm random graph
