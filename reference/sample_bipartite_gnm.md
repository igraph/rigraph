...
#> IGRAPH fcf1aa0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fcf1aa0:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 461a965 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 461a965:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 269f760 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 269f760:
...
#> IGRAPH f298e46 D--B 15 20 -- Bipartite Gnm random graph
