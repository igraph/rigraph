...
#> IGRAPH 7d42758 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7d42758:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2221cf9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2221cf9:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fe168a1 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fe168a1:
#> [1] 1--11 5--13 8--13
...
#> IGRAPH a5150c8 D--B 15 20 -- Bipartite Gnm random graph
