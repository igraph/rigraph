...
#> IGRAPH 26cf561 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26cf561:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a64d891 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a64d891:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 054e50c U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 054e50c:
...
#> IGRAPH 3755dca D--B 15 20 -- Bipartite Gnm random graph
