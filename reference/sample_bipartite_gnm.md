...
#> IGRAPH 04c3b28 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 04c3b28:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 572b06d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 572b06d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3632d10 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3632d10:
...
#> IGRAPH aa9e336 D--B 15 20 -- Bipartite Gnm random graph
