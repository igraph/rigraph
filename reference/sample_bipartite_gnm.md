...
#> IGRAPH aabed60 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aabed60:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 70d16e4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 70d16e4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 039b317 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 039b317:
#> [1] 1--13 3--14
...
#> IGRAPH eca418a D--B 15 20 -- Bipartite Gnm random graph
