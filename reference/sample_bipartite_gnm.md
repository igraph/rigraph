...
#> IGRAPH 2356d7f U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2356d7f:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH b073cae U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b073cae:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 92d9547 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 92d9547:
...
#> IGRAPH edaf8bd D--B 15 20 -- Bipartite Gnm random graph
