...
#> IGRAPH fc9e079 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fc9e079:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c9da090 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c9da090:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b7de10c U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b7de10c:
...
#> IGRAPH 95ae46b D--B 15 20 -- Bipartite Gnm random graph
