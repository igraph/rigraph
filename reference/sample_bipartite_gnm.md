...
#> IGRAPH d199217 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d199217:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 25531d4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 25531d4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH dc6c5b3 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dc6c5b3:
#> [1] 1--13 3--14
...
#> IGRAPH 3a38548 D--B 15 20 -- Bipartite Gnm random graph
