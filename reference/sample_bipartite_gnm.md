...
#> IGRAPH 895e083 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 895e083:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2d15ad6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2d15ad6:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fa9a506 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fa9a506:
...
#> IGRAPH 3f500a7 D--B 15 20 -- Bipartite Gnm random graph
