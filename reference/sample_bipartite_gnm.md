...
#> IGRAPH 842c8e9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 842c8e9:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5a8c47b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5a8c47b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b20c7a8 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b20c7a8:
#> [1] 2--11 6--11
...
#> IGRAPH aa4058e D--B 15 20 -- Bipartite Gnm random graph
