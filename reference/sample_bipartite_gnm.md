...
#> IGRAPH ac93186 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ac93186:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a978743 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a978743:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3b4642f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3b4642f:
...
#> IGRAPH af03969 D--B 15 20 -- Bipartite Gnm random graph
