...
#> IGRAPH 32a9f91 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 32a9f91:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 04cfd98 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 04cfd98:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH db245f0 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from db245f0:
#> [1] 1--13 3--14
...
#> IGRAPH 2837f68 D--B 15 20 -- Bipartite Gnm random graph
