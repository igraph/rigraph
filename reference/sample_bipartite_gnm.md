...
#> IGRAPH f4b7071 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f4b7071:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 354c032 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 354c032:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4c20a92 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4c20a92:
...
#> IGRAPH 103355f D--B 15 20 -- Bipartite Gnm random graph
