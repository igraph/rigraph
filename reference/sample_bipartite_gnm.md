...
#> IGRAPH 1652cc1 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1652cc1:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH fb6755f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fb6755f:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b89b144 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b89b144:
#> [1] 1--13 3--14
...
#> IGRAPH 6e677af D--B 15 20 -- Bipartite Gnm random graph
