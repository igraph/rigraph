...
#> IGRAPH 3aab088 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3aab088:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0698a37 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0698a37:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9690e16 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9690e16:
#> [1] 1--13 3--14
...
#> IGRAPH 1c1dd73 D--B 15 20 -- Bipartite Gnm random graph
