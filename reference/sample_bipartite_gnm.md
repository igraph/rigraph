...
#> IGRAPH c207802 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c207802:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2e49875 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2e49875:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH c1d2508 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c1d2508:
...
#> IGRAPH 3330bb0 D--B 15 20 -- Bipartite Gnm random graph
