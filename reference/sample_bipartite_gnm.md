...
#> IGRAPH 4f4a43c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4f4a43c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 65feb47 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 65feb47:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4964c03 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4964c03:
...
#> IGRAPH 80ac3e6 D--B 15 20 -- Bipartite Gnm random graph
