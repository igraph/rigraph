...
#> IGRAPH 762dd04 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 762dd04:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH be86487 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from be86487:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 99b08ee U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 99b08ee:
#> [1] 1--13 3--14
...
#> IGRAPH cec05bc D--B 15 20 -- Bipartite Gnm random graph
