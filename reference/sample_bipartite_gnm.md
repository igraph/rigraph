...
#> IGRAPH 6551c61 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6551c61:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 10c6e4b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 10c6e4b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 6205c0a U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6205c0a:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH 9ab72a6 D--B 15 20 -- Bipartite Gnm random graph
