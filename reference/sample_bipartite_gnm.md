...
#> IGRAPH 5e2b62e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5e2b62e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 55a828b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 55a828b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b28390d U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b28390d:
#> [1] 2--11 6--11
...
#> IGRAPH 33c2882 D--B 15 20 -- Bipartite Gnm random graph
