...
#> IGRAPH a01e41f U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a01e41f:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 96ac916 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 96ac916:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ff10c70 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ff10c70:
...
#> IGRAPH e95f42e D--B 15 20 -- Bipartite Gnm random graph
