...
#> IGRAPH 03b93a4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 03b93a4:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 221ed22 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 221ed22:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH c33528e U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c33528e:
...
#> IGRAPH 8661696 D--B 15 20 -- Bipartite Gnm random graph
