...
#> IGRAPH d62369c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d62369c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9382033 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9382033:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 0efe5d6 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0efe5d6:
...
#> IGRAPH 2882cff D--B 15 20 -- Bipartite Gnm random graph
