...
#> IGRAPH 3d109bb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3d109bb:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 897b297 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 897b297:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ef5c16b U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef5c16b:
#> [1] 1--13 3--14
...
#> IGRAPH 9984b82 D--B 15 20 -- Bipartite Gnm random graph
