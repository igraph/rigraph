...
#> IGRAPH 62602cf U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 62602cf:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 1218314 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1218314:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3a6e4e3 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a6e4e3:
#> [1] 1--13 3--14
...
#> IGRAPH 612d852 D--B 15 20 -- Bipartite Gnm random graph
