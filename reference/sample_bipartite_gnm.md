...
#> IGRAPH 2278dc3 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2278dc3:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 03cb46b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 03cb46b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 640cd07 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 640cd07:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH aae4d74 D--B 15 20 -- Bipartite Gnm random graph
