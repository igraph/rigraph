...
#> IGRAPH dbcff46 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dbcff46:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8eb120a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8eb120a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a29cdda U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a29cdda:
...
#> IGRAPH 2c08ca2 D--B 15 20 -- Bipartite Gnm random graph
