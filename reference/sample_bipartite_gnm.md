...
#> IGRAPH 149c39d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 149c39d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7b16ad4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b16ad4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 62db798 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 62db798:
#> [1] 1--13 3--14
...
#> IGRAPH bec8057 D--B 15 20 -- Bipartite Gnm random graph
