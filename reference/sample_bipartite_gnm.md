...
#> IGRAPH 95eec8d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 95eec8d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 887f682 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 887f682:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f122f0b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f122f0b:
...
#> IGRAPH 9115a49 D--B 15 20 -- Bipartite Gnm random graph
