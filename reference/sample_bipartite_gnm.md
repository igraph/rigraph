...
#> IGRAPH f70aec4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f70aec4:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a7b67a1 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a7b67a1:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7fa9983 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7fa9983:
...
#> IGRAPH 13ff4e6 D--B 15 20 -- Bipartite Gnm random graph
