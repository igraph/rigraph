...
#> IGRAPH dd11cb7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dd11cb7:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e1f8228 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e1f8228:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 282f2ae U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 282f2ae:
...
#> IGRAPH 05dc518 D--B 15 20 -- Bipartite Gnm random graph
