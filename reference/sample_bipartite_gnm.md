...
#> IGRAPH d680378 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d680378:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0ea2c9a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0ea2c9a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 89f83a5 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 89f83a5:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 00f2e98 D--B 15 20 -- Bipartite Gnm random graph
