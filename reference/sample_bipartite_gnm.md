...
#> IGRAPH fd37e9d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fd37e9d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 89692e4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 89692e4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 91d88c8 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 91d88c8:
#> [1] 2--11 6--11
...
#> IGRAPH 713c9b0 D--B 15 20 -- Bipartite Gnm random graph
