...
#> IGRAPH 52343e6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 52343e6:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH fc271a6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fc271a6:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 86eafab U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 86eafab:
...
#> IGRAPH e3f57ff D--B 15 20 -- Bipartite Gnm random graph
