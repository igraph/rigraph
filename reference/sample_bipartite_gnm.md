...
#> IGRAPH 0b550f1 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0b550f1:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 4798cc6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4798cc6:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 18a1eab U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 18a1eab:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH 35f20ac D--B 15 20 -- Bipartite Gnm random graph
