...
#> IGRAPH 5107432 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5107432:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f002569 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f002569:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 734155f U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 734155f:
#> [1] 1--13 3--14
...
#> IGRAPH a193757 D--B 15 20 -- Bipartite Gnm random graph
