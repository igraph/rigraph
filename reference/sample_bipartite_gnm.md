...
#> IGRAPH 10eb88e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 10eb88e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c5927b3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c5927b3:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3df8e68 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3df8e68:
...
#> IGRAPH fde8baf D--B 15 20 -- Bipartite Gnm random graph
