...
#> IGRAPH 6237452 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6237452:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 40c7b09 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 40c7b09:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH e90a995 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e90a995:
...
#> IGRAPH ac8ccc1 D--B 15 20 -- Bipartite Gnm random graph
