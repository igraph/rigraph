...
#> IGRAPH 12eb583 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 12eb583:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e28d49b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e28d49b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 92a901f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 92a901f:
...
#> IGRAPH f585358 D--B 15 20 -- Bipartite Gnm random graph
