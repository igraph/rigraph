...
#> IGRAPH 925b0e2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 925b0e2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 85302dd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 85302dd:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 1a2c075 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1a2c075:
...
#> IGRAPH 64974ba D--B 15 20 -- Bipartite Gnm random graph
