...
#> IGRAPH 1ed9fbc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1ed9fbc:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0e0f605 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0e0f605:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 57f999c U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 57f999c:
...
#> IGRAPH b0522ac D--B 15 20 -- Bipartite Gnm random graph
