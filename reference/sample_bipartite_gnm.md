...
#> IGRAPH f44fe90 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f44fe90:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 760931d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 760931d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 121fb6a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 121fb6a:
...
#> IGRAPH 58a1cbe D--B 15 20 -- Bipartite Gnm random graph
