...
#> IGRAPH d1aa339 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d1aa339:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8bcd093 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8bcd093:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 63da256 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 63da256:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH fcd4625 D--B 15 20 -- Bipartite Gnm random graph
