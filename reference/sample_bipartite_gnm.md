...
#> IGRAPH 59b1247 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 59b1247:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ced8f10 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ced8f10:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH db1b07e U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from db1b07e:
#> [1] 1--13 3--14
...
#> IGRAPH dc6bdab D--B 15 20 -- Bipartite Gnm random graph
