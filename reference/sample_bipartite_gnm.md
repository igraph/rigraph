...
#> IGRAPH 6edf792 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6edf792:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 397031f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 397031f:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH aa84aa1 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aa84aa1:
...
#> IGRAPH 04fb7d2 D--B 15 20 -- Bipartite Gnm random graph
