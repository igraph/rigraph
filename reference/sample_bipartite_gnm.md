...
#> IGRAPH 630935a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 630935a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 75b913e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 75b913e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4062677 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4062677:
...
#> IGRAPH 2f849d9 D--B 15 20 -- Bipartite Gnm random graph
