...
#> IGRAPH 1ad606d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1ad606d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH aedf947 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aedf947:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b0c7469 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b0c7469:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH 9596e47 D--B 15 20 -- Bipartite Gnm random graph
