...
#> IGRAPH 409c0b4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 409c0b4:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 74024b0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 74024b0:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 358d1d1 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 358d1d1:
...
#> IGRAPH 8285957 D--B 15 20 -- Bipartite Gnm random graph
