...
#> IGRAPH 1993e81 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1993e81:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH d8dd1b4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d8dd1b4:
...
#> IGRAPH d17137a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d17137a:
...
#> IGRAPH 8c73f1f D--B 15 20 -- Bipartite Gnm random graph
