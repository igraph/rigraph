...
#> IGRAPH b23dc74 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b23dc74:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2975eef U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2975eef:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH bd24770 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bd24770:
...
#> IGRAPH 23580e8 D--B 15 20 -- Bipartite Gnm random graph
