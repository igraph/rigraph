...
#> IGRAPH be45274 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from be45274:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 755fb78 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 755fb78:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH e2b7779 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e2b7779:
...
#> IGRAPH 748d74c D--B 15 20 -- Bipartite Gnm random graph
