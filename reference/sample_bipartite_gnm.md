...
#> IGRAPH d1fee20 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d1fee20:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH fcf39a5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fcf39a5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 709fffc U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 709fffc:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 5c83753 D--B 15 20 -- Bipartite Gnm random graph
