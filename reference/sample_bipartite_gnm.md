...
#> IGRAPH 14b2dce U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 14b2dce:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 59ea5e5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 59ea5e5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3c6f4cc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3c6f4cc:
...
#> IGRAPH 9a930f6 D--B 15 20 -- Bipartite Gnm random graph
