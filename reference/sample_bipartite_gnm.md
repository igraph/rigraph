...
#> IGRAPH 7b4946c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b4946c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 1a1c971 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1a1c971:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f5f137f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f5f137f:
...
#> IGRAPH 2fdbd4a D--B 15 20 -- Bipartite Gnm random graph
