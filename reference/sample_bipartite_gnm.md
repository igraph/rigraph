...
#> IGRAPH 5a8795d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5a8795d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ab9228c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ab9228c:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f305c58 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f305c58:
#> [1] 1--13 3--14
...
#> IGRAPH 1155810 D--B 15 20 -- Bipartite Gnm random graph
