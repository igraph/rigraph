...
#> IGRAPH 6edcc33 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6edcc33:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f99080f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f99080f:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 42cd9fd U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 42cd9fd:
#> [1] 2--11 6--11
...
#> IGRAPH 25ae5c6 D--B 15 20 -- Bipartite Gnm random graph
