...
#> IGRAPH 44d4b8a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 44d4b8a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH bda69d2 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bda69d2:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b7d7979 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b7d7979:
...
#> IGRAPH 47a6eb6 D--B 15 20 -- Bipartite Gnm random graph
