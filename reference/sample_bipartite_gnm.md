...
#> IGRAPH 2a84330 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2a84330:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH eac4dc7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eac4dc7:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a81e1a2 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a81e1a2:
...
#> IGRAPH e8c189c D--B 15 20 -- Bipartite Gnm random graph
