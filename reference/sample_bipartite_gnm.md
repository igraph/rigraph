...
#> IGRAPH 03f5479 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 03f5479:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a36337c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a36337c:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b77bf53 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b77bf53:
...
#> IGRAPH bdcfb0a D--B 15 20 -- Bipartite Gnm random graph
