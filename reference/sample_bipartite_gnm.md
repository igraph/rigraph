...
#> IGRAPH 06b9f1a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 06b9f1a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0800089 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0800089:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a96a80c U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a96a80c:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 9542b30 D--B 15 20 -- Bipartite Gnm random graph
