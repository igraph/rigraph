...
#> IGRAPH 0308460 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0308460:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f82fe51 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f82fe51:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f74cace U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f74cace:
...
#> IGRAPH 8055146 D--B 15 20 -- Bipartite Gnm random graph
