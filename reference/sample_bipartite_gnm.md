...
#> IGRAPH cfc62d0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cfc62d0:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH bc873bd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bc873bd:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fa1973f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fa1973f:
...
#> IGRAPH 29dd8ba D--B 15 20 -- Bipartite Gnm random graph
