...
#> IGRAPH 16f2a3b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 16f2a3b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a68d8f6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a68d8f6:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a09d76d U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a09d76d:
...
#> IGRAPH a1eaaa1 D--B 15 20 -- Bipartite Gnm random graph
