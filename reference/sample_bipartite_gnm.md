...
#> IGRAPH 1f3fa4c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1f3fa4c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0b4998d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0b4998d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 059aa40 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 059aa40:
...
#> IGRAPH a216cc5 D--B 15 20 -- Bipartite Gnm random graph
