...
#> IGRAPH d6a6845 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d6a6845:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0b863ac U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0b863ac:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4334b6b U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4334b6b:
#> [1] 1--13 3--14
...
#> IGRAPH 26e65ab D--B 15 20 -- Bipartite Gnm random graph
