...
#> IGRAPH 9d2a53e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9d2a53e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 1d5c9f4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1d5c9f4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 38d3039 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 38d3039:
...
#> IGRAPH 928af8d D--B 15 20 -- Bipartite Gnm random graph
