...
#> IGRAPH afd667f U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from afd667f:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a5ce4d3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a5ce4d3:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 46b1f54 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 46b1f54:
#> [1] 1--13 3--14
...
#> IGRAPH 4e9b5d9 D--B 15 20 -- Bipartite Gnm random graph
