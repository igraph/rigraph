...
#> IGRAPH beb3450 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from beb3450:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH cb1dca4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb1dca4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH e828b14 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e828b14:
...
#> IGRAPH f7fbf77 D--B 15 20 -- Bipartite Gnm random graph
