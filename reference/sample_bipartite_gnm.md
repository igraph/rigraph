...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 7ee185f ──
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 756fba0 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 5d12ba5 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnm random graph ────────────────────────────── d53348f ──
