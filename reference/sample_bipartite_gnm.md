...
#> IGRAPH daed46c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from daed46c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8d4bc36 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8d4bc36:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 67f017c U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 67f017c:
#> [1] 1--13 3--14
...
#> IGRAPH 577e56a D--B 15 20 -- Bipartite Gnm random graph
