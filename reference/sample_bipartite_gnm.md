...
#> IGRAPH 189f387 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 189f387:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 0f50227 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0f50227:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 495eb3d U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 495eb3d:
...
#> IGRAPH 30174a7 D--B 15 20 -- Bipartite Gnm random graph
