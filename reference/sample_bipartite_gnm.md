...
#> IGRAPH 6e0be78 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6e0be78:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e55d47e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e55d47e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3e0142e U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3e0142e:
...
#> IGRAPH 21def6c D--B 15 20 -- Bipartite Gnm random graph
