...
#> IGRAPH 423f4b2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 423f4b2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 019b851 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 019b851:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 185f07f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 185f07f:
...
#> IGRAPH 1ca4d29 D--B 15 20 -- Bipartite Gnm random graph
