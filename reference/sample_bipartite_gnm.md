...
#> IGRAPH 05d1c08 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 05d1c08:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f7c8e7b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f7c8e7b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2a9a5ea U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2a9a5ea:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH 5cb1d4e D--B 15 20 -- Bipartite Gnm random graph
