...
#> IGRAPH 580788e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 580788e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 34f932b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 34f932b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3c9571d U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3c9571d:
...
#> IGRAPH edaf3a8 D--B 15 20 -- Bipartite Gnm random graph
