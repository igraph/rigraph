...
#> IGRAPH 3a06961 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a06961:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ab710b7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ab710b7:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ef2e675 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef2e675:
...
#> IGRAPH 6d2261f D--B 15 20 -- Bipartite Gnm random graph
