...
#> IGRAPH 763eafb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 763eafb:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c5e4963 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c5e4963:
...
#> IGRAPH ec73324 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ec73324:
...
#> IGRAPH 09dad24 D--B 15 20 -- Bipartite Gnm random graph
