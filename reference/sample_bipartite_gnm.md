...
#> IGRAPH a053127 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a053127:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9a5b6c5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9a5b6c5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 23c586f U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 23c586f:
#> [1] 1--13 3--14
...
#> IGRAPH d3adece D--B 15 20 -- Bipartite Gnm random graph
