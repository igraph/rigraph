...
#> IGRAPH 87cdc56 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 87cdc56:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH aa4bdff U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aa4bdff:
...
#> IGRAPH f330100 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f330100:
...
#> IGRAPH 055a775 D--B 15 20 -- Bipartite Gnm random graph
