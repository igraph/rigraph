...
#> IGRAPH bfc4863 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bfc4863:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 566b1e4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 566b1e4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 61cf805 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 61cf805:
...
#> IGRAPH 882d493 D--B 15 20 -- Bipartite Gnm random graph
