...
#> IGRAPH 81d6e2d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 81d6e2d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ad3b424 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ad3b424:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 94edb9a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 94edb9a:
...
#> IGRAPH 3818f15 D--B 15 20 -- Bipartite Gnm random graph
