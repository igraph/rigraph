...
#> IGRAPH e139762 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e139762:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e5e1cfb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e5e1cfb:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b989d1b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b989d1b:
...
#> IGRAPH a1a815a D--B 15 20 -- Bipartite Gnm random graph
