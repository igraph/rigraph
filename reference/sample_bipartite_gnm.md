...
#> IGRAPH e359c83 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e359c83:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ab88c91 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ab88c91:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f0dead6 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f0dead6:
...
#> IGRAPH 1869f20 D--B 15 20 -- Bipartite Gnm random graph
