...
#> IGRAPH d63968c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d63968c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a021d04 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a021d04:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fc53e4a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fc53e4a:
...
#> IGRAPH fabc4b5 D--B 15 20 -- Bipartite Gnm random graph
