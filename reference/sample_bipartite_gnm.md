...
#> IGRAPH 19744ec U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 19744ec:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f4a9898 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f4a9898:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 771e272 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 771e272:
...
#> IGRAPH dd797b9 D--B 15 20 -- Bipartite Gnm random graph
