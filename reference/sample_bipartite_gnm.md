...
#> IGRAPH e290b76 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e290b76:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e94450d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e94450d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 52e6f55 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 52e6f55:
#> [1] 1--13 3--14
...
#> IGRAPH 2792326 D--B 15 20 -- Bipartite Gnm random graph
