...
#> IGRAPH 05475e6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 05475e6:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5e5007e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5e5007e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8a3c3a7 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8a3c3a7:
...
#> IGRAPH 397e6fc D--B 15 20 -- Bipartite Gnm random graph
