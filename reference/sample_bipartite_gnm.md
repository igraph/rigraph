...
#> IGRAPH f74d29c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f74d29c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7855358 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7855358:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ca7e2c0 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ca7e2c0:
...
#> IGRAPH 35fccbf D--B 15 20 -- Bipartite Gnm random graph
