...
#> IGRAPH c4f6774 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c4f6774:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 908272d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 908272d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 6a2a4c1 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6a2a4c1:
...
#> IGRAPH 441ba52 D--B 15 20 -- Bipartite Gnm random graph
