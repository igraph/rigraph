...
#> IGRAPH b6bd7c5 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b6bd7c5:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 792093c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 792093c:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b9ef351 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b9ef351:
#> [1] 1--13 3--14
...
#> IGRAPH 046c044 D--B 15 20 -- Bipartite Gnm random graph
