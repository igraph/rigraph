...
#> IGRAPH f8f6c0b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f8f6c0b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5e5f332 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5e5f332:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f5e9fa0 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f5e9fa0:
...
#> IGRAPH 1c82e2b D--B 15 20 -- Bipartite Gnm random graph
