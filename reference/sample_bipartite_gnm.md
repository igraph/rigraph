...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── a47282f ──
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── bcbbfc8 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── e085157 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnm random graph ────────────────────────────── d43bcae ──
