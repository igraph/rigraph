...
#> IGRAPH 2ca81b2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2ca81b2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 34104ca U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 34104ca:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 88cf2bc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 88cf2bc:
...
#> IGRAPH 14292ab D--B 15 20 -- Bipartite Gnm random graph
