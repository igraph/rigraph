...
#> IGRAPH 3ba0185 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3ba0185:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH fae97ce U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fae97ce:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8abc973 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8abc973:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 526c399 D--B 15 20 -- Bipartite Gnm random graph
