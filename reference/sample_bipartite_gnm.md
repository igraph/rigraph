...
#> IGRAPH 697827a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 697827a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c5e0463 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c5e0463:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH c4f8024 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c4f8024:
#> [1] 1--13 3--14
...
#> IGRAPH 3750e3d D--B 15 20 -- Bipartite Gnm random graph
