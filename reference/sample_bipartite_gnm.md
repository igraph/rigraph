...
#> IGRAPH eaa21ef U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eaa21ef:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8715a80 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8715a80:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 82c0a48 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 82c0a48:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH a8ace35 D--B 15 20 -- Bipartite Gnm random graph
