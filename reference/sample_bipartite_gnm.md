...
#> IGRAPH 24e486b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 24e486b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 786639e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 786639e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 65630bc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 65630bc:
...
#> IGRAPH 606b08a D--B 15 20 -- Bipartite Gnm random graph
