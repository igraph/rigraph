...
#> IGRAPH 53f3f3f U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 53f3f3f:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9399fad U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9399fad:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 0369978 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0369978:
...
#> IGRAPH 8756f5d D--B 15 20 -- Bipartite Gnm random graph
