...
#> IGRAPH ba440ca U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ba440ca:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e7adb3a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e7adb3a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH aa93386 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aa93386:
...
#> IGRAPH d2acfe5 D--B 15 20 -- Bipartite Gnm random graph
