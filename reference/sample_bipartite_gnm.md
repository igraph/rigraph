...
#> IGRAPH 16c3df2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 16c3df2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f8e57a0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f8e57a0:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8d76f1f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8d76f1f:
...
#> IGRAPH 400492a D--B 15 20 -- Bipartite Gnm random graph
