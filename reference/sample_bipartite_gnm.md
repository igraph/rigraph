...
#> IGRAPH 9fbe73e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9fbe73e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c5ebfba U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c5ebfba:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH cc39725 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cc39725:
...
#> IGRAPH 8856184 D--B 15 20 -- Bipartite Gnm random graph
