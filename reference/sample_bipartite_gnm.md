...
#> IGRAPH 96200af U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 96200af:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 41026b2 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 41026b2:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8f05306 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8f05306:
...
#> IGRAPH fc25429 D--B 15 20 -- Bipartite Gnm random graph
