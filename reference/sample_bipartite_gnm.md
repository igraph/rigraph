...
#> IGRAPH ef936b9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef936b9:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH d8f49c4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d8f49c4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH c7778da U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c7778da:
#> [1] 2--11 6--11
...
#> IGRAPH ae0c565 D--B 15 20 -- Bipartite Gnm random graph
