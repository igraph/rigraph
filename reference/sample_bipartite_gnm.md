...
#> IGRAPH e62a130 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e62a130:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ff81af4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ff81af4:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 80ebac5 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 80ebac5:
...
#> IGRAPH 47b7282 D--B 15 20 -- Bipartite Gnm random graph
