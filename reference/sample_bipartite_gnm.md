...
#> IGRAPH 194bcc6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 194bcc6:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e25d9ff U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e25d9ff:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b548898 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b548898:
#> [1] 1--13 3--14
...
#> IGRAPH d4f4144 D--B 15 20 -- Bipartite Gnm random graph
