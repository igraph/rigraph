...
#> IGRAPH 843177d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 843177d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2528b9e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2528b9e:
...
#> IGRAPH 89e9dda U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 89e9dda:
...
#> IGRAPH 0e42973 D--B 15 20 -- Bipartite Gnm random graph
