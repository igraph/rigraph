...
#> IGRAPH 00a2542 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 00a2542:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7e3f371 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7e3f371:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 485cd1b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 485cd1b:
...
#> IGRAPH f8c44ad D--B 15 20 -- Bipartite Gnm random graph
