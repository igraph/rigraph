...
#> IGRAPH 7cd2f91 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7cd2f91:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 888966b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 888966b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4244013 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4244013:
...
#> IGRAPH e275076 D--B 15 20 -- Bipartite Gnm random graph
