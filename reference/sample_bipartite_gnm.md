...
#> IGRAPH a7b3a81 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a7b3a81:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 6533aed U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6533aed:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH dcf1cda U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dcf1cda:
...
#> IGRAPH 640a248 D--B 15 20 -- Bipartite Gnm random graph
