...
#> IGRAPH 465d925 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 465d925:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 98d2d08 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 98d2d08:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fe037a2 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fe037a2:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH d5c71b0 D--B 15 20 -- Bipartite Gnm random graph
