...
#> IGRAPH b51de6e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b51de6e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8828c76 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8828c76:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH abed8cb U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from abed8cb:
...
#> IGRAPH dd3988b D--B 15 20 -- Bipartite Gnm random graph
