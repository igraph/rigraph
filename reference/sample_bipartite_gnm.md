...
#> IGRAPH cfc397c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cfc397c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a8d948e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a8d948e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7976334 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7976334:
...
#> IGRAPH 08323e5 D--B 15 20 -- Bipartite Gnm random graph
