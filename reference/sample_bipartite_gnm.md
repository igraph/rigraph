...
#> IGRAPH 845e88d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 845e88d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 63e8b10 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 63e8b10:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4780c63 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4780c63:
...
#> IGRAPH 0f40a97 D--B 15 20 -- Bipartite Gnm random graph
