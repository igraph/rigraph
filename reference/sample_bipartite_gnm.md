...
#> IGRAPH 5f7d28a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5f7d28a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c63aeb5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c63aeb5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH d7bf091 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d7bf091:
#> [1] 2--11 6--11
...
#> IGRAPH 7564c62 D--B 15 20 -- Bipartite Gnm random graph
