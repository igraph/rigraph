...
#> IGRAPH 2ec7c35 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2ec7c35:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e2c87d3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e2c87d3:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9845af3 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9845af3:
...
#> IGRAPH 06d94f4 D--B 15 20 -- Bipartite Gnm random graph
