...
#> IGRAPH a39cfd0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a39cfd0:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 6dae8b8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6dae8b8:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 827f7b4 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 827f7b4:
#> [1] 1--13 3--14
...
#> IGRAPH e21f385 D--B 15 20 -- Bipartite Gnm random graph
