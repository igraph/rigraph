...
#> IGRAPH 2308cf6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2308cf6:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9dd5c95 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9dd5c95:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH eede07d U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eede07d:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 8b34188 D--B 15 20 -- Bipartite Gnm random graph
