...
#> IGRAPH b9a4a75 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b9a4a75:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e830bb9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e830bb9:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3d2651d U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3d2651d:
#> [1]  2--11 10--12  9--15
...
#> IGRAPH 8b785c9 D--B 15 20 -- Bipartite Gnm random graph
