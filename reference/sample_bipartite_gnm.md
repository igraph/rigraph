...
#> IGRAPH fa8642d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fa8642d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 6776c5f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6776c5f:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8919f3a U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8919f3a:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 14cd704 D--B 15 20 -- Bipartite Gnm random graph
