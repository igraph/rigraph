...
#> IGRAPH 094b3cf U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 094b3cf:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH db90471 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from db90471:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b6eafb0 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b6eafb0:
#> [1] 1--13 3--14
...
#> IGRAPH bf6410c D--B 15 20 -- Bipartite Gnm random graph
