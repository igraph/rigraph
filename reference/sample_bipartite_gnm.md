...
#> IGRAPH a390370 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a390370:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 4f33fcb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4f33fcb:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 609d794 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 609d794:
#> [1] 1--13 3--14
...
#> IGRAPH 6cb5b64 D--B 15 20 -- Bipartite Gnm random graph
