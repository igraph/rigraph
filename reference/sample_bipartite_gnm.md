...
#> IGRAPH 59c903d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 59c903d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5cc1682 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5cc1682:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 76cb892 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 76cb892:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH e3d571f D--B 15 20 -- Bipartite Gnm random graph
