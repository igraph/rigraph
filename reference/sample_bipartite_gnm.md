...
#> IGRAPH 889398c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 889398c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH b181d20 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b181d20:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2a4cf1a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2a4cf1a:
...
#> IGRAPH 9da3e42 D--B 15 20 -- Bipartite Gnm random graph
