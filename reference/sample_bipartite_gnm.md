...
#> IGRAPH 2300a8b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2300a8b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ddf7003 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ddf7003:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7a3845e U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7a3845e:
...
#> IGRAPH 661a0f1 D--B 15 20 -- Bipartite Gnm random graph
