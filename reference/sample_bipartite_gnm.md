...
#> IGRAPH 44be73a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 44be73a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9f37458 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f37458:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3cf206b U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3cf206b:
#> [1] 2--11 6--11
...
#> IGRAPH a04f1bd D--B 15 20 -- Bipartite Gnm random graph
