...
#> IGRAPH d6db410 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d6db410:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c7debca U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c7debca:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9e0f05f U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9e0f05f:
#> [1] 1--13 3--14
...
#> IGRAPH 998fcf1 D--B 15 20 -- Bipartite Gnm random graph
