...
#> IGRAPH 2f9cfe6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2f9cfe6:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 4951a8e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4951a8e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 44ee74e U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 44ee74e:
#> [1] 1--13 3--14
...
#> IGRAPH a637c4b D--B 15 20 -- Bipartite Gnm random graph
