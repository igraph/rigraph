...
#> IGRAPH ce21adf U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ce21adf:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 703066d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 703066d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 3aebb26 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3aebb26:
...
#> IGRAPH 3b169c2 D--B 15 20 -- Bipartite Gnm random graph
