...
#> IGRAPH c56cfd3 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c56cfd3:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 743a934 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 743a934:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 381fcd7 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 381fcd7:
...
#> IGRAPH 95d4198 D--B 15 20 -- Bipartite Gnm random graph
