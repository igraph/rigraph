...
#> IGRAPH 8fa0d81 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8fa0d81:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 67eb4eb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 67eb4eb:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 987cc7b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 987cc7b:
...
#> IGRAPH 38848c7 D--B 15 20 -- Bipartite Gnm random graph
