...
#> IGRAPH ac69fee U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ac69fee:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 3b45b80 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3b45b80:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 316e560 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 316e560:
...
#> IGRAPH d2210c6 D--B 15 20 -- Bipartite Gnm random graph
