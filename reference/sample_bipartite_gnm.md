...
#> IGRAPH 4b07845 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4b07845:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7b8b261 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b8b261:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b72dc30 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b72dc30:
#> [1] 1--13 3--14
...
#> IGRAPH bd20fe0 D--B 15 20 -- Bipartite Gnm random graph
