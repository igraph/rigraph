...
#> IGRAPH baa53ff U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from baa53ff:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e8f7c1a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e8f7c1a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2cee4af U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2cee4af:
...
#> IGRAPH c944551 D--B 15 20 -- Bipartite Gnm random graph
