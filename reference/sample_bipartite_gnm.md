...
#> IGRAPH ec94145 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ec94145:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8805509 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8805509:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ea2f58b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ea2f58b:
...
#> IGRAPH be1c873 D--B 15 20 -- Bipartite Gnm random graph
