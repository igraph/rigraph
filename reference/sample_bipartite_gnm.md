...
#> IGRAPH eb6009b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eb6009b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH d37e439 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d37e439:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH bb459b7 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bb459b7:
...
#> IGRAPH eeb44b4 D--B 15 20 -- Bipartite Gnm random graph
