...
#> IGRAPH d2d7bdf U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d2d7bdf:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 177ba4b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 177ba4b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b3fdcee U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b3fdcee:
...
#> IGRAPH 8b9cc30 D--B 15 20 -- Bipartite Gnm random graph
