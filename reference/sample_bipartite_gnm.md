...
#> IGRAPH 2687a65 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2687a65:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH dadc6d5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dadc6d5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9f1a20b U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f1a20b:
#> [1] 1--13 3--14
...
#> IGRAPH 206912d D--B 15 20 -- Bipartite Gnm random graph
