...
#> IGRAPH b8dfe9e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b8dfe9e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c5d3b8d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c5d3b8d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9db1c87 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9db1c87:
#> [1] 1--13 3--14
...
#> IGRAPH c032774 D--B 15 20 -- Bipartite Gnm random graph
