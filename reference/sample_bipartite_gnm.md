...
#> IGRAPH 00235a7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 00235a7:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8bdbaec U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8bdbaec:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 63e2328 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 63e2328:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH e6c5b96 D--B 15 20 -- Bipartite Gnm random graph
