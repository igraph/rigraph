...
#> IGRAPH 31be0ff U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 31be0ff:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8d027de U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8d027de:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 5ff362b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5ff362b:
...
#> IGRAPH 9f37f25 D--B 15 20 -- Bipartite Gnm random graph
