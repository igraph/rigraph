...
#> IGRAPH 373d692 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 373d692:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2a9e2b2 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2a9e2b2:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 39cef0c U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 39cef0c:
...
#> IGRAPH c6bf15c D--B 15 20 -- Bipartite Gnm random graph
