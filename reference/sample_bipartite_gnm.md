...
#> IGRAPH 0cf4d09 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0cf4d09:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9bb3116 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9bb3116:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ae1bda6 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ae1bda6:
#> [1] 1--13 3--14
...
#> IGRAPH e0226e5 D--B 15 20 -- Bipartite Gnm random graph
