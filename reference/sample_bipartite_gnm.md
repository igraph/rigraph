...
#> IGRAPH 3ff9120 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3ff9120:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 533f218 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 533f218:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 1ae74d2 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1ae74d2:
...
#> IGRAPH 982b3d7 D--B 15 20 -- Bipartite Gnm random graph
