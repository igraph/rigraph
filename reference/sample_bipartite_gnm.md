...
#> IGRAPH 7b5ff8d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b5ff8d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 2940934 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2940934:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7ea6738 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7ea6738:
...
#> IGRAPH 299ccc7 D--B 15 20 -- Bipartite Gnm random graph
