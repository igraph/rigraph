...
#> IGRAPH f7b18b2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f7b18b2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 844ec92 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 844ec92:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 10985ce U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 10985ce:
...
#> IGRAPH 4d385be D--B 15 20 -- Bipartite Gnm random graph
