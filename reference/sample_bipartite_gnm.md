...
#> IGRAPH 40a73dc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 40a73dc:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c319860 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c319860:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7d109f6 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7d109f6:
...
#> IGRAPH 3d3be21 D--B 15 20 -- Bipartite Gnm random graph
