...
#> IGRAPH 3982518 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3982518:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH a6c0531 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a6c0531:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8684057 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8684057:
...
#> IGRAPH 0ba49d5 D--B 15 20 -- Bipartite Gnm random graph
