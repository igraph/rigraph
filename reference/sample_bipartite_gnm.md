...
#> IGRAPH fee0a0d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fee0a0d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9105705 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9105705:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 09eb7b2 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 09eb7b2:
...
#> IGRAPH 36d4b92 D--B 15 20 -- Bipartite Gnm random graph
