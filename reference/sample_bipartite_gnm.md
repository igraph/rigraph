...
#> IGRAPH 7152d3d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7152d3d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ea2e4c0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ea2e4c0:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9f4fc86 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f4fc86:
...
#> IGRAPH db075a8 D--B 15 20 -- Bipartite Gnm random graph
