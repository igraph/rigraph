...
#> IGRAPH aa558d4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aa558d4:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8fcf3ba U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8fcf3ba:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b13cb66 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b13cb66:
...
#> IGRAPH 4530047 D--B 15 20 -- Bipartite Gnm random graph
