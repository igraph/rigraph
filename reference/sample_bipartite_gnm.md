...
#> IGRAPH 61d8209 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 61d8209:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8970445 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8970445:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fcd7e1e U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fcd7e1e:
...
#> IGRAPH 8ce3c4a D--B 15 20 -- Bipartite Gnm random graph
