...
#> IGRAPH 553e834 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 553e834:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH fa81ba7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fa81ba7:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 82107f5 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 82107f5:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH 1f38f16 D--B 15 20 -- Bipartite Gnm random graph
