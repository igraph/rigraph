...
#> IGRAPH 162c886 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 162c886:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH cd3468d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cd3468d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 22602f3 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 22602f3:
#> [1] 2--11 3--11 3--12
...
#> IGRAPH cd8e8d7 D--B 15 20 -- Bipartite Gnm random graph
