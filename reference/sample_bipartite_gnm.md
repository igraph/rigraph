...
#> IGRAPH 850f059 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 850f059:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9d270c5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9d270c5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 316daf7 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 316daf7:
...
#> IGRAPH 6fc6925 D--B 15 20 -- Bipartite Gnm random graph
