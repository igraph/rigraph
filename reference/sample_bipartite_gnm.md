...
#> IGRAPH 1341568 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1341568:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH d903f3d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d903f3d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a39a123 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a39a123:
...
#> IGRAPH 0040649 D--B 15 20 -- Bipartite Gnm random graph
