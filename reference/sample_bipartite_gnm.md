...
#> IGRAPH c2cce47 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c2cce47:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH cf264bf U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cf264bf:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 1fa1667 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1fa1667:
...
#> IGRAPH 5ef99eb D--B 15 20 -- Bipartite Gnm random graph
