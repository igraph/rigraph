...
#> IGRAPH dda7e94 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dda7e94:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 90d832d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 90d832d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 1ffb0e1 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1ffb0e1:
#> [1] 1--13 3--14
...
#> IGRAPH a1e0345 D--B 15 20 -- Bipartite Gnm random graph
