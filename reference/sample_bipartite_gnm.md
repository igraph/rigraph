...
#> IGRAPH ca8396e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ca8396e:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH feb488e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from feb488e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7c4f4a8 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7c4f4a8:
...
#> IGRAPH 0193dff D--B 15 20 -- Bipartite Gnm random graph
