...
#> IGRAPH 532947c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 532947c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f4d806d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f4d806d:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2f5c124 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2f5c124:
#> [1] 1--13 3--14
...
#> IGRAPH 8b28ef4 D--B 15 20 -- Bipartite Gnm random graph
