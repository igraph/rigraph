...
#> IGRAPH 38a2b13 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 38a2b13:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 98a8f1f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 98a8f1f:
...
#> IGRAPH cf14518 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cf14518:
...
#> IGRAPH b83f4e6 D--B 15 20 -- Bipartite Gnm random graph
