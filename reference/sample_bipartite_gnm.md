...
#> IGRAPH 0bb742c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0bb742c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 524d307 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 524d307:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH e48eac0 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e48eac0:
...
#> IGRAPH f10f4aa D--B 15 20 -- Bipartite Gnm random graph
