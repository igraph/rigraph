...
#> IGRAPH 077097c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 077097c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 22e9d44 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 22e9d44:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 176fde4 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 176fde4:
...
#> IGRAPH 47fccbb D--B 15 20 -- Bipartite Gnm random graph
