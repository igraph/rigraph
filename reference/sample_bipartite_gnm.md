...
#> IGRAPH b4758ee U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b4758ee:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 35fed69 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 35fed69:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 93bc538 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 93bc538:
#> [1] 1--13 3--14
...
#> IGRAPH 18e2ac1 D--B 15 20 -- Bipartite Gnm random graph
