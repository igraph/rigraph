...
#> IGRAPH bc7507b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bc7507b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH dcb330c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dcb330c:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 40a8750 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 40a8750:
...
#> IGRAPH 412df7b D--B 15 20 -- Bipartite Gnm random graph
