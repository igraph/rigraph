...
#> IGRAPH bf0ffa9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bf0ffa9:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH b0686c8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b0686c8:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH d62fcfd U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d62fcfd:
...
#> IGRAPH 933b2e2 D--B 15 20 -- Bipartite Gnm random graph
