...
#> IGRAPH 0350854 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0350854:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9f6bc25 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f6bc25:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 870bf06 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 870bf06:
...
#> IGRAPH 3072bc6 D--B 15 20 -- Bipartite Gnm random graph
