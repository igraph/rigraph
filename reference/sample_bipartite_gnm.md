...
#> IGRAPH cd5b35b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cd5b35b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 3791c90 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3791c90:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 881beae U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 881beae:
...
#> IGRAPH 3b1750c D--B 15 20 -- Bipartite Gnm random graph
