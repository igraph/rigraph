...
#> IGRAPH 9790db0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9790db0:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 360ff3c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 360ff3c:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 7242746 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7242746:
#> [1] 1--13 3--14
...
#> IGRAPH 3b8b4a6 D--B 15 20 -- Bipartite Gnm random graph
