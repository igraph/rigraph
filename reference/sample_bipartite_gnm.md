...
#> IGRAPH 4e2860f U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4e2860f:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH dab3c35 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dab3c35:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH bde5968 U--B 15 2 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bde5968:
#> [1] 2--11 6--11
...
#> IGRAPH a53f9f8 D--B 15 20 -- Bipartite Gnm random graph
