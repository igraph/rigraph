...
`graph.automorphisms()` was renamed to
...
[[`count_automorphisms()`](https://r.igraph.org/reference/count_automorphisms.md)](https://igraph.org/c/html/latest/igraph-Isomorphism.html#igraph_count_automorphisms),
