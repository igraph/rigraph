...
#> $vertices
#> $vertices[[1]]
#> ── <vertex sequence> 3/6 · named · from dddafa0 ────────────────────────────────
#> [1] A B C
#> 
#> $vertices[[2]]
#> ── <vertex sequence> 2/6 · named · from dddafa0 ────────────────────────────────
#> [1] A F
#> 
#> $vertices[[3]]
#> ── <vertex sequence> 1/6 · named · from dddafa0 ────────────────────────────────
#> [1] E
#> 
#> 
#> $edges
#> $edges[[1]]
#> ── <edge sequence> 3/9 · vertex names · from dddafa0 ───────────────────────────
#> [1] A → B  B → C  C → A 
#> 
#> $edges[[2]]
#> ── <edge sequence> 2/9 · vertex names · from dddafa0 ───────────────────────────
#> [1] A → F  F → A 
#> 
#> $edges[[3]]
#> ── <edge sequence> 1/9 · vertex names · from dddafa0 ───────────────────────────
#> [1] E → E 
#> 
#> 
...
#> 
#> $vertices[[2]]
#> ── <vertex sequence> 4/6 · named · from dddafa0 ────────────────────────────────
#> [1] A D E F
#> 
#> $vertices[[3]]
#> ── <vertex sequence> 4/6 · named · from dddafa0 ────────────────────────────────
...
#> 
#> $edges[[2]]
#> ── <edge sequence> 4/9 · vertex names · from dddafa0 ───────────────────────────
#> [1] A → D  D → E  F → E  F → A 
#> 
#> $edges[[3]]
#> ── <edge sequence> 4/9 · vertex names · from dddafa0 ───────────────────────────
