...
[`is_matching()`](https://igraph.org/c/html/latest/igraph-Structural.html#igraph_is_matching),
...
#> | [5]    e FALSE
#> | [6]    f  TRUE
#> + edges from 1a41afd (vertex names):
...
#> | [6]    f  TRUE
#> | [7]    g FALSE
#> + edges from 52650c2 (vertex names):
