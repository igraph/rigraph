...
#> $cuts
#> $cuts[[1]]
#> ── <edge sequence> 2/14 · vertex names · from ac5fb91 ──────────────────────────
#> [1] s → a  s → b 
#> 
#> $cuts[[2]]
#> ── <edge sequence> 2/14 · vertex names · from ac5fb91 ──────────────────────────
...
#> $partition1s
#> $partition1s[[1]]
#> ── <vertex sequence> 1/9 · named · from ac5fb91 ────────────────────────────────
#> [1] s
#> 
#> $partition1s[[2]]
#> ── <vertex sequence> 2/9 · named · from ac5fb91 ────────────────────────────────
#> [1] s b
#> 
#> $partition1s[[3]]
#> ── <vertex sequence> 8/9 · named · from ac5fb91 ────────────────────────────────
#> [1] s b a 5 4 3 2 1
#> 
#> 
```
