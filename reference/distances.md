...
#> $vpath
#> $vpath[[1]]
#> ── <vertex sequence> 5/10 · from 6de9d67 ───────────────────────────────────────
#> [1] 5 4 3 2 1
#> 
#> $vpath[[2]]
#> ── <vertex sequence> 4/10 · from 6de9d67 ───────────────────────────────────────
#> [1] 5 4 3 2
#> 
#> $vpath[[3]]
#> ── <vertex sequence> 3/10 · from 6de9d67 ───────────────────────────────────────
#> [1] 5 4 3
#> 
#> $vpath[[4]]
#> ── <vertex sequence> 2/10 · from 6de9d67 ───────────────────────────────────────
#> [1] 5 4
#> 
#> $vpath[[5]]
#> ── <vertex sequence> 1/10 · from 6de9d67 ───────────────────────────────────────
#> [1] 5
#> 
#> $vpath[[6]]
#> ── <vertex sequence> 2/10 · from 6de9d67 ───────────────────────────────────────
...
#> 
#> $vpath[[10]]
#> ── <vertex sequence> 6/10 · from 6de9d67 ───────────────────────────────────────
#> [1]  5  4  3  2  1 10
#> 
#> 
#> $epath
...
#> $epaths
#> $epaths[[1]]
#> ── <edge sequence> 5/10 · from 6de9d67 ─────────────────────────────────────────
...
#> 
#> $epaths[[3]]
#> ── <edge sequence> 4/10 · from 6de9d67 ─────────────────────────────────────────
#> [1] 1 ─ 10  9 ─ 10  8 ─ 9   7 ─ 8  
#> 
#> $epaths[[4]]
#> ── <edge sequence> 3/10 · from 6de9d67 ─────────────────────────────────────────
#> [1] 1 ─ 10  9 ─ 10  8 ─ 9  
#> 
#> 
#> $nrgeo
