...
ego(g, order = 0, 1:3)
#> [[1]]
#> ── <vertex sequence> 1/10 · from cc52b4c ───────────────────────────────────────
#> [1] 1
#> 
#> [[2]]
#> ── <vertex sequence> 1/10 · from cc52b4c ───────────────────────────────────────
...
ego(g, order = 1, 1:3)
#> [[1]]
#> ── <vertex sequence> 3/10 · from cc52b4c ───────────────────────────────────────
#> [1]  1  2 10
#> 
#> [[2]]
#> ── <vertex sequence> 3/10 · from cc52b4c ───────────────────────────────────────
...
ego(g, order = 2, 1:3)
#> [[1]]
#> ── <vertex sequence> 5/10 · from cc52b4c ───────────────────────────────────────
#> [1]  1  2 10  3  9
#> 
#> [[2]]
#> ── <vertex sequence> 5/10 · from cc52b4c ───────────────────────────────────────
