...
[`get_all_simple_paths()`](https://igraph.org/c/html/0.10.17/igraph-Structural.html#igraph_get_all_simple_paths),
...
#> [[1]]
#> ── <vertex sequence> 5/10 · from 7fec70b ───────────────────────────────────────
#> [1] 1 2 3 4 5
#> 
#> [[2]]
#> ── <vertex sequence> 7/10 · from 7fec70b ───────────────────────────────────────
#> [1]  1 10  9  8  7  6  5
#> 
all_simple_paths(g, 1, c(3, 5))
#> [[1]]
#> ── <vertex sequence> 3/10 · from 7fec70b ───────────────────────────────────────
#> [1] 1 2 3
#> 
#> [[2]]
#> ── <vertex sequence> 5/10 · from 7fec70b ───────────────────────────────────────
...
#> 
#> [[4]]
#> ── <vertex sequence> 9/10 · from 7fec70b ───────────────────────────────────────
