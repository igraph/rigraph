...
#> IGRAPH 2e61b77 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2e61b77:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c754063 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c754063:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 43f8ade U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 43f8ade:
...
#> IGRAPH df1e5c1 D--B 15 20 -- Bipartite Gnm random graph
