...
#> IGRAPH 983236b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 983236b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH bf24511 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bf24511:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 390f992 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 390f992:
...
#> IGRAPH 810b0f8 D--B 15 20 -- Bipartite Gnm random graph
