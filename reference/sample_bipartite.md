...
#> IGRAPH dd5de80 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dd5de80:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH da4b2d9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from da4b2d9:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c8f1364 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c8f1364:
...
#> IGRAPH 530f76a D--B 15 20 -- Bipartite Gnm random graph
