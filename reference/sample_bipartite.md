...
#> IGRAPH 821f5cc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 821f5cc:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 091c1a7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 091c1a7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2366718 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2366718:
...
#> IGRAPH 5ce16de D--B 15 20 -- Bipartite Gnm random graph
