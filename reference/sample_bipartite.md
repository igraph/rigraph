...
#> IGRAPH d653d87 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d653d87:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6f9dc63 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6f9dc63:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e83d16c U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e83d16c:
...
#> IGRAPH 4778786 D--B 15 20 -- Bipartite Gnm random graph
