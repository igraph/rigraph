...
#> IGRAPH 2d0b668 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2d0b668:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0f88d53 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0f88d53:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d311e8e U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d311e8e:
...
#> IGRAPH 32f8661 D--B 15 20 -- Bipartite Gnm random graph
