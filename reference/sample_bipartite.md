...
#> IGRAPH e187b56 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e187b56:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH e700364 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e700364:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c3e8946 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c3e8946:
...
#> IGRAPH 6422baf D--B 15 20 -- Bipartite Gnm random graph
