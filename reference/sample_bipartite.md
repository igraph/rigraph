...
#> IGRAPH 3c3bcfa U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3c3bcfa:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 8323db0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8323db0:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3fb4b9e U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3fb4b9e:
#> [1] 3--13 8--15 9--15
...
#> IGRAPH 2bedd03 D--B 15 20 -- Bipartite Gnm random graph
