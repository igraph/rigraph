...
#> IGRAPH 3dc42c6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3dc42c6:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ef1f1da U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef1f1da:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c6dbf56 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c6dbf56:
...
#> IGRAPH 4a4892c D--B 15 20 -- Bipartite Gnm random graph
