...
#> IGRAPH 26b9cc5 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26b9cc5:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4ab047c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4ab047c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 1490bf6 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1490bf6:
...
#> IGRAPH 62eeb72 D--B 15 20 -- Bipartite Gnm random graph
