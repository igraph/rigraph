...
#> IGRAPH 26f203c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26f203c:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a82c7b8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a82c7b8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4877a1b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4877a1b:
...
#> IGRAPH cbf4102 D--B 15 20 -- Bipartite Gnm random graph
