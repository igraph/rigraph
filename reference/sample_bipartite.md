...
#> IGRAPH aab9871 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aab9871:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH f997b83 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f997b83:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9876fe7 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9876fe7:
...
#> IGRAPH b2c1d05 D--B 15 20 -- Bipartite Gnm random graph
