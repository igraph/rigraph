...
#> IGRAPH 45d153e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 45d153e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 353aa66 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 353aa66:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f1b0279 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f1b0279:
...
#> IGRAPH c3c824d D--B 15 20 -- Bipartite Gnm random graph
