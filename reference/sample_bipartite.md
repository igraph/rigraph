...
#> IGRAPH 3da5e37 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3da5e37:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 51faf62 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 51faf62:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d9b93dc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d9b93dc:
...
#> IGRAPH a50aeaf D--B 15 20 -- Bipartite Gnm random graph
