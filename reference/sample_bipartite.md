...
#> IGRAPH c3a36dc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c3a36dc:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9750041 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9750041:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH da483e7 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from da483e7:
...
#> IGRAPH d2264d6 D--B 15 20 -- Bipartite Gnm random graph
