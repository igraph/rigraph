...
#> IGRAPH 71aceec U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 71aceec:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0d2805a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d2805a:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 31bf3f0 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 31bf3f0:
...
#> IGRAPH b5cbf04 D--B 15 20 -- Bipartite Gnm random graph
