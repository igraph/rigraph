...
#> IGRAPH bb2d7c7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bb2d7c7:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 7eb7802 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7eb7802:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 26aa3f5 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26aa3f5:
...
#> IGRAPH c326881 D--B 15 20 -- Bipartite Gnm random graph
