...
#> IGRAPH dfcce89 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dfcce89:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 1e2cdf5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1e2cdf5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 56fe1e4 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 56fe1e4:
...
#> IGRAPH 12429e4 D--B 15 20 -- Bipartite Gnm random graph
