...
#> IGRAPH fb0e14d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fb0e14d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4155d21 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4155d21:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 728c016 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 728c016:
...
#> IGRAPH 8a1f923 D--B 15 20 -- Bipartite Gnm random graph
