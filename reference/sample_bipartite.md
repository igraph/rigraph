...
#> IGRAPH 651988a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 651988a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 7f04e01 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7f04e01:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 763a18c U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 763a18c:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH f0a6ef1 D--B 15 20 -- Bipartite Gnm random graph
