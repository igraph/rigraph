...
#> IGRAPH 3deae45 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3deae45:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9b8da8c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9b8da8c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 917d328 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 917d328:
...
#> IGRAPH 3e3f4b3 D--B 15 20 -- Bipartite Gnm random graph
