...
#> IGRAPH 8d5c872 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8d5c872:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5b4baf3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5b4baf3:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH a694d54 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a694d54:
...
#> IGRAPH 7eb3a89 D--B 15 20 -- Bipartite Gnm random graph
