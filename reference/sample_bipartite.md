...
#> IGRAPH 4f06105 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4f06105:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0872cda U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0872cda:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 115ca2c U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 115ca2c:
...
#> IGRAPH 8011e8f D--B 15 20 -- Bipartite Gnm random graph
