...
#> IGRAPH 2e6dcca U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2e6dcca:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c09fb9b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c09fb9b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 85c84cf U--B 15 9 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 85c84cf:
...
#> IGRAPH b460d53 D--B 15 20 -- Bipartite Gnm random graph
