...
#> IGRAPH e1943de U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e1943de:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 29587be U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 29587be:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH cb5d9b2 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb5d9b2:
...
#> IGRAPH 48d1f13 D--B 15 20 -- Bipartite Gnm random graph
