...
#> IGRAPH be2a195 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from be2a195:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a80e06a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a80e06a:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 24d5611 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 24d5611:
...
#> IGRAPH 01eb459 D--B 15 20 -- Bipartite Gnm random graph
