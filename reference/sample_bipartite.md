...
#> IGRAPH 9814471 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9814471:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3313a5a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3313a5a:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 751af6f U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 751af6f:
...
#> IGRAPH ff0d588 D--B 15 20 -- Bipartite Gnm random graph
