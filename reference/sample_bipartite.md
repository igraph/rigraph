...
#> IGRAPH 0997012 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0997012:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 41b67a6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 41b67a6:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f1f86ff U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f1f86ff:
...
#> IGRAPH 2237747 D--B 15 20 -- Bipartite Gnm random graph
