...
#> IGRAPH 067aa62 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 067aa62:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 1b19067 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1b19067:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0f87be1 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0f87be1:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH ad0f3dd D--B 15 20 -- Bipartite Gnm random graph
