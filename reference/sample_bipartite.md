...
#> IGRAPH 3f0779e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3f0779e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH bfeefe0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bfeefe0:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ddaa726 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ddaa726:
...
#> IGRAPH e71376c D--B 15 20 -- Bipartite Gnm random graph
