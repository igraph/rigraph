...
#> IGRAPH bf2e584 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bf2e584:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 8bfed7d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8bfed7d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9eb5eb2 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9eb5eb2:
...
#> IGRAPH 536780d D--B 15 20 -- Bipartite Gnm random graph
