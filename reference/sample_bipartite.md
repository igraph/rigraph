...
#> IGRAPH 38eee34 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 38eee34:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 003dbcd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 003dbcd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3ea100f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3ea100f:
...
#> IGRAPH 9a3a46f D--B 15 20 -- Bipartite Gnm random graph
