...
#> IGRAPH 5fe1ef9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5fe1ef9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5faa783 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5faa783:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6af0a17 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6af0a17:
...
#> IGRAPH 762faeb D--B 15 20 -- Bipartite Gnm random graph
