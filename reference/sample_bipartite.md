...
#> IGRAPH a5cf536 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a5cf536:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH be123ec U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from be123ec:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3c3aa7f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3c3aa7f:
...
#> IGRAPH f389604 D--B 15 20 -- Bipartite Gnm random graph
