...
#> IGRAPH 94ac914 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 94ac914:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH bc34336 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bc34336:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9125fbd U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9125fbd:
...
#> IGRAPH 6bd22db D--B 15 20 -- Bipartite Gnm random graph
