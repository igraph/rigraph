...
#> IGRAPH 5396878 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5396878:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3a5c340 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a5c340:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 1dc65b8 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1dc65b8:
...
#> IGRAPH 2923e52 D--B 15 20 -- Bipartite Gnm random graph
