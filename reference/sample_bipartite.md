...
#> IGRAPH a28b128 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a28b128:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 8f2b1bd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8f2b1bd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d0f8309 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d0f8309:
...
#> IGRAPH 5b9f9cc D--B 15 20 -- Bipartite Gnm random graph
