...
#> IGRAPH fd720be U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fd720be:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 219446f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 219446f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4baa4d8 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4baa4d8:
...
#> IGRAPH 5dd5a97 D--B 15 20 -- Bipartite Gnm random graph
