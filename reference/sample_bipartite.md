...
#> IGRAPH 9b499cb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9b499cb:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 87580ce U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 87580ce:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0784df3 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0784df3:
...
#> IGRAPH bcc7364 D--B 15 20 -- Bipartite Gnm random graph
