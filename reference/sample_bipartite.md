...
#> IGRAPH 7f24677 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7f24677:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5d52950 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5d52950:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c0b9bb0 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c0b9bb0:
...
#> IGRAPH 04887c0 D--B 15 20 -- Bipartite Gnm random graph
