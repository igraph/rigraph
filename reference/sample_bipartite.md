...
#> IGRAPH 820a331 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 820a331:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0794a2d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0794a2d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 338148c U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 338148c:
...
#> IGRAPH 76e65e6 D--B 15 20 -- Bipartite Gnm random graph
