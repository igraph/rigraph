...
#> IGRAPH 56f465d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 56f465d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9ed02b0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9ed02b0:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b93eabf U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b93eabf:
...
#> IGRAPH cbd691a D--B 15 20 -- Bipartite Gnm random graph
