...
#> IGRAPH 4f7434e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4f7434e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 01e17eb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 01e17eb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e0b9a26 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e0b9a26:
...
#> IGRAPH 2b0a4f5 D--B 15 20 -- Bipartite Gnm random graph
