...
#> IGRAPH 4dee99a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4dee99a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH f34c816 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f34c816:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 425ad50 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 425ad50:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH 5ce89bf D--B 15 20 -- Bipartite Gnm random graph
