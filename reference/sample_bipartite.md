...
#> IGRAPH 48175bb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 48175bb:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cb917cd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb917cd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 403c513 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 403c513:
...
#> IGRAPH 0c1f2be D--B 15 20 -- Bipartite Gnm random graph
