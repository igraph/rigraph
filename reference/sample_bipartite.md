...
#> IGRAPH 920c1bc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 920c1bc:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a4adaa4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a4adaa4:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b19a212 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b19a212:
#> [1] 3--13 8--15 9--15
...
#> IGRAPH 07dcc72 D--B 15 20 -- Bipartite Gnm random graph
