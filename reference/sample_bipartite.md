...
#> IGRAPH 9944234 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9944234:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 051fa54 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 051fa54:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 02b997e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 02b997e:
...
#> IGRAPH 18f08b4 D--B 15 20 -- Bipartite Gnm random graph
