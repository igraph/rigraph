...
#> IGRAPH 349377b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 349377b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5834fcd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5834fcd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b1f5d0b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b1f5d0b:
...
#> IGRAPH bee92da D--B 15 20 -- Bipartite Gnm random graph
