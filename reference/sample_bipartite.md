...
#> IGRAPH 9ab47a9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9ab47a9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 097ad3d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 097ad3d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH acdc123 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from acdc123:
...
#> IGRAPH 51e99f2 D--B 15 20 -- Bipartite Gnm random graph
