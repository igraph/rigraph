...
#> IGRAPH 3f8a63e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3f8a63e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a4509f3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a4509f3:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH aadf642 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aadf642:
...
#> IGRAPH b7bf372 D--B 15 20 -- Bipartite Gnm random graph
