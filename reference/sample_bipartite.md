...
#> IGRAPH 88db588 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 88db588:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c380e5c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c380e5c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 7c53c43 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7c53c43:
...
#> IGRAPH 21c884e D--B 15 20 -- Bipartite Gnm random graph
