...
#> IGRAPH 002a10b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 002a10b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 71c072c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 71c072c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 1914436 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1914436:
...
#> IGRAPH b274b8d D--B 15 20 -- Bipartite Gnm random graph
