...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 3d7b65c ──
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 5185df2 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 61b36f0 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnm random graph ────────────────────────────── c676902 ──
