...
#> IGRAPH dd5c4ee U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dd5c4ee:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 12ab76f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 12ab76f:
...
#> IGRAPH be70e7d U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from be70e7d:
...
#> IGRAPH 6bdb41f D--B 15 20 -- Bipartite Gnm random graph
