...
#> IGRAPH 5bf23b7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5bf23b7:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 7881c6d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7881c6d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 26d250d U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26d250d:
...
#> IGRAPH bf30c5e D--B 15 20 -- Bipartite Gnm random graph
