...
#> IGRAPH a4b92ed U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a4b92ed:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 7ebeb0f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7ebeb0f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c2b8c6c U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c2b8c6c:
...
#> IGRAPH 9cd602c D--B 15 20 -- Bipartite Gnm random graph
