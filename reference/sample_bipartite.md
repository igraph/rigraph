...
#> IGRAPH 74b901d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 74b901d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3ebed11 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3ebed11:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0de77ef U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0de77ef:
...
#> IGRAPH 8ab175a D--B 15 20 -- Bipartite Gnm random graph
