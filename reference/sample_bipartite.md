...
#> IGRAPH 96f8a22 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 96f8a22:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cf312f7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cf312f7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 8bfc0ee U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8bfc0ee:
...
#> IGRAPH a0d11ff D--B 15 20 -- Bipartite Gnm random graph
