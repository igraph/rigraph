...
#> IGRAPH cbb8c21 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cbb8c21:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 070603f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 070603f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 58eb3f2 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 58eb3f2:
...
#> IGRAPH c521f51 D--B 15 20 -- Bipartite Gnm random graph
