...
#> IGRAPH 8f498da U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8f498da:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH eed2d51 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eed2d51:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e809919 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e809919:
...
#> IGRAPH 9dc4684 D--B 15 20 -- Bipartite Gnm random graph
