...
#> IGRAPH e5402c0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e5402c0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2f490eb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2f490eb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 19362d1 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 19362d1:
...
#> IGRAPH 1e2dce7 D--B 15 20 -- Bipartite Gnm random graph
