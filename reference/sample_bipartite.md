...
#> IGRAPH baf502a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from baf502a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 13ee14a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 13ee14a:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 041fad2 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 041fad2:
...
#> IGRAPH cbf3171 D--B 15 20 -- Bipartite Gnm random graph
