...
#> IGRAPH 810de8b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 810de8b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cb7548e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb7548e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4848f58 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4848f58:
...
#> IGRAPH 689dbce D--B 15 20 -- Bipartite Gnm random graph
