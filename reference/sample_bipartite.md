...
#> IGRAPH 22aea5f U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 22aea5f:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH f983a09 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f983a09:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 80fd5ef U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 80fd5ef:
...
#> IGRAPH 6ebf508 D--B 15 20 -- Bipartite Gnm random graph
