...
#> IGRAPH 94e25cd U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 94e25cd:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6cd85be U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6cd85be:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 25ba6f5 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 25ba6f5:
...
#> IGRAPH d24d7db D--B 15 20 -- Bipartite Gnm random graph
