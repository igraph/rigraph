...
#> IGRAPH 8c4e585 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8c4e585:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a94ce61 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a94ce61:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 70dc978 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 70dc978:
...
#> IGRAPH dcf86fc D--B 15 20 -- Bipartite Gnm random graph
