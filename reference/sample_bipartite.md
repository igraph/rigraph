...
#> IGRAPH 5cec741 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5cec741:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 206fe12 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 206fe12:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4898b4f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4898b4f:
...
#> IGRAPH c4c988b D--B 15 20 -- Bipartite Gnm random graph
