...
#> IGRAPH c3d0921 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c3d0921:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0c862f5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0c862f5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 5cebd46 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5cebd46:
...
#> IGRAPH 63015e5 D--B 15 20 -- Bipartite Gnm random graph
