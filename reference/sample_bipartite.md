...
#> IGRAPH 2b4c029 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2b4c029:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cab7a5b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cab7a5b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9712fce U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9712fce:
...
#> IGRAPH b874aef D--B 15 20 -- Bipartite Gnm random graph
