...
#> IGRAPH e651ef0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e651ef0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c8d8464 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c8d8464:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH cda82cb U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cda82cb:
#> [1] 3--13 8--15 9--15
...
#> IGRAPH f264019 D--B 15 20 -- Bipartite Gnm random graph
