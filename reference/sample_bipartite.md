...
#> IGRAPH c15b627 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c15b627:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2b71a22 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2b71a22:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH fbf9ab7 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fbf9ab7:
...
#> IGRAPH 78a611e D--B 15 20 -- Bipartite Gnm random graph
