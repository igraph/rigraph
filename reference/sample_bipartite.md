...
#> IGRAPH b2ea255 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b2ea255:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 016fc39 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 016fc39:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b87470f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b87470f:
...
#> IGRAPH 9b3997f D--B 15 20 -- Bipartite Gnm random graph
