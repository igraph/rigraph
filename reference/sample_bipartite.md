...
#> IGRAPH 53eb1bd U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 53eb1bd:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 8c8debc U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8c8debc:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b93f28e U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b93f28e:
...
#> IGRAPH b67e7c6 D--B 15 20 -- Bipartite Gnm random graph
