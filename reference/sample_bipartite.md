...
#> IGRAPH 93e6cf7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 93e6cf7:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH be8ba0e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from be8ba0e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH dd9b180 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dd9b180:
...
#> IGRAPH c4ec203 D--B 15 20 -- Bipartite Gnm random graph
