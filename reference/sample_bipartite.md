...
#> IGRAPH 3446349 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3446349:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6fb7235 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6fb7235:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b95626b U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b95626b:
...
#> IGRAPH 010993d D--B 15 20 -- Bipartite Gnm random graph
