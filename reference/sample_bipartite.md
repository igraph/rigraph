...
#> IGRAPH c5fe045 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c5fe045:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 95becbd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 95becbd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ed71d64 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ed71d64:
...
#> IGRAPH 5b91ea7 D--B 15 20 -- Bipartite Gnm random graph
