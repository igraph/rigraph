...
#> IGRAPH 4a581e2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4a581e2:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 1128504 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1128504:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH df09812 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from df09812:
...
#> IGRAPH 086d5cb D--B 15 20 -- Bipartite Gnm random graph
