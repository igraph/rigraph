...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 6506144 ──
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 5216405 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── b3f0d4c ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnm random graph ────────────────────────────── f2c72e8 ──
