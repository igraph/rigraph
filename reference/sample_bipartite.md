...
#> IGRAPH b4e94bb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b4e94bb:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cb23be4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb23be4:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9bd59cb U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9bd59cb:
...
#> IGRAPH c32eb48 D--B 15 20 -- Bipartite Gnm random graph
