...
#> IGRAPH bdcebcc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bdcebcc:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH e897075 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e897075:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3e0bd88 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3e0bd88:
...
#> IGRAPH ac5f971 D--B 15 20 -- Bipartite Gnm random graph
