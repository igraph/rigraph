...
#> IGRAPH 7080a14 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7080a14:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c7efa1b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c7efa1b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH bf20dc5 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bf20dc5:
...
#> IGRAPH 631751b D--B 15 20 -- Bipartite Gnm random graph
