...
#> IGRAPH 2d8f4b7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2d8f4b7:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9433c3e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9433c3e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 266d6a9 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 266d6a9:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH df29c1a D--B 15 20 -- Bipartite Gnm random graph
