...
#> IGRAPH 77accc0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 77accc0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 85dbc4f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 85dbc4f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6a7fa72 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6a7fa72:
...
#> IGRAPH edf8dfc D--B 15 20 -- Bipartite Gnm random graph
