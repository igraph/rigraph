...
#> IGRAPH 51bb2c0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 51bb2c0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 72ed32f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 72ed32f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 258a2d5 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 258a2d5:
...
#> IGRAPH 0ea9699 D--B 15 20 -- Bipartite Gnm random graph
