...
#> IGRAPH a69ccd9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a69ccd9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a193151 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a193151:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e303fba U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e303fba:
...
#> IGRAPH ff6f5a5 D--B 15 20 -- Bipartite Gnm random graph
