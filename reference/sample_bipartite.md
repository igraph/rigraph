...
#> IGRAPH ae694e6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ae694e6:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 66c2cf3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 66c2cf3:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 333779e U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 333779e:
...
#> IGRAPH 0bd2744 D--B 15 20 -- Bipartite Gnm random graph
