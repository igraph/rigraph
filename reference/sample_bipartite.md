...
#> IGRAPH f9f7e7b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f9f7e7b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH d377106 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d377106:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 251e08e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 251e08e:
...
#> IGRAPH 16cb3d7 D--B 15 20 -- Bipartite Gnm random graph
