...
#> IGRAPH d40a705 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d40a705:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c7f038b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c7f038b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 03a7cab U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 03a7cab:
...
#> IGRAPH 7f85a4e D--B 15 20 -- Bipartite Gnm random graph
