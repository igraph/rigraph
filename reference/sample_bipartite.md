...
#> IGRAPH 92b3312 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 92b3312:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 090ccf7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 090ccf7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 8ddd001 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8ddd001:
...
#> IGRAPH 4e57060 D--B 15 20 -- Bipartite Gnm random graph
