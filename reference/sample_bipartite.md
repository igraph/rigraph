...
#> IGRAPH dcd4d71 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dcd4d71:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5a83aee U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5a83aee:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d6cd641 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d6cd641:
...
#> IGRAPH f328103 D--B 15 20 -- Bipartite Gnm random graph
