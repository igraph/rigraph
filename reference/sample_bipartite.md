...
#> IGRAPH 31ceb69 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 31ceb69:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH e0049c7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e0049c7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 54a3587 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 54a3587:
...
#> IGRAPH 8a7453e D--B 15 20 -- Bipartite Gnm random graph
