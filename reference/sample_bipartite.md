...
#> IGRAPH 7390cfb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7390cfb:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 7af4bf1 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7af4bf1:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH cc175a3 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cc175a3:
...
#> IGRAPH c5c662e D--B 15 20 -- Bipartite Gnm random graph
