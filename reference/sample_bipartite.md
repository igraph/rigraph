...
#> IGRAPH 854476e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 854476e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3211c91 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3211c91:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ce4c415 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ce4c415:
...
#> IGRAPH 6897aac D--B 15 20 -- Bipartite Gnm random graph
