...
#> IGRAPH b8f6d0d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b8f6d0d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH dd7b87f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dd7b87f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0d994b0 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d994b0:
...
#> IGRAPH 409ff47 D--B 15 20 -- Bipartite Gnm random graph
