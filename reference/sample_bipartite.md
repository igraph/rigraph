...
#> IGRAPH 8f31102 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8f31102:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 1f4a75f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1f4a75f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ad04213 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ad04213:
...
#> IGRAPH 6e6a171 D--B 15 20 -- Bipartite Gnm random graph
