...
#> IGRAPH 4e3189e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4e3189e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5b6cac5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5b6cac5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 118dab8 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 118dab8:
...
#> IGRAPH a6a2485 D--B 15 20 -- Bipartite Gnm random graph
