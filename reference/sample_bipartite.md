...
#> IGRAPH 0d40da4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d40da4:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2daccd5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2daccd5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4cd3c41 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4cd3c41:
...
#> IGRAPH a5df851 D--B 15 20 -- Bipartite Gnm random graph
