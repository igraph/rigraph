...
#> IGRAPH e012786 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e012786:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 92ac425 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 92ac425:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 126f645 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 126f645:
...
#> IGRAPH db83da7 D--B 15 20 -- Bipartite Gnm random graph
