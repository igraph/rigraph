...
#> IGRAPH b89c6e0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b89c6e0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cbc6c9d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cbc6c9d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH a292ccd U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a292ccd:
...
#> IGRAPH c8d3cc2 D--B 15 20 -- Bipartite Gnm random graph
