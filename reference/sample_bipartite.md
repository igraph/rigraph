...
#> IGRAPH 38c1f4b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 38c1f4b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 041a9ed U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 041a9ed:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 53c04b3 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 53c04b3:
...
#> IGRAPH 74c7619 D--B 15 20 -- Bipartite Gnm random graph
