...
#> IGRAPH 77cea96 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 77cea96:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH fb4c4d8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fb4c4d8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9a61ffc U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9a61ffc:
...
#> IGRAPH 18f645c D--B 15 20 -- Bipartite Gnm random graph
