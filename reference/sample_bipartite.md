...
#> IGRAPH 30b1788 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 30b1788:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0dc7d4b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0dc7d4b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 586c1a2 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 586c1a2:
...
#> IGRAPH a70f225 D--B 15 20 -- Bipartite Gnm random graph
