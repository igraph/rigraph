...
#> IGRAPH 90e37a9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 90e37a9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 65ef31a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 65ef31a:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 81302df U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 81302df:
...
#> IGRAPH 90d4eef D--B 15 20 -- Bipartite Gnm random graph
