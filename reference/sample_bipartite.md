...
#> IGRAPH b7fc063 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b7fc063:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 85fbd7d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 85fbd7d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 068a335 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 068a335:
...
#> IGRAPH dab59eb D--B 15 20 -- Bipartite Gnm random graph
