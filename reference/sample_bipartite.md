...
#> IGRAPH 468f822 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 468f822:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c286fba U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c286fba:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3f8dbed U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3f8dbed:
...
#> IGRAPH 5d11633 D--B 15 20 -- Bipartite Gnm random graph
