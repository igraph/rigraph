...
#> IGRAPH 72b0d3e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 72b0d3e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2d638ed U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2d638ed:
...
#> IGRAPH 4229cf1 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4229cf1:
...
#> IGRAPH fe6ff01 D--B 15 20 -- Bipartite Gnm random graph
