...
#> IGRAPH d808bd3 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d808bd3:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 21590fb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 21590fb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6fc0b3e U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6fc0b3e:
...
#> IGRAPH 3f6dfc1 D--B 15 20 -- Bipartite Gnm random graph
