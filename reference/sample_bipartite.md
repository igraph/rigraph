...
#> IGRAPH e9316a7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e9316a7:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH f751232 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f751232:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f6e5f25 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f6e5f25:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH cbede64 D--B 15 20 -- Bipartite Gnm random graph
