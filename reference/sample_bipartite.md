...
#> IGRAPH fb8ad82 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fb8ad82:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 346788a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 346788a:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4e97b8e U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4e97b8e:
...
#> IGRAPH 302b669 D--B 15 20 -- Bipartite Gnm random graph
