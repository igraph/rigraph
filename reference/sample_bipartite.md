...
#> IGRAPH ac1b330 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ac1b330:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH dd00d74 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dd00d74:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH bdf5ced U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bdf5ced:
...
#> IGRAPH e6ae74a D--B 15 20 -- Bipartite Gnm random graph
