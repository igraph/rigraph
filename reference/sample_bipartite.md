...
#> IGRAPH 2721bdf U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2721bdf:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 103cd9f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 103cd9f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4548ddc U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4548ddc:
...
#> IGRAPH 9f100b2 D--B 15 20 -- Bipartite Gnm random graph
