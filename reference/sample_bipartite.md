...
#> IGRAPH fe9e956 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fe9e956:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH af504cb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from af504cb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0d0523c U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d0523c:
...
#> IGRAPH 1a1c03f D--B 15 20 -- Bipartite Gnm random graph
