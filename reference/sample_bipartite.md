...
#> IGRAPH f740297 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f740297:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 417abfd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 417abfd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 477470f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 477470f:
...
#> IGRAPH 886f110 D--B 15 20 -- Bipartite Gnm random graph
