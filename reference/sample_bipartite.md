...
#> IGRAPH c18c90d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c18c90d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2054927 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2054927:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9a163f6 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9a163f6:
...
#> IGRAPH 4d16024 D--B 15 20 -- Bipartite Gnm random graph
