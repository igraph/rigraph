...
#> IGRAPH bd4a7a8 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bd4a7a8:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ac72a49 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ac72a49:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9331dde U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9331dde:
...
#> IGRAPH 239543f D--B 15 20 -- Bipartite Gnm random graph
