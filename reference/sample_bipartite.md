...
#> IGRAPH 8fba287 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8fba287:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 866effa U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 866effa:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH af6d4c7 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from af6d4c7:
...
#> IGRAPH d83876f D--B 15 20 -- Bipartite Gnm random graph
