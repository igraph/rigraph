...
#> IGRAPH 7df721d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7df721d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 269c8bd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 269c8bd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 95fb9be U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 95fb9be:
...
#> IGRAPH fc2bfd4 D--B 15 20 -- Bipartite Gnm random graph
