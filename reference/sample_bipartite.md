...
#> IGRAPH dfef168 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dfef168:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 130a57e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 130a57e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6ec167b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6ec167b:
...
#> IGRAPH fbd9c1e D--B 15 20 -- Bipartite Gnm random graph
