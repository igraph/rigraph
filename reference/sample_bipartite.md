...
#> IGRAPH 923eb87 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 923eb87:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6aa0137 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6aa0137:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3641550 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3641550:
...
#> IGRAPH 9171db9 D--B 15 20 -- Bipartite Gnm random graph
