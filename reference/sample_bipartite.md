...
#> IGRAPH 65a630e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 65a630e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH d9c8692 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d9c8692:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 35310d5 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 35310d5:
...
#> IGRAPH 89826a0 D--B 15 20 -- Bipartite Gnm random graph
