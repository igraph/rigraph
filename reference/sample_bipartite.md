...
#> IGRAPH 2954e9b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2954e9b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2da52c7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2da52c7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2733f5f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2733f5f:
...
#> IGRAPH 90da88b D--B 15 20 -- Bipartite Gnm random graph
