...
#> IGRAPH 86a2aa2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 86a2aa2:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c374bbb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c374bbb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ca3f4b0 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ca3f4b0:
...
#> IGRAPH 58a524e D--B 15 20 -- Bipartite Gnm random graph
