...
#> IGRAPH aee193e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aee193e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 07ec22c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 07ec22c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 285fc7a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 285fc7a:
...
#> IGRAPH c2a317d D--B 15 20 -- Bipartite Gnm random graph
