...
#> IGRAPH a710c56 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a710c56:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5b2a6a7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5b2a6a7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 51a0383 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 51a0383:
...
#> IGRAPH ef28623 D--B 15 20 -- Bipartite Gnm random graph
