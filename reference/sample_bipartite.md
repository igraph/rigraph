...
#> IGRAPH eb2c205 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eb2c205:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 27b2fd5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 27b2fd5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e024288 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e024288:
...
#> IGRAPH 1df3c2d D--B 15 20 -- Bipartite Gnm random graph
