...
#> IGRAPH f20309c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f20309c:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a576773 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a576773:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ea31053 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ea31053:
...
#> IGRAPH e3f1e12 D--B 15 20 -- Bipartite Gnm random graph
