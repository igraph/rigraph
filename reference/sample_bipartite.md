...
#> IGRAPH f52adcb U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f52adcb:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a77bac8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a77bac8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b61cce4 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b61cce4:
...
#> IGRAPH 9412ef9 D--B 15 20 -- Bipartite Gnm random graph
