...
#> IGRAPH 7d6eaf5 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7d6eaf5:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 032ae9f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 032ae9f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4c40c77 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4c40c77:
...
#> IGRAPH ac10332 D--B 15 20 -- Bipartite Gnm random graph
