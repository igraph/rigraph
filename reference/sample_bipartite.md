...
#> IGRAPH af11518 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from af11518:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4722d4e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4722d4e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 013bc4e U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 013bc4e:
...
#> IGRAPH ca6f051 D--B 15 20 -- Bipartite Gnm random graph
