...
#> IGRAPH 385da0b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 385da0b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c2fab2f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c2fab2f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 7b36013 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b36013:
...
#> IGRAPH d8694ce D--B 15 20 -- Bipartite Gnm random graph
