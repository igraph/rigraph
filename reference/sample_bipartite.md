...
#> IGRAPH e95901d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e95901d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0de3480 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0de3480:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH a81ab45 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a81ab45:
...
#> IGRAPH 1d75770 D--B 15 20 -- Bipartite Gnm random graph
