...
#> IGRAPH cd00053 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cd00053:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ba6daf6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ba6daf6:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d92f1ad U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d92f1ad:
...
#> IGRAPH 39475ac D--B 15 20 -- Bipartite Gnm random graph
