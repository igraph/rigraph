...
#> IGRAPH 74c637b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 74c637b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 179136f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 179136f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0b0e937 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0b0e937:
...
#> IGRAPH 2dd0979 D--B 15 20 -- Bipartite Gnm random graph
