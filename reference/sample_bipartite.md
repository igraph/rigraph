...
#> IGRAPH cf21c6c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cf21c6c:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 510963d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 510963d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 35ede81 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 35ede81:
...
#> IGRAPH 762119f D--B 15 20 -- Bipartite Gnm random graph
