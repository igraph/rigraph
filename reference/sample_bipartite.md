...
#> IGRAPH e8e4fc4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e8e4fc4:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 94cfb68 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 94cfb68:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 40deeba U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 40deeba:
...
#> IGRAPH d3518e4 D--B 15 20 -- Bipartite Gnm random graph
