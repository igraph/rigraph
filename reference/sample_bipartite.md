...
#> IGRAPH 1117c4a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1117c4a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2940158 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2940158:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3a5b7e5 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a5b7e5:
...
#> IGRAPH 28711e6 D--B 15 20 -- Bipartite Gnm random graph
