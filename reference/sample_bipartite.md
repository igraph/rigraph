...
#> IGRAPH 6eef717 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6eef717:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 85b74a9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 85b74a9:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2b0418a U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2b0418a:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH cf9c2fe D--B 15 20 -- Bipartite Gnm random graph
