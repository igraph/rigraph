...
#> IGRAPH e87e0ba U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e87e0ba:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH b418f8f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b418f8f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3b71093 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3b71093:
...
#> IGRAPH b9f51db D--B 15 20 -- Bipartite Gnm random graph
