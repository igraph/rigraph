...
#> IGRAPH f505200 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f505200:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH b337a02 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b337a02:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6ad63f1 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6ad63f1:
...
#> IGRAPH 7111edc D--B 15 20 -- Bipartite Gnm random graph
