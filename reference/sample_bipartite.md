...
#> IGRAPH 086ee8b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 086ee8b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a1eed5f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a1eed5f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 379e954 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 379e954:
...
#> IGRAPH 5d674b9 D--B 15 20 -- Bipartite Gnm random graph
