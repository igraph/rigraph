...
#> IGRAPH 05062ac U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 05062ac:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9f7b23e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f7b23e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b7c3911 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b7c3911:
...
#> IGRAPH 8566021 D--B 15 20 -- Bipartite Gnm random graph
