...
#> IGRAPH 1203de3 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1203de3:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH fcd3049 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fcd3049:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2e8680a U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2e8680a:
...
#> IGRAPH 4a5f461 D--B 15 20 -- Bipartite Gnm random graph
