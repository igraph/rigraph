...
#> IGRAPH d3e4513 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d3e4513:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a368c24 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a368c24:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2bd8076 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2bd8076:
...
#> IGRAPH 04b24d3 D--B 15 20 -- Bipartite Gnm random graph
