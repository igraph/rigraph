...
#> IGRAPH 495785c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 495785c:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ac1d427 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ac1d427:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b23a69a U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b23a69a:
...
#> IGRAPH 3c32b1a D--B 15 20 -- Bipartite Gnm random graph
