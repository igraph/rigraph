...
#> IGRAPH 017ea40 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 017ea40:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0385463 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0385463:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c90ca3b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c90ca3b:
...
#> IGRAPH 1b9029b D--B 15 20 -- Bipartite Gnm random graph
