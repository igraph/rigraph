...
#> IGRAPH d23462b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d23462b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 8e8233b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8e8233b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 41cb1ae U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 41cb1ae:
...
#> IGRAPH 04b0fbe D--B 15 20 -- Bipartite Gnm random graph
