...
#> IGRAPH ef27d37 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef27d37:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH b344352 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b344352:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3a1cb33 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a1cb33:
...
#> IGRAPH 51e351f D--B 15 20 -- Bipartite Gnm random graph
