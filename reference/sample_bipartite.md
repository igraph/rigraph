...
#> IGRAPH b0924c8 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b0924c8:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH e64d5fd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e64d5fd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 74750f8 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 74750f8:
#> [1] 4--12 6--14 7--15
...
#> IGRAPH 8899769 D--B 15 20 -- Bipartite Gnm random graph
