...
#> IGRAPH 7082745 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7082745:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cb1d649 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb1d649:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3224c07 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3224c07:
...
#> IGRAPH aae3ac7 D--B 15 20 -- Bipartite Gnm random graph
