...
#> IGRAPH f3e8952 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f3e8952:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6eb65ae U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6eb65ae:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2f13c29 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2f13c29:
#> [1] 3--13 8--15 9--15
...
#> IGRAPH f751997 D--B 15 20 -- Bipartite Gnm random graph
#> + attr: name (g/c), m (g/n), type (v/l)
#> + edges from f751997:
#>  [1]  9->11  2->12 10->12  5->13  2->14  7->14  3->15  4->15 12-> 1 15-> 3
#> [11] 15-> 4 13-> 5 13-> 7 11-> 8 11-> 9 12-> 9 13-> 9 14-> 9 15-> 9 13->10
```
