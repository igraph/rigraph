...
#> IGRAPH b610451 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b610451:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH b78ff53 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b78ff53:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 8cfadc5 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8cfadc5:
...
#> IGRAPH 9b45608 D--B 15 20 -- Bipartite Gnm random graph
