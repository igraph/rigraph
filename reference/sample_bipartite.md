...
#> IGRAPH 3d58e85 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3d58e85:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a7029bb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a7029bb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 569533f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 569533f:
...
#> IGRAPH 53c135c D--B 15 20 -- Bipartite Gnm random graph
