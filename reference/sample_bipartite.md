...
#> IGRAPH 08c51ac U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 08c51ac:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0f89e2b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0f89e2b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6c875cd U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6c875cd:
...
#> IGRAPH 336bd83 D--B 15 20 -- Bipartite Gnm random graph
