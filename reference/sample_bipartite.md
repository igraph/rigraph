...
#> IGRAPH c67062d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c67062d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 614d9b9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 614d9b9:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH cae0469 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cae0469:
...
#> IGRAPH 53eb1c5 D--B 15 20 -- Bipartite Gnm random graph
