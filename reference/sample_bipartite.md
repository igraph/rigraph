...
#> IGRAPH ebc8658 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ebc8658:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9d08092 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9d08092:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c46ce34 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c46ce34:
...
#> IGRAPH 2a4fd8d D--B 15 20 -- Bipartite Gnm random graph
