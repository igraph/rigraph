...
#> IGRAPH 359e366 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 359e366:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 92ee014 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 92ee014:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH efb6d98 U--B 15 3 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from efb6d98:
#> [1] 3--13 8--15 9--15
...
#> IGRAPH 00a493f D--B 15 20 -- Bipartite Gnm random graph
