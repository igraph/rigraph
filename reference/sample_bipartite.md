...
#> IGRAPH cdf3c29 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cdf3c29:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4d4589f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4d4589f:
...
#> IGRAPH 7b6d8f2 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b6d8f2:
...
#> IGRAPH c2238e1 D--B 15 20 -- Bipartite Gnm random graph
