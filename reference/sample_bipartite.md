...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── d37bed2 ──
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── e740e48 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 04f6378 ──
#> ℹ undirected · bipartite
...
#> 
#> ── Edges ───────────────────────────────────────────────────────────────────────
#>  [1] 3 → 11   8 → 11   1 → 12   2 → 12   10 → 12  3 → 13   9 → 13   10 → 13 
#>  [9] 8 → 14   10 → 15  12 → 1   13 → 1   12 → 2   13 → 2   11 → 4   11 → 8  
#> [17] 14 → 8   11 → 9   13 → 9   14 → 9  
```
