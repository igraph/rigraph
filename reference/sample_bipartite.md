...
#> IGRAPH f68bfd3 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f68bfd3:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH eaa67a0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from eaa67a0:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 046e4b1 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 046e4b1:
...
#> IGRAPH 7478305 D--B 15 20 -- Bipartite Gnm random graph
