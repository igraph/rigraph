...
#> IGRAPH bddc081 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bddc081:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2fb2dda U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2fb2dda:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH bcc37fe U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bcc37fe:
...
#> IGRAPH fa5f94e D--B 15 20 -- Bipartite Gnm random graph
