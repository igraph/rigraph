...
#> IGRAPH ed87786 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ed87786:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ded9641 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ded9641:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 200de99 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 200de99:
...
#> IGRAPH d7ccfdf D--B 15 20 -- Bipartite Gnm random graph
