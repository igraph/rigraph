...
#> IGRAPH a3ac13b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a3ac13b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0430b28 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0430b28:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH bf50db6 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bf50db6:
...
#> IGRAPH 64eb1c9 D--B 15 20 -- Bipartite Gnm random graph
