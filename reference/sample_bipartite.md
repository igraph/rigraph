...
#> IGRAPH 5a60eb9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5a60eb9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a4a3c50 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a4a3c50:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 324a148 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 324a148:
...
#> IGRAPH fbad402 D--B 15 20 -- Bipartite Gnm random graph
