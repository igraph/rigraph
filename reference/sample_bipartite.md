...
#> IGRAPH 6498026 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6498026:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 7401e3f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7401e3f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ad2087a U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ad2087a:
...
#> IGRAPH ec1da1d D--B 15 20 -- Bipartite Gnm random graph
