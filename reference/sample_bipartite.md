...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 97009b8 ──
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 55c7dd8 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnp random graph ────────────────────────────── 1d41f17 ──
#> ℹ undirected · bipartite
...
#> ── <igraph> Bipartite Gnm random graph ────────────────────────────── 869e03a ──
