...
#> IGRAPH a1c2b19 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a1c2b19:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ef40f5c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef40f5c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 294664e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 294664e:
...
#> IGRAPH 3105f4c D--B 15 20 -- Bipartite Gnm random graph
