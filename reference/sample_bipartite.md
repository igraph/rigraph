...
#> IGRAPH 6691bcc U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6691bcc:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH fa76ea5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fa76ea5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2ca4d8a U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2ca4d8a:
...
#> IGRAPH 8085f62 D--B 15 20 -- Bipartite Gnm random graph
