...
#> IGRAPH 92b357a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 92b357a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 8e9f4a9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8e9f4a9:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6b149e5 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6b149e5:
...
#> IGRAPH b469363 D--B 15 20 -- Bipartite Gnm random graph
