...
#> IGRAPH 82b1292 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 82b1292:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3e6b68e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3e6b68e:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH cfede5c U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cfede5c:
...
#> IGRAPH b940439 D--B 15 20 -- Bipartite Gnm random graph
