...
#> IGRAPH af4fb1d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from af4fb1d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH f1d64a6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f1d64a6:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 1c6fd9e U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1c6fd9e:
...
#> IGRAPH 65f9acd D--B 15 20 -- Bipartite Gnm random graph
