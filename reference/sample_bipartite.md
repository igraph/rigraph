...
#> IGRAPH 956ac46 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 956ac46:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ded7483 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ded7483:
...
#> IGRAPH b92246c U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b92246c:
...
#> IGRAPH ec837dc D--B 15 20 -- Bipartite Gnm random graph
