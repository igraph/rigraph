...
#> IGRAPH ad16517 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ad16517:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 303378b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 303378b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH bec48cd U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bec48cd:
...
#> IGRAPH 9f5e4aa D--B 15 20 -- Bipartite Gnm random graph
