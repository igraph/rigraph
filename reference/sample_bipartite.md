...
#> IGRAPH 875541d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 875541d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 05dcba3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 05dcba3:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9e35e17 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9e35e17:
...
#> IGRAPH 658a85a D--B 15 20 -- Bipartite Gnm random graph
