...
#> IGRAPH 8a58896 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8a58896:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH d29b3a8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d29b3a8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH bdc1375 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bdc1375:
...
#> IGRAPH 910fce9 D--B 15 20 -- Bipartite Gnm random graph
