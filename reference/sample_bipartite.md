...
#> IGRAPH afe1fbf U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from afe1fbf:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 76ee22d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 76ee22d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 60b8dcf U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 60b8dcf:
...
#> IGRAPH 2245e60 D--B 15 20 -- Bipartite Gnm random graph
