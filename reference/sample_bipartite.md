...
#> IGRAPH 1d8c391 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1d8c391:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH e2949f9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e2949f9:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2f8f142 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2f8f142:
...
#> IGRAPH faea3e4 D--B 15 20 -- Bipartite Gnm random graph
