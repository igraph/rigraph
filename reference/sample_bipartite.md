...
#> IGRAPH 3cf6459 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3cf6459:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH da43038 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from da43038:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 759ddb8 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 759ddb8:
...
#> IGRAPH 6dd4a17 D--B 15 20 -- Bipartite Gnm random graph
