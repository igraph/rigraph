...
#> IGRAPH c271a0d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c271a0d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4a1f678 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4a1f678:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH cd66430 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cd66430:
...
#> IGRAPH 0b848a1 D--B 15 20 -- Bipartite Gnm random graph
