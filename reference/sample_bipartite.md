...
#> IGRAPH e173f70 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e173f70:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9434751 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9434751:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2dc663e U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2dc663e:
...
#> IGRAPH 1b1d1ed D--B 15 20 -- Bipartite Gnm random graph
