...
#> IGRAPH c70b7d0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c70b7d0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 2176c93 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2176c93:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2a990a7 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2a990a7:
...
#> IGRAPH 30352ec D--B 15 20 -- Bipartite Gnm random graph
