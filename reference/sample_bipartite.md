...
#> IGRAPH 59d773b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 59d773b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6b533d3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6b533d3:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 8a73bc3 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8a73bc3:
...
#> IGRAPH ed345e0 D--B 15 20 -- Bipartite Gnm random graph
