...
#> IGRAPH dba1e01 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dba1e01:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH bd57a70 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bd57a70:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 2bdcdca U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2bdcdca:
...
#> IGRAPH 0e45d8f D--B 15 20 -- Bipartite Gnm random graph
