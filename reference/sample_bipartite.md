...
#> IGRAPH 7d30065 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7d30065:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5a9d619 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5a9d619:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 70c8bef U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 70c8bef:
...
#> IGRAPH 6af043b D--B 15 20 -- Bipartite Gnm random graph
