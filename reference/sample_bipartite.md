...
#> IGRAPH 3c66f86 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3c66f86:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 315b466 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 315b466:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9ad742e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9ad742e:
...
#> IGRAPH bac22dc D--B 15 20 -- Bipartite Gnm random graph
