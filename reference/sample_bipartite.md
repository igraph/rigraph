...
#> IGRAPH fc1886a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fc1886a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 77935dd U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 77935dd:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 796e7ff U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 796e7ff:
...
#> IGRAPH 93086eb D--B 15 20 -- Bipartite Gnm random graph
