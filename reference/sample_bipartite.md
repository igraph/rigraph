...
#> IGRAPH e2b7cb2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e2b7cb2:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 94f0166 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 94f0166:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 34c4a75 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 34c4a75:
...
#> IGRAPH e5cb211 D--B 15 20 -- Bipartite Gnm random graph
