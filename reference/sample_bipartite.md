...
#> IGRAPH 7b45361 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b45361:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 34c2b71 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 34c2b71:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH c34a2ee U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c34a2ee:
...
#> IGRAPH c717ff1 D--B 15 20 -- Bipartite Gnm random graph
