...
#> IGRAPH 4d711a5 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4d711a5:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c860397 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c860397:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6fa3c76 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6fa3c76:
...
#> IGRAPH 49c3657 D--B 15 20 -- Bipartite Gnm random graph
