...
#> IGRAPH b3ec2da U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b3ec2da:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 35cec94 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 35cec94:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 802e6c1 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 802e6c1:
...
#> IGRAPH 9c7c4e0 D--B 15 20 -- Bipartite Gnm random graph
