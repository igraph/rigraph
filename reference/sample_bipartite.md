...
#> IGRAPH 129e441 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 129e441:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c4ca415 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c4ca415:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 33933d0 U--B 15 8 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 33933d0:
...
#> IGRAPH 5ee0fe4 D--B 15 20 -- Bipartite Gnm random graph
