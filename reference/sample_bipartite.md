...
#> IGRAPH 85ae1b0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 85ae1b0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 93de09b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 93de09b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 73ca857 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 73ca857:
...
#> IGRAPH 82ddc7f D--B 15 20 -- Bipartite Gnm random graph
