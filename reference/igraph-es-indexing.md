...
E(g)[1:3 %--% 2:6]
#> ── <edge sequence> 5/99 · from 7089e2b ─────────────────────────────────────────
#> [1] 2 → 1  3 → 1  4 → 1  5 → 2  6 → 2 
E(g)[1:5 %->% 1:6]
#> ── <edge sequence> 4/99 · from 7089e2b ─────────────────────────────────────────
#> [1] 2 → 1  3 → 1  4 → 1  5 → 2 
E(g)[1:3 %<-% 2:6]
#> ── <edge sequence> 5/99 · from 7089e2b ─────────────────────────────────────────
#> [1] 2 → 1  3 → 1  4 → 1  5 → 2  6 → 2 
...
d <- get_diameter(g)
E(g, path = d)
#> ── <edge sequence> 12/99 · from 5e2f08b ────────────────────────────────────────
...
E(g)[[weight < 0]]
#> ── <edge sequence> 16/27 · from ea4be86 ────────────────────────────────────────
...
x <- 2
E(g)[.env$x]
#> ── <edge sequence> 1/27 · from ea4be86 ─────────────────────────────────────────
#> [1] 3 ─ 6 
```
