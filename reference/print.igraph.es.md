...
g <- make_ring(10)
E(g)
#> ── <edge sequence> 10/10 · from 86679fb ────────────────────────────────────────
...
E(g2)
#> ── <edge sequence> 10/10 · vertex names · from ece1cd8 ─────────────────────────
#>  [1] A ─ B  B ─ C  C ─ D  D ─ E  E ─ F  F ─ G  G ─ H  H ─ I  I ─ J  A ─ J 

# All edges in a long sequence
g3 <- make_ring(200)
E(g3)
#> ── <edge sequence> 200/200 · from 96bc318 ──────────────────────────────────────
...
#> [139] 139 ─ 140  140 ─ 141  141 ─ 142  142 ─ 143  143 ─ 144  144 ─ 145 
#> [145] 145 ─ 146  146 ─ 147  147 ─ 148  148 ─ 149  149 ─ 150  150 ─ 151 
#> [151] 151 ─ 152  152 ─ 153  153 ─ 154  154 ─ 155  155 ─ 156  156 ─ 157 
#> [157] 157 ─ 158  158 ─ 159  159 ─ 160  160 ─ 161  161 ─ 162  162 ─ 163 
...
E(g4)
#> ── <edge sequence> 10/10 · vertex names · from 3d789bb ─────────────────────────
#>  [1] A ─ B  B ─ C  C ─ D  D ─ E  E ─ F  F ─ G  G ─ H  H ─ I  I ─ J  A ─ J 
E(g4)[[]]
#> ── <edge sequence> 10/10 · vertex names · from 3d789bb ─────────────────────────
...
E(g4)[[1:5]]
#> ── <edge sequence> 5/10 · vertex names · from 3d789bb ──────────────────────────
#>   tail head tid hid weight color
#> 1    A    B   1   2      1 green
#> 2    B    C   2   3      2 green
#> 3    C    D   3   4      3 green
