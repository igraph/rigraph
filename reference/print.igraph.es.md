...
g <- make_ring(10)
E(g)
#> ── <edge sequence> 10/10 · from 6fb6a10 ────────────────────────────────────────
...
E(g2)
#> ── <edge sequence> 10/10 · vertex names · from 51bb8a3 ─────────────────────────
#>  [1] A ─ B  B ─ C  C ─ D  D ─ E  E ─ F  F ─ G  G ─ H  H ─ I  I ─ J  A ─ J 

# All edges in a long sequence
g3 <- make_ring(200)
E(g3)
#> ── <edge sequence> 200/200 · from 5e27a15 ──────────────────────────────────────
...
E(g4)
#> ── <edge sequence> 10/10 · vertex names · from 451b5a0 ─────────────────────────
#>  [1] A ─ B  B ─ C  C ─ D  D ─ E  E ─ F  F ─ G  G ─ H  H ─ I  I ─ J  A ─ J 
E(g4)[[]]
#> ── <edge sequence> 10/10 · vertex names · from 451b5a0 ─────────────────────────
...
E(g4)[[1:5]]
#> ── <edge sequence> 5/10 · vertex names · from 451b5a0 ──────────────────────────
#>   tail head tid hid weight color
#> 1    A    B   1   2      1 green
#> 2    B    C   2   3      2 green
#> 3    C    D   3   4      3 green
