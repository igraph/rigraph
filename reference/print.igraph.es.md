...
g <- make_ring(10)
E(g)
#> ── <edge sequence> 10/10 · from 5608149 ────────────────────────────────────────
...
E(g2)
#> ── <edge sequence> 10/10 · vertex names · from f200d49 ─────────────────────────
#>  [1] A ─ B  B ─ C  C ─ D  D ─ E  E ─ F  F ─ G  G ─ H  H ─ I  I ─ J  A ─ J 

# All edges in a long sequence
g3 <- make_ring(200)
E(g3)
#> ── <edge sequence> 200/200 · from 29891c4 ──────────────────────────────────────
...
E(g4)
#> ── <edge sequence> 10/10 · vertex names · from 5dea5e2 ─────────────────────────
#>  [1] A ─ B  B ─ C  C ─ D  D ─ E  E ─ F  F ─ G  G ─ H  H ─ I  I ─ J  A ─ J 
E(g4)[[]]
#> ── <edge sequence> 10/10 · vertex names · from 5dea5e2 ─────────────────────────
...
E(g4)[[1:5]]
#> ── <edge sequence> 5/10 · vertex names · from 5dea5e2 ──────────────────────────
#>   tail head tid hid weight color
#> 1    A    B   1   2      1 green
#> 2    B    C   2   3      2 green
#> 3    C    D   3   4      3 green
