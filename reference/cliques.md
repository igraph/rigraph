...
[`cliques_callback()`](https://igraph.org/c/html/0.10.17/igraph-Cliques.html#igraph_cliques_callback),
...
cliques(g, min = 6)
#> [[1]]
#> ── <vertex sequence> 6/100 · from 49642a0 ──────────────────────────────────────
#> [1]  6  7 20 76 87 94
#> 
#> [[2]]
#> ── <vertex sequence> 6/100 · from 49642a0 ──────────────────────────────────────
...
max_cliques(g)
#> [[1]]
#> ── <vertex sequence> 1/100 · from f7a25ee ──────────────────────────────────────
#> [1] 49
#> 
#> [[2]]
#> ── <vertex sequence> 1/100 · from f7a25ee ──────────────────────────────────────
...
#> 
#> [[8]]
#> ── <vertex sequence> 2/100 · from f7a25ee ──────────────────────────────────────
#> [1] 89 80
#> 
#> [[9]]
#> ── <vertex sequence> 2/100 · from f7a25ee ──────────────────────────────────────
...
#> 
#> [[108]]
#> ── <vertex sequence> 3/100 · from f7a25ee ──────────────────────────────────────
#> [1] 81 17 84
#> 
#> [[109]]
#> ── <vertex sequence> 2/100 · from f7a25ee ──────────────────────────────────────
