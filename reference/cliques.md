...
- callback:
  ...
  return `TRUE` to continue the search or `FALSE` to stop it. If `NULL`
...
[`cliques_callback()`](https://igraph.org/c/html/latest/igraph-Cliques.html#igraph_cliques_callback),
