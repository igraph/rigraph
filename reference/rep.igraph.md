...
The new graph will contain the input graph the given number of times, as
...
- mark:
  ...
  Whether to mark the vertices with a `which` attribute, an integer
  number denoting which replication the vertex is coming from.
