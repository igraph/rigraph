...
g
#> IGRAPH a744b03 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from a744b03 (vertex names):
...
g2
#> IGRAPH 8e00eff UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 8e00eff (vertex names):
...
g3
#> IGRAPH 1deb580 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 1deb580 (vertex names):
...
g4
#> IGRAPH 4dc6a8b UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 4dc6a8b (vertex names):
...
g5
#> IGRAPH c7c0bab DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from c7c0bab (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 1671b35 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 1671b35 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
