...
g
#> IGRAPH b0fc68e UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from b0fc68e (vertex names):
...
g2
#> IGRAPH 218c823 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 218c823 (vertex names):
...
g3
#> IGRAPH ad020c1 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from ad020c1 (vertex names):
...
g4
#> IGRAPH cfa98b3 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from cfa98b3 (vertex names):
...
g5
#> IGRAPH 1b98062 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 1b98062 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 7032cd8 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 7032cd8 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
