...
g
#> IGRAPH 88f4138 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 88f4138 (vertex names):
...
g2
#> IGRAPH 8135d4c UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 8135d4c (vertex names):
...
g3
#> IGRAPH 2c27fd9 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 2c27fd9 (vertex names):
...
g4
#> IGRAPH e95fcaa UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from e95fcaa (vertex names):
...
g5
#> IGRAPH 0e578ca DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 0e578ca (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 8feb7db UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 8feb7db (vertex names):
#> [1] + ---   * --/   %%--%/%
```
