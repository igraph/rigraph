...
g
#> IGRAPH 88c2213 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 88c2213 (vertex names):
...
g2
#> IGRAPH 01c4db5 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 01c4db5 (vertex names):
...
g3
#> IGRAPH c6c9b51 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from c6c9b51 (vertex names):
...
g4
#> IGRAPH b2d38ea UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from b2d38ea (vertex names):
...
g5
#> IGRAPH b182636 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from b182636 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 7a218c5 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 7a218c5 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
