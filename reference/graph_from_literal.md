...
g
#> IGRAPH f275709 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from f275709 (vertex names):
...
g2
#> IGRAPH 4055a48 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 4055a48 (vertex names):
...
g3
#> IGRAPH fbd90d7 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from fbd90d7 (vertex names):
...
g4
#> IGRAPH 57c871a UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 57c871a (vertex names):
...
g5
#> IGRAPH 5920ba0 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 5920ba0 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 4f365bb UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 4f365bb (vertex names):
#> [1] + ---   * --/   %%--%/%
```
