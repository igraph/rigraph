...
g
#> IGRAPH 5c24a54 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 5c24a54 (vertex names):
...
g2
#> IGRAPH 44bde1c UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 44bde1c (vertex names):
...
g3
#> IGRAPH ff64c7d DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from ff64c7d (vertex names):
...
g4
#> IGRAPH 550dde5 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 550dde5 (vertex names):
...
g5
#> IGRAPH db3ffc9 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from db3ffc9 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 037e80e UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 037e80e (vertex names):
#> [1] + ---   * --/   %%--%/%
```
