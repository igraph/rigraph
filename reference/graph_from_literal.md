...
g
#> IGRAPH 259918e UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 259918e (vertex names):
...
g2
#> IGRAPH 873a6e3 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 873a6e3 (vertex names):
...
g3
#> IGRAPH 5a1e00c DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 5a1e00c (vertex names):
...
g4
#> IGRAPH ab7aad4 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from ab7aad4 (vertex names):
...
g5
#> IGRAPH 51badbc DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 51badbc (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH ed21766 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from ed21766 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
