...
g
#> IGRAPH 72c65ab UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 72c65ab (vertex names):
...
g2
#> IGRAPH c38ad47 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from c38ad47 (vertex names):
...
g3
#> IGRAPH 7e7b3b1 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 7e7b3b1 (vertex names):
...
g4
#> IGRAPH a45c8fb UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from a45c8fb (vertex names):
...
g5
#> IGRAPH 8646561 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 8646561 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 670e988 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 670e988 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
