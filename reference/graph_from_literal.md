...
g
#> IGRAPH de71eeb UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from de71eeb (vertex names):
...
g2
#> IGRAPH 6313c5e UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 6313c5e (vertex names):
...
g3
#> IGRAPH 8aace86 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 8aace86 (vertex names):
...
g4
#> IGRAPH 7a00a4d UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 7a00a4d (vertex names):
...
g5
#> IGRAPH bbd8320 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from bbd8320 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH ed0c4ac UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from ed0c4ac (vertex names):
#> [1] + ---   * --/   %%--%/%
```
