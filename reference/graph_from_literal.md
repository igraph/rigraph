...
g
#> IGRAPH aaeb2bc UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from aaeb2bc (vertex names):
...
g2
#> IGRAPH 28e0b9e UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 28e0b9e (vertex names):
...
g3
#> IGRAPH 10c4763 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 10c4763 (vertex names):
...
g4
#> IGRAPH a31089b UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from a31089b (vertex names):
...
g5
#> IGRAPH 6e32097 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 6e32097 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 10ca244 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 10ca244 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
