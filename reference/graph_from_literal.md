...
g
#> IGRAPH 1ead66d UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 1ead66d (vertex names):
...
g2
#> IGRAPH fc7ba81 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from fc7ba81 (vertex names):
...
g3
#> IGRAPH 02e3b09 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 02e3b09 (vertex names):
...
g4
#> IGRAPH 54cdd6a UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 54cdd6a (vertex names):
...
g5
#> IGRAPH c6648ee DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from c6648ee (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH a45e75a UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from a45e75a (vertex names):
#> [1] + ---   * --/   %%--%/%
```
