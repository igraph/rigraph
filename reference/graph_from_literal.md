...
g
#> IGRAPH 071be9b UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 071be9b (vertex names):
...
g2
#> IGRAPH 8611bd6 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 8611bd6 (vertex names):
...
g3
#> IGRAPH 1ceecda DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 1ceecda (vertex names):
...
g4
#> IGRAPH 20c05e5 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 20c05e5 (vertex names):
...
g5
#> IGRAPH 78aebb3 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 78aebb3 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 7eaccdd UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 7eaccdd (vertex names):
#> [1] + ---   * --/   %%--%/%
```
