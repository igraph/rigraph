...
g
#> IGRAPH 8d6a0cf UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 8d6a0cf (vertex names):
...
g2
#> IGRAPH cbad260 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from cbad260 (vertex names):
...
g3
#> IGRAPH 7fb0341 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 7fb0341 (vertex names):
...
g4
#> IGRAPH f224a43 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from f224a43 (vertex names):
...
g5
#> IGRAPH 2788633 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 2788633 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 458a0c3 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 458a0c3 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
