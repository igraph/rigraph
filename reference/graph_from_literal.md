...
g
#> IGRAPH f15c79e UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from f15c79e (vertex names):
...
g2
#> IGRAPH b26a901 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from b26a901 (vertex names):
...
g3
#> IGRAPH 8438ff7 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 8438ff7 (vertex names):
...
g4
#> IGRAPH 4bda3f0 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 4bda3f0 (vertex names):
...
g5
#> IGRAPH 597ac51 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 597ac51 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 2108b0d UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 2108b0d (vertex names):
#> [1] + ---   * --/   %%--%/%
```
