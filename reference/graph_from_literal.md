...
g
#> IGRAPH 81fa780 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 81fa780 (vertex names):
...
g2
#> IGRAPH ae06d15 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from ae06d15 (vertex names):
...
g3
#> IGRAPH 77acc0b DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 77acc0b (vertex names):
...
g4
#> IGRAPH a2b01be UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from a2b01be (vertex names):
...
g5
#> IGRAPH 1aee0e9 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 1aee0e9 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH b3b4891 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from b3b4891 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
