...
g
#> IGRAPH 77dbc50 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 77dbc50 (vertex names):
...
g2
#> IGRAPH 8baa3e5 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 8baa3e5 (vertex names):
...
g3
#> IGRAPH e36e909 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from e36e909 (vertex names):
...
g4
#> IGRAPH 6f0de2c UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 6f0de2c (vertex names):
...
g5
#> IGRAPH b45eb38 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from b45eb38 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH a2dc9b4 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from a2dc9b4 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
