...
g
#> IGRAPH 5a2fc25 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 5a2fc25 (vertex names):
...
g2
#> IGRAPH 651e65d UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 651e65d (vertex names):
...
g3
#> IGRAPH 48fdc65 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 48fdc65 (vertex names):
...
g4
#> IGRAPH 816537b UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 816537b (vertex names):
...
g5
#> IGRAPH 7621cd5 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 7621cd5 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 432e011 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 432e011 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
