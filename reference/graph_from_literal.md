...
g
#> IGRAPH 9510990 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 9510990 (vertex names):
...
g2
#> IGRAPH e009c3c UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from e009c3c (vertex names):
...
g3
#> IGRAPH 33744e5 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 33744e5 (vertex names):
...
g4
#> IGRAPH 3747d34 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 3747d34 (vertex names):
...
g5
#> IGRAPH 8f6f7fc DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 8f6f7fc (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH f817951 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from f817951 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
