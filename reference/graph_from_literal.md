...
g
#> IGRAPH 1a25881 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 1a25881 (vertex names):
...
g2
#> IGRAPH f42e101 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from f42e101 (vertex names):
...
g3
#> IGRAPH f1724de DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from f1724de (vertex names):
...
g4
#> IGRAPH 20c96c9 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 20c96c9 (vertex names):
...
g5
#> IGRAPH c01589b DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from c01589b (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 87db33d UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 87db33d (vertex names):
#> [1] + ---   * --/   %%--%/%
```
