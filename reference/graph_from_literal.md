...
g
#> IGRAPH 3ddde3c UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 3ddde3c (vertex names):
...
g2
#> IGRAPH 661986a UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 661986a (vertex names):
...
g3
#> IGRAPH eb3580c DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from eb3580c (vertex names):
...
g4
#> IGRAPH 20d68c7 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 20d68c7 (vertex names):
...
g5
#> IGRAPH 91c27f4 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 91c27f4 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 52f6c3f UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 52f6c3f (vertex names):
#> [1] + ---   * --/   %%--%/%
```
