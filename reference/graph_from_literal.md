...
g
#> IGRAPH d648cae UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from d648cae (vertex names):
...
g2
#> IGRAPH 955ed7c UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 955ed7c (vertex names):
...
g3
#> IGRAPH 74d1eb8 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 74d1eb8 (vertex names):
...
g4
#> IGRAPH 9796410 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 9796410 (vertex names):
...
g5
#> IGRAPH d1a8edf DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from d1a8edf (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 7c1ff44 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 7c1ff44 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
