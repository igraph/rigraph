...
g
#> IGRAPH 5ad8516 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 5ad8516 (vertex names):
...
g2
#> IGRAPH 1792614 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 1792614 (vertex names):
...
g3
#> IGRAPH e420923 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from e420923 (vertex names):
...
g4
#> IGRAPH 986f8f6 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 986f8f6 (vertex names):
...
g5
#> IGRAPH 28dc6eb DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 28dc6eb (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH e334688 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from e334688 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
