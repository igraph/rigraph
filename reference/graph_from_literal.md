...
g
#> IGRAPH 6bc69bf UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 6bc69bf (vertex names):
...
g2
#> IGRAPH f76efe8 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from f76efe8 (vertex names):
...
g3
#> IGRAPH 6779b00 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 6779b00 (vertex names):
...
g4
#> IGRAPH 3e1c5b0 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 3e1c5b0 (vertex names):
...
g5
#> IGRAPH ec0592f DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from ec0592f (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH dd5373a UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from dd5373a (vertex names):
#> [1] + ---   * --/   %%--%/%
```
