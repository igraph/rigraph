...
g
#> IGRAPH 3878831 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 3878831 (vertex names):
...
g2
#> IGRAPH 80acf1a UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 80acf1a (vertex names):
...
g3
#> IGRAPH a1c9699 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from a1c9699 (vertex names):
...
g4
#> IGRAPH 682135b UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 682135b (vertex names):
...
g5
#> IGRAPH f5aaed1 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from f5aaed1 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 685f5bb UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 685f5bb (vertex names):
#> [1] + ---   * --/   %%--%/%
```
