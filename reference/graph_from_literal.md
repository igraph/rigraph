...
g
#> IGRAPH 9c34488 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 9c34488 (vertex names):
...
g2
#> IGRAPH 826bfd9 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 826bfd9 (vertex names):
...
g3
#> IGRAPH e9b092b DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from e9b092b (vertex names):
...
g4
#> IGRAPH 07e018a UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 07e018a (vertex names):
...
g5
#> IGRAPH 84f630b DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 84f630b (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 683999f UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 683999f (vertex names):
#> [1] + ---   * --/   %%--%/%
```
