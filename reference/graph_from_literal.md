...
g
#> IGRAPH 292fd8a UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 292fd8a (vertex names):
...
g2
#> IGRAPH f349b24 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from f349b24 (vertex names):
...
g3
#> IGRAPH 2a0438c DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 2a0438c (vertex names):
...
g4
#> IGRAPH d654b88 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from d654b88 (vertex names):
...
g5
#> IGRAPH cdbb069 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from cdbb069 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 4e50c9d UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 4e50c9d (vertex names):
#> [1] + ---   * --/   %%--%/%
```
