...
g
#> IGRAPH 53eb499 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 53eb499 (vertex names):
...
g2
#> IGRAPH bbccdf9 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from bbccdf9 (vertex names):
...
g3
#> IGRAPH a2bc718 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from a2bc718 (vertex names):
...
g4
#> IGRAPH 0a717ce UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 0a717ce (vertex names):
...
g5
#> IGRAPH 53dbaf3 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 53dbaf3 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 0d517e3 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 0d517e3 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
