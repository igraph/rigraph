...
g
#> IGRAPH b6f2746 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from b6f2746 (vertex names):
...
g2
#> IGRAPH 1ed82b2 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 1ed82b2 (vertex names):
...
g3
#> IGRAPH 44d372a DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 44d372a (vertex names):
...
g4
#> IGRAPH 49b0fb8 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 49b0fb8 (vertex names):
...
g5
#> IGRAPH e8b229b DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from e8b229b (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 6d3469a UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 6d3469a (vertex names):
#> [1] + ---   * --/   %%--%/%
```
