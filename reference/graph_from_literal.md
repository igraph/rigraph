...
g
#> IGRAPH 6377dde UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 6377dde (vertex names):
...
g2
#> IGRAPH 0a43940 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 0a43940 (vertex names):
...
g3
#> IGRAPH bd7d2fd DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from bd7d2fd (vertex names):
...
g4
#> IGRAPH d7d90e8 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from d7d90e8 (vertex names):
...
g5
#> IGRAPH c6947e4 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from c6947e4 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH a0d5d1b UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from a0d5d1b (vertex names):
#> [1] + ---   * --/   %%--%/%
```
