...
g
#> IGRAPH 43bb9df UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 43bb9df (vertex names):
...
g2
#> IGRAPH fc05995 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from fc05995 (vertex names):
...
g3
#> IGRAPH 2dd87d6 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 2dd87d6 (vertex names):
...
g4
#> IGRAPH 38bfe8d UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 38bfe8d (vertex names):
...
g5
#> IGRAPH efd0b1a DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from efd0b1a (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 19bbf13 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 19bbf13 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
