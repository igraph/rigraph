...
g
#> IGRAPH 77ccbc6 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 77ccbc6 (vertex names):
...
g2
#> IGRAPH 4021fd0 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 4021fd0 (vertex names):
...
g3
#> IGRAPH cafcdc3 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from cafcdc3 (vertex names):
...
g4
#> IGRAPH 4f0ab61 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 4f0ab61 (vertex names):
...
g5
#> IGRAPH 4067a90 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 4067a90 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH cbc54c9 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from cbc54c9 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
