...
g
#> IGRAPH af9d782 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from af9d782 (vertex names):
...
g2
#> IGRAPH b351d7c UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from b351d7c (vertex names):
...
g3
#> IGRAPH e764469 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from e764469 (vertex names):
...
g4
#> IGRAPH 4f8d5bc UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 4f8d5bc (vertex names):
...
g5
#> IGRAPH e2c1aef DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from e2c1aef (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 4b60639 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 4b60639 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
