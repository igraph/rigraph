...
g
#> IGRAPH da78c71 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from da78c71 (vertex names):
...
g2
#> IGRAPH da340da UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from da340da (vertex names):
...
g3
#> IGRAPH 10dafc8 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 10dafc8 (vertex names):
...
g4
#> IGRAPH 393d8e1 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 393d8e1 (vertex names):
...
g5
#> IGRAPH 10d7272 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 10d7272 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 0eed08c UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 0eed08c (vertex names):
#> [1] + ---   * --/   %%--%/%
```
