...
g
#> IGRAPH b625aac UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from b625aac (vertex names):
...
g2
#> IGRAPH c270d7e UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from c270d7e (vertex names):
...
g3
#> IGRAPH 060ef9f DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 060ef9f (vertex names):
...
g4
#> IGRAPH 01f8e44 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 01f8e44 (vertex names):
...
g5
#> IGRAPH 3856b00 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 3856b00 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 83c29b8 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 83c29b8 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
