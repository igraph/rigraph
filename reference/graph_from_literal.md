...
g
#> IGRAPH 5994536 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 5994536 (vertex names):
...
g2
#> IGRAPH 7f098ea UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 7f098ea (vertex names):
...
g3
#> IGRAPH 1e03b2b DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 1e03b2b (vertex names):
...
g4
#> IGRAPH 138fe25 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 138fe25 (vertex names):
...
g5
#> IGRAPH d79d60f DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from d79d60f (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH c2e88f5 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from c2e88f5 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
