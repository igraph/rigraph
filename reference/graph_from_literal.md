...
g
#> IGRAPH 45ff3c8 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 45ff3c8 (vertex names):
...
g2
#> IGRAPH ee8b0b1 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from ee8b0b1 (vertex names):
...
g3
#> IGRAPH 07da874 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 07da874 (vertex names):
...
g4
#> IGRAPH f891f5a UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from f891f5a (vertex names):
...
g5
#> IGRAPH 35d18b7 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 35d18b7 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 944b1bf UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 944b1bf (vertex names):
#> [1] + ---   * --/   %%--%/%
```
