...
g
#> IGRAPH 2c4e607 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 2c4e607 (vertex names):
...
g2
#> IGRAPH 0f4dd1d UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 0f4dd1d (vertex names):
...
g3
#> IGRAPH 81f6017 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 81f6017 (vertex names):
...
g4
#> IGRAPH 8f2949a UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 8f2949a (vertex names):
...
g5
#> IGRAPH 5c71fd4 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 5c71fd4 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH ebcff9a UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from ebcff9a (vertex names):
#> [1] + ---   * --/   %%--%/%
```
