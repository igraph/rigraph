...
g
#> IGRAPH cde37dc UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from cde37dc (vertex names):
...
g2
#> IGRAPH 05413e1 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 05413e1 (vertex names):
...
g3
#> IGRAPH 39254df DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 39254df (vertex names):
...
g4
#> IGRAPH 76da52b UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 76da52b (vertex names):
...
g5
#> IGRAPH 1fadd04 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 1fadd04 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH a1641c8 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from a1641c8 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
