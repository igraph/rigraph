...
g
#> IGRAPH 64368b7 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 64368b7 (vertex names):
...
g2
#> IGRAPH e0ac32e UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from e0ac32e (vertex names):
...
g3
#> IGRAPH dd32ca4 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from dd32ca4 (vertex names):
...
g4
#> IGRAPH 0b53c23 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 0b53c23 (vertex names):
...
g5
#> IGRAPH ea38b20 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from ea38b20 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 4e656f1 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 4e656f1 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
