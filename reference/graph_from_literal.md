...
g
#> IGRAPH 216b5e0 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 216b5e0 (vertex names):
...
g2
#> IGRAPH ebf9d77 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from ebf9d77 (vertex names):
...
g3
#> IGRAPH 17c480a DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 17c480a (vertex names):
...
g4
#> IGRAPH ae6f562 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from ae6f562 (vertex names):
...
g5
#> IGRAPH 6f12261 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 6f12261 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 2cf1718 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 2cf1718 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
