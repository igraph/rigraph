...
g
#> IGRAPH a871e39 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from a871e39 (vertex names):
...
g2
#> IGRAPH 9d1e05b UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 9d1e05b (vertex names):
...
g3
#> IGRAPH d9378a8 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from d9378a8 (vertex names):
...
g4
#> IGRAPH b41bfc7 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from b41bfc7 (vertex names):
...
g5
#> IGRAPH 3bf9662 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 3bf9662 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH eff9352 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from eff9352 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
