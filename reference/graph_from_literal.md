...
g
#> IGRAPH 5b1a45a UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 5b1a45a (vertex names):
...
g2
#> IGRAPH 8af5892 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 8af5892 (vertex names):
...
g3
#> IGRAPH f4a5a88 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from f4a5a88 (vertex names):
...
g4
#> IGRAPH 071b00a UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 071b00a (vertex names):
...
g5
#> IGRAPH a3754e3 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from a3754e3 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 6d05250 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 6d05250 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
