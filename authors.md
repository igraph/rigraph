...
Source:
[`inst/CITATION`](https://github.com/igraph/rigraph/blob/cran-2.2.99.9900/inst/CITATION)
...
2.2.99.9900, \<https://CRAN.R-project.org/package=igraph\>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 2.2.99.9900},
