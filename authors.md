...
Source:
[`inst/CITATION`](https://github.com/igraph/rigraph/blob/claude/ci-full-matrix/inst/CITATION)
...
2.3.3.9020, \<https://CRAN.R-project.org/package=igraph\>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 2.3.3.9020},
