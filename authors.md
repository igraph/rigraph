...
Source:
[`inst/CITATION`](https://github.com/igraph/rigraph/blob/cran-fix/inst/CITATION)
...
2.2.2.9005, \<https://CRAN.R-project.org/package=igraph\>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 2.2.2.9005},
