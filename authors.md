...
Source:
[`inst/CITATION`](https://github.com/igraph/rigraph/blob/docs-id-casing-convention/inst/CITATION)
...
2.3.2.9011, \<https://CRAN.R-project.org/package=igraph\>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 2.3.2.9011},
